...
public interface BoBaBatPgmChgHstService {

	/** 배치프로그램 변경이력 등록 interface */
	BaBatPgmChgHstVo insertBatPgmChgHst(BaBatPgmChgHstVo baBatPgmChgHstVo) throws Exception;
	
	/** 배치프로그램 변경이력 리스트 interface */
	List<BaBatPgmChgHstVo> inqBatPgmChgHstList(BaBatPgmChgHstVo baBatPgmChgHstVo) throws Exception;
	
	/** 배치프로그램 변경이력 리스트 카운트 interface */
