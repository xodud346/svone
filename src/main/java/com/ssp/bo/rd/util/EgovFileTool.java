 ...
 *     수정일         수정자                   수정내용
 *   -------    --------    ---------------------------
 *   2014.02.25    나용철          최초 생성
 *
 *  @author 공통 서비스 개발팀 나용철,오왕표
 *  @since 2014. 02. 25
 *  @version 1.0
 *  @see 
 * 
...
public class EgovFileTool {
	private static final Logger slog = LoggerFactory.getLogger(EgovFileTool.class);
    ...
    public static boolean getExistDirectory(String targetDirPath) throws Exception {
        ...
        {   
        	...
        	slog.error("getExistDirectory exception :", e);
        }
    ...
    public static String getLastModifiedDateFromFile(File f){
        ...
        try{
        	...
        	slog.error("getLastModifiedDateFromFile exception :", e);
        }
    ...
    public static ArrayList getLastDirectoryForModifiedDate(String baseDirPath , String fromDate, String toDate){
        ...
        try
        {
        	...
        	slog.error("getLastDirectoryForModifiedDate exception :", e);
        }
    ...
    public static boolean canRead(String filePath){
        ...
        try
        {
            ...
            slog.error("canRead exception :", e);
        }
    ...
    public static boolean canWrite(String filePath){
        ...
        try
        {
        	...
        	slog.error("canWrite exception :", e);
        }
    ...
    public static String getName(String filePath){
        ...
        try
        {
        	...
        	slog.error("getName exception :", e);
        }
    ...
    public  static String deletePath(String filePath){
        ...
        try{
           ...
           if(file.exists()){
            ...
            slog.error("deletePath exception :", e);
        }
        return result;
    }
...
//            }
        ...
        if(!file.exists()){
        	...
        	slog.error("createDirectory exception :", e);
        }
        return result;
    }
    ...
    */
    public static boolean checkFileExstByExtnt(String dir, String eventn) throws Exception {
        ...
        if (srcDrctry.exists() && srcDrctry.isDirectory()) {
            ...
            ArrayList list = new ArrayList();
            if(fileArray != null) {
            	list = getSubFilesByExtnt(fileArray, eventn);
            }
            if (list != null && list.size() > 0) {
                result = true;
            }
    ...
    */
    public static boolean checkFileExstBySize(String dir, long sizeFrom, long sizeTo) throws Exception {
        ...
        if (srcDrctry.exists() && srcDrctry.isDirectory()) {
            ...
            ArrayList list = new ArrayList();
            if(fileArray != null) {
            	list = getSubFilesBySize(fileArray, sizeFrom, sizeTo);
            }
            if (list != null && list.size() > 0) {
                result = true;
            }
    ...
    */
    ...
    public  static String createNewDirectory(String dirPath){
        ...
        try{
        	...
        	slog.error("createNewDirectory exception :", e);
        }
    ...
    public  static String createNewFile(String filePath){
        ...
        try{
        	...
        	slog.error("createNewFile exception :", e);
        }
    ...
    */
    public static boolean checkReadAuth(String file) throws Exception {
        ...
        {   
            ...
            slog.error("checkReadAuth exception :", ex);
        } 
    ...
    public static boolean checkWriteAuth(String file) throws Exception {
        ...
        {   
           ...
           //}
        	...
        	slog.error("checkWriteAuth exception :", ex);
        } 
    ...
    */
    public static Vector parsFileBySize(String parFile, int[] parLen, int parLine) throws Exception {
        ...
        try {
            ...
            if (file.exists() && file.isFile()) {
                ...
                String [] strArr = readFile(file, parLine);
        	...
        	slog.error("parsFileBySize exception :", e);
		}finally{
			if(br!=null) br.close();
		}
    ...
    public static synchronized String[] readFile(File file, int parLine) throws IOException {
    ...
    public static boolean cmprFilesByContent(String cmprFile1, String cmprFile2) throws Exception {
        ...
        try {
            ...
            if (file1.exists() && file2.exists()
                ...
                ArrayList cmprText1 = readFile1(file1);
                ArrayList cmprText2 = readFile1(file2);
...
//                }
			...
			slog.error("cmprFilesByContent exception :", ex);
		} finally {
    ...
    private static synchronized ArrayList<String> readFile1(File file1) throws IOException {
    	 String line1 = "";
    ...
    public static boolean copyFile(String source, String target) throws Exception {
        ...
        try {
           ...
           // }
        	...
        	slog.error("copyFile IOException :", ex);
        }
        ...
        for (int j = 0; j < source.length; j++) {
            ...
            if(result){ //result != false
                ...
                {   
                	...
                	slog.error("copyFiles exception :", ex);
                }
    ...
    */
    public static boolean copyFilesByExtnt(String source, String extnt, String target) throws Exception {
        ...
        if (srcFile.exists() && srcFile.isDirectory()) {
            ...
            ArrayList list = new ArrayList();
            if(fileArray != null) {
            	list = getSubFilesByExtnt(fileArray, extnt);
            }            
            ...
            for (int i = 0; i < list.size(); i++) {
                if(result){ //f(result != false){
                    ...
                    {   
                        ...
                        slog.error("copyFilesByExtnt IOException :", ex);
                    }
                }
            ...
            for (int i = 0; i < list.size() ; i++) {
                ...
                if(result){ //f(result != false){
                    ...
                    {   
                    	...
                    	slog.error("copyFilesByUpdtPd exception :", ex);
                    }
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if(result){ //result != false
                    ...
                    {   
                    	...
                    	slog.error("copyFilesBySize exception :", ex);
                    }
    ...
    */
    public static boolean execCopyFile(File srcFile, File tarFile) throws Exception {
        ...
        try {
        	...
        	slog.error("execCopyFile exception :", ex);
        } finally {
    ...
    public  static String deleteDirectory(String dirDeletePath, String fromDate, String toDate){
        ...
        try{
        	...
        	slog.error("deleteDirectory exception :", e);
        }
    ...
    */
    public static String getDrctryName(String file) throws Exception {
        ...
        {   
        	...
        	slog.error("getDrctryName exception :", ex);
        } 
    ...
    */
    public static String getFileName(String file) throws Exception {
        ...
        {   
        	...
        	slog.error("getFileName exception :", ex);
        } 
    ...
    */
    public static String getUpdtDate(String file) throws Exception {
        ...
        {   
            ...
            slog.error("getUpdtDate exception :", ex);
        } 
    ...
    */
    public static long getSize(String file) throws Exception {
        ...
        {   
        	...
        	slog.error("getSize exception :", ex);
        } 
        ...
        {   
            ...
            if(f.exists() && f.isDirectory()){
                ...
                if(targetDirPath1.equals("")){
                    ...
                    if(originalFileList != null && originalFileList.length>0){
    ...
    public static boolean copyDirectory(String originalDirPath, String targetDirPath, String fromDate, String toDate) throws Exception {
        ...
        {              
        	...
        	slog.error("copyDirectory exception :", e);
        }
