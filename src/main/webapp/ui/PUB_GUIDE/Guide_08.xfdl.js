(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static71_00_00_00_00_00_00","309","271","91","25",null,null,null,null,null,null,this);
            obj.set_taborder("68");
            obj.set_text("edi_WF_error");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00","55","268","91","25",null,null,null,null,null,null,this);
            obj.set_taborder("69");
            obj.set_text("btn_WF_help");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00","112","1424","78","25",null,null,null,null,null,null,this);
            obj.set_taborder("70");
            obj.set_text("productImage");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00_00","136","1520","140","25",null,null,null,null,null,null,this);
            obj.set_taborder("71");
            obj.set_text("btn_WF_close_small_red");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00_00_00","764","2655","90","25",null,null,null,null,null,null,this);
            obj.set_taborder("72");
            obj.set_text("btn_WF_select");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00_00_00_00","397","2450","90","25",null,null,null,null,null,null,this);
            obj.set_taborder("73");
            obj.set_text("tab_WF_basic");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00_00_00_00_00","490","2300","120","25",null,null,null,null,null,null,this);
            obj.set_taborder("74");
            obj.set_text("btn_WF_close_small");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
