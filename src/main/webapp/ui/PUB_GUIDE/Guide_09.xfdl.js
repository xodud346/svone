(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static63_00_00","1","45",null,"21","-1",null,null,null,null,null,this.Div00_01.form);
            obj.set_taborder("2");
            obj.set_text("220408   제목 타이틀 수정");
            obj.set_cssclass("sta_WF_SubTitle");
            obj.set_font("12px/normal \"Malgun Gothic\",\"맑은고딕\",\"Apple SD Gothic Neo\",\"dotum\",\"돋움\",\"arial\",\"sans-serif\"");
            this.Div00_01.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00","445","26","91","25",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("btn_WF_require");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00","299","41","71","25",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("sta_WF_txtR");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_00_00","145","15","85","25",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("sta_WF_title04");
            obj.set_background("#fff6c0");
            this.addChild(obj.name, obj);

            obj = new Static("Static71_00_00_00_00_00_00_01","495",null,"91","25",null,"60",null,null,null,null,this);
            obj.set_taborder("13");
