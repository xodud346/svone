(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("전용상품 노출판매가 상세 - 영업담당자");
        ...
        // User Script
        this.registerScript("SSP_BO_CA_40_1.xfdl", function() {
        ...
        ************************************************************************************************/
        ...
        trace("SSP_BO_CA_40_1_onload is " + this.strAuth + "," + this.strIsNew);
        ...
        this.loadIncludeScript("SSP_BO_CA_40_1.xfdl");
