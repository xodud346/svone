(function()
{
    return function()
    {
        ...
        {
            this.set_name("test1");
            this.set_titletext("공용상품 가격관리 - 그외(조회)");
            ...
            obj.set_taborder("0");
            obj.set_text("Div00");
            obj.set_url("PC::SSP_BO_CA_20.xfdl");
        ...
        {
            this._addPreloadList("fdl","PC::SSP_BO_CA_20.xfdl");
        };
        
        // User Script
        this.registerScript("SSP_BO_CA_20_1.xfdl", function() {
        ...
        this.loadIncludeScript("SSP_BO_CA_20_1.xfdl");
