(function()
{
    return function()
    {
        ...
        {
            this.set_name("test1");
            this.set_titletext("카테고리계획매익율 조회");
            ...
            obj.set_taborder("0");
            obj.set_text("Div00");
            obj.set_url("PC::SSP_BO_CA_51.xfdl");
            obj.set_async("true");
        ...
        {
            this._addPreloadList("fdl","PC::SSP_BO_CA_51.xfdl");
        };
        
        // User Script
        this.registerScript("SSP_BO_CA_51_1.xfdl", function() {
        ...
        this.tabPageInit = function(){
        	...
        	//tabpage1 의 일괄등록버튼 set_visible(false)
        ...
        this.loadIncludeScript("SSP_BO_CA_51_1.xfdl");
