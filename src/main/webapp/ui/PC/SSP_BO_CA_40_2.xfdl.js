(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("전용상품 노출판매가 상세 - 그외(조회)");
        ...
        // User Script
        this.registerScript("SSP_BO_CA_40_2.xfdl", function() {
        /***********************************************************************************************
         * Form 변수 선언 영역
        ************************************************************************************************/
        this.prdId = "";
        ...
        this.detailFunction = function(){
        	this.Div00.form.auth = 0;
        	this.Div00.form.fn_checkData();
        	this.Div00.form.btn_update.set_visible(false);
        }*/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_CA_40_2.xfdl");
