(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Condition 이력조회 - 물량할인");
            ...
            obj._setContents("<ColumnInfo><Column id=\"REG_DTM\" type=\"DATETIME\" size=\"17\"/><Column id=\"QTY_ITV_STR\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"QTY_ITV_END\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"DC_AMT\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"CUR_UNT_CD\" type=\"STRING\" size=\"32\"/><Column id=\"QTY_STR_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"QTY_END_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"DATA_CHG_TP_NM\" type=\"STRING\" size=\"256\"/><Column id=\"UPDPSN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPRTR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HST_SEQ\" type=\"BIGDECIMAL\" size=\"16\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"101\"/><Column size=\"84\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"45\"/><Column size=\"101\"/><Column size=\"101\"/><Column size=\"80\"/><Column size=\"78\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"등록 일시\"/><Cell col=\"1\" text=\"공용전용구분\"/><Cell col=\"2\" text=\"물량(From)\"/><Cell col=\"3\" text=\"물량(To)\"/><Cell col=\"4\" text=\"할인금액\"/><Cell col=\"5\" text=\"판매통화\"/><Cell col=\"6\" text=\"기간(From)\"/><Cell col=\"7\" text=\"기간(To)\"/><Cell col=\"8\" text=\"변경담당자ID\"/><Cell col=\"9\" text=\"변경담당자\"/></Band><Band id=\"body\"><Cell text=\"bind:REG_DTM\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" autosizecol=\"default\"/><Cell col=\"1\" text=\"bind:BZPLC_ID\" expr=\"BZPLC_ID==&apos;*&apos;?&apos;공용&apos;:&apos;전용&apos;\"/><Cell col=\"2\" text=\"bind:QTY_ITV_STR\"/><Cell col=\"3\" text=\"bind:QTY_ITV_END\"/><Cell col=\"4\" text=\"bind:DC_AMT\" textAlign=\"right\"/><Cell col=\"5\" text=\"bind:CUR_UNT_CD\"/><Cell col=\"6\" text=\"bind:QTY_STR_DTM\"/><Cell col=\"7\" text=\"bind:QTY_END_DTM\"/><Cell col=\"8\" text=\"bind:UPDPSN_ID\"/><Cell col=\"9\" text=\"bind:OPRTR_NM\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("cbo_page",null,"5","114","24","178",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_init",null,"40","65","26","192",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("5");
            obj.set_text("초기화");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Button("Button58",null,"40","60","26","128",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("6");
            obj.set_text("조회");
        ...
        // User Script
        this.addIncludeScript("SSP_BO_CA_29_A.xfdl","PC::pcUtils.xjs");
        this.addIncludeScript("SSP_BO_CA_29_A.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_CA_29_A.xfdl", function() {
        ...
        ************************************************************************************************/
        ...
        this.fn_doSearch = function(page)
        {
             ...
             var sUrl = "/pc/popup/select-prd-qty-hst-list.do";
        ...
        ************************************************************************************************/
        ...
        this.btn_excelDownload_onclick = function(obj,e)
        {
        	...
        	if(this.ds_list.getRowCount() > 0){
        		this.ofn_exportExcel({form:this, grid:this.Div00.form.grd_dlvplcList, fileName:"물량할인이력"});
        	}else{
        ...
        this.loadIncludeScript("SSP_BO_CA_29_A.xfdl");
