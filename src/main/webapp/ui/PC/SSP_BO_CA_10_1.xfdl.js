(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("Div00");
            obj.set_url("PC::SSP_BO_CA_10.xfdl");
        ...
        {
            this._addPreloadList("fdl","PC::SSP_BO_CA_10.xfdl");
        };
        
        // User Script
        this.registerScript("SSP_BO_CA_10_1.xfdl", function() {
        ...
        this.loadIncludeScript("SSP_BO_CA_10_1.xfdl");
