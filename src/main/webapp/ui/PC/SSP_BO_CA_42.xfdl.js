(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","0","274",null,"333","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_dlvplcList","0","28",null,"257","0",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            ...
            obj = new Static("totalPageCount","0","7","300","14",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            ...
            obj = new Div("Div00_00","0","205",null,"85","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("검색 영역");
            ...
            obj = new Button("btn_init",null,"48","65","26","64",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("6");
            obj.set_text("초기화");
            this.Div00_00.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_03_00_00","0","170","200","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("■ 내부최저판매가 등록 이력");
            obj.set_cssclass("sta_WF_title01");
            this.addChild(obj.name, obj);

            obj = new Div("Div_top_info00","0","30",null,"140","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Div01");
            ...
            obj = new Static("Static22_00_00_00","709","53",null,"32","0",null,null,null,null,null,this.Div_top_info00.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static03_00_00_02","709","84",null,"32","0",null,null,null,null,null,this.Div_top_info00.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            obj.set_textAlign("center");
        ...
        // User Script
        this.addIncludeScript("SSP_BO_CA_42.xfdl","PC::pcUtils.xjs");
        this.addIncludeScript("SSP_BO_CA_42.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_CA_42.xfdl", function() {
        /*******************************************************
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_CA_42.xfdl");
