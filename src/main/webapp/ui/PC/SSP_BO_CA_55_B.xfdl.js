(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"ePRD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"PUB_ONLY_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_USE_YN\" type=\"STRING\" size=\"1\"/><Column id=\"codeList\" type=\"STRING\" size=\"256\"/><Column id=\"INQ_COND_DTLS\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"START_NUM\">0</Col><Col id=\"ROW_COUNT\">20</Col><Col id=\"PRD_USE_YN\">Y</Col><Col id=\"PUB_ONLY_SPR_CD\">P</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_exPrdPrcList", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"COL_CHK\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_ID\" type=\"STRING\" size=\"32\"/><Column id=\"PRD_ID_NUM\" type=\"STRING\" size=\"32\"/><Column id=\"PRD_NM\" type=\"STRING\" size=\"32\"/><Column id=\"PUB_ONLY_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PUB_ONLY_SPR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_USE_YN\" type=\"STRING\" size=\"32\"/><Column id=\"PRD_USE_NM\" type=\"STRING\" size=\"32\"/><Column id=\"PURG_DSGN_SALSPRC\" type=\"STRING\" size=\"256\"/><Column id=\"DSTRB_STD_PRC\" type=\"STRING\" size=\"256\"/><Column id=\"MRK_LWST_SALSPRC\" type=\"STRING\" size=\"256\"/><Column id=\"CURR_UNIT_CD\" type=\"STRING\" size=\"32\"/><Column id=\"UPD_DTM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_exPrdPrcList","20","60",null,"580","20",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"220\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"45\"/><Column size=\"70\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell text=\"상품ID\"/><Cell col=\"1\" text=\"상품명\"/><Cell col=\"2\" text=\"공용전용구분\"/><Cell col=\"3\" text=\"SSP상품상태\"/><Cell col=\"4\" text=\"MD지정판매가\"/><Cell col=\"5\" text=\"ListPrice\"/><Cell col=\"6\" text=\"시장최저판매가\"/><Cell col=\"7\" text=\"판매통화\"/><Cell col=\"8\" text=\"최종변경일\"/></Band><Band id=\"body\"><Cell text=\"bind:PRD_ID_NUM\" displaytype=\"text\" color=\"blue\" textDecoration=\"underline\"/><Cell col=\"1\" text=\"bind:PRD_NM\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:PUB_ONLY_SPR_NM\"/><Cell col=\"3\" text=\"bind:PRD_USE_NM\"/><Cell col=\"4\" text=\"bind:PURG_DSGN_SALSPRC\" displaytype=\"mask\" maskeditformat=\"#,###.####\" maskeditlimitbymask=\"both\"/><Cell col=\"5\" text=\"bind:DSTRB_STD_PRC\" displaytype=\"mask\" maskeditformat=\"#,###.####\" maskeditlimitbymask=\"both\"/><Cell col=\"6\" text=\"bind:MRK_LWST_SALSPRC\" displaytype=\"mask\" maskeditformat=\"#,###.####\" maskeditlimitbymask=\"both\"/><Cell col=\"7\" text=\"bind:CURR_UNIT_CD\"/><Cell col=\"8\" text=\"bind:UPD_DTM\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" displaytype=\"expr:UPD_DTM!=undefined?&apos;date&apos;:&apos;&apos;\" calendardisplayinvalidtype=\"none\" calendardisplaynulltype=\"none\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format></Formats>");
            ...
            obj = new Button("btn_write",null,"25","69","28","btn_insert:5",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("개별등록");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static05","40","0",null,"32","0",null,"1276",null,null,null,this.Div00_00.form);
            obj.set_taborder("0");
            ...
            obj = new Edit("edt_prdNm","320","4","174","24",null,null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("5");
            ...
            obj = new Edit("edt_prdId","159","4","151","24",null,null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("11");
            ...
            obj = new BindItem("item3","Div00_00.form.edt_prdId","value","ds_search","ePRD_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_CA_55_B.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_CA_55_B.xfdl", function() {
        /*******************************************************
        ...
        ************************************************************************************************/
        ...
        this.fn_doSearch = function(page)
        {
             ...
             var sUrl = "/pc/prd-prc-chg/select-exprd-prc-list.do";
        ...
        this.fn_largeFileDown = function (){
        	...
        	var sUrl = "/pc/pc-xlsx-down/excel-prd-prc-chg.do";
        	var inDs = "ds_search=ds_search";
        	var outDs = "";
        	var arg = "";
        ...
        this.fn_received = function(svcID, errorCode, errorMsg)	{
        	...
        	switch(svcID)
        	{
        		case 'selectIntlLwstList' :
        			...
        			this.ds_exPrdPrcList.set_rowposition(-1);
        		break;
        		...
        		case "commonCodeSearch":
        			...
        			this.Div00_00.form.cmb_pubOnlySprCd.set_value("P");
        			break;
        ...
        ************************************************************************************************/
        ...
        {
        	//카테고리
        	this.ds_search.setColumn(0,"PUB_ONLY_SPR_CD","P");
        	this.ds_search.setColumn(0,"ePRD_ID","");
        	this.ds_search.setColumn(0,"PRD_NM","");
        	this.ds_search.setColumn(0,"PRD_USE_YN","Y");
        ...
        {
        	var param = {pgmId : "SSP_BO_CA_55_01"}; //프로그램 ID ex) CO_SA_01
        ...
        this.Div00_grd_exPrdPrcList_oncellclick = function(obj,e)
        {
        	if(e.cell == 0){
        		...
        		if(typeof(this.parent.parent.parent.isDiv) == "boolean"){
        		}else{
        			var objParam = {};
        			//objParam.prdIdNum = this.ds_exPrdPrcList.getColumn(e.row, "PRD_ID_NUM");
        			//objParam.prdId = this.ds_exPrdPrcList.getColumn(e.row, "PRD_ID");
        			objParam.prdId = this.ds_exPrdPrcList.getColumn(e.row, "PRD_ID_NUM");
        			objParam.prdNm = this.ds_exPrdPrcList.getColumn(e.row, "PRD_NM");
        			objParam.exYn = "Y";
        			this.gfn_openPopup("btn_cell0", "PC::SSP_BO_CA_30.xfdl", objParam, "fn_popupCallback");
        		}
        ...
        this.Div00_btn_write_onclick = function(obj,e)
        {
        	var objParam = {};
        	var options = {};
        	objParam.exYn = "Y";
        	this.gfn_openPopup("btn_cell0", "PC::SSP_BO_CA_30.xfdl", objParam, "fn_popupCallback",options);
        };

        this.Div00_Button01_onclick = function(obj,e)
        {

        	if(this.ds_exPrdPrcList.getRowCount() > 0){
        		this.ofn_exportExcel({form:this, grid:this.Div00.form.grd_exPrdPrcList, fileName:"참조가격관리"});
        	}else{
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.btn_write.addEventHandler("onclick",this.Div00_btn_write_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_CA_55_B.xfdl");
