(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_CA_02");
            this.set_titletext("가격변동 이력관리");
            ...
            obj = new Button("btn_bzplcIdPopup","edt_bzplcNm:4","24","24","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("33");
            obj.set_cssclass("btn_WF_multi");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("btn_bzplcIdMultiInput","btn_bzplcIdPopup:4","24","24","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("34");
            ...
            obj = new Combo("cbo_pubOnlySprCd","610","55","150","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("39");
            ...
            obj = new BindItem("item11","Div00.form.edt_grpId","value","ds_search","eREPR_PRD_GRP_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","Div00.form.cbo_pubOnlySprCd","value","ds_search","PUB_ONLY_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item0","Div00.form.cbo_date","value","ds_search","INQ_PERD_SPR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_CA_02.xfdl","OD::odUtils.xjs");
        this.addIncludeScript("SSP_BO_CA_02.xfdl","PC::pcUtils.xjs");
        this.registerScript("SSP_BO_CA_02.xfdl", function() {
        /*******************************************************
        ...
        ************************************************************************************************/
        	...
        	this.fn_commonCodeSearch = function(){
        		this.ds_search.setColumn(0, "codeList", "PRC_APLY_SPR_CD,REPR_PRD_SPR_CD,DISP_STATS_CD,INQ_PERD_SPR_CD,PUB_ONLY_SPR_CD");
        		this.ds_search.setColumn(0, "langCd", "KO");
        		var sSvcId = "commonCodeSearch";
        		var sUrl = "/co/select-common-code-list.do";
        		var inDs = "ds_search=ds_search";
        		var outDs = "ds_prcAplySprCd=ds_output1 ds_reprPrdSprCd=ds_output2 ds_dispStatsCd=ds_output3 ds_inqPerdSpr=ds_output4 ds_pubOnlySprCd=ds_output5";
        		var arg = "";
        	...
        	this.fn_search = function(page)	{
        		var sSvcId = "List";
        		var sUrl = "/pc/pc-prc-mng/selectPrcHistList.do";
        		var inDs = "ds_search=ds_search";
        	...
        	this.fn_largeFileDown = function (){
        		...
        		var sUrl = "/pc/pc-xlsx-down/excel-prd-prc-hst.do";
        		var inDs = "ds_search=ds_search";
        		var outDs = "";
        		var arg = "";
        		this.gfn_transaction(sSvcId, sUrl, inDs, outDs, arg, "fn_callBack");
        ...
        ************************************************************************************************/
        	this.fn_callBack = function(svcID, errorCode, errorMsg)	{
        		...
        		if(svcID == "commonCodeSearch"){
        			...
        			this.ds_pubOnlySprCd.insertRow(0); //SSP진열상태
        ...
        ************************************************************************************************/
        ...
        this.Div00_btn_oprtrPopup_onclick = function(obj,e)
        {
        	if("" == this.ds_search.getColumn(0, "CHRPSN_CD")){
        		alert(this.fn_getMessage("ERRP000024"));
        	}else{
        		var params = {};
        		var options = {};
        ...
        this.Div01_cmb_viewCount_onitemchanged = function(obj,e)
        {
        ...
        this.Div01_Button01_onclick = function(obj,e)
        {
        	if(this.ds_list.getRowCount() > 0){
        		this.ofn_exportExcel({form:this, grid:this.grd_mainList, fileName:"가격변동이력관리"});
        	}else{
        ...
        this.loadIncludeScript("SSP_BO_CA_02.xfdl");
