(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_autoMnlSprCd", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_autoLogicTgtCd", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_title","20","362","200","23",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_title02");
            obj.set_text("■ 목록");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","20","380","300","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("※사용 상태 상품 10개 등록 필수 (PC)\r\n※사용 상태 상품 2개 등록 필수 (모바일)");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_mainPrdDtlList","20","439",null,null,"20","23",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Div("div_detail","0","0",null,"365","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);

            obj = new Static("Static05","20","181",null,"152","20",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_cm_box02L_tdt");
            obj.set_text("");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static09_00","20","100",null,"32","20",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_title00","20","155","200","23",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_title02");
            obj.set_text("■ 조회");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static07","30","39",null,"32","20",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static09","20","69",null,"32","20",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("카테고리BEST");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_expsMthd","20","39","130","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("5");
            obj.set_text("노출방식");
            obj.set_cssclass("sta_cm_box01L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static10","20","69","130","64",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("6");
            obj.set_text("자동로직");
            obj.set_cssclass("sta_cm_box01L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static08","20","8",null,"32","20",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_cm_box02L_tdt");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_img","20","8","130","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("8");
            obj.set_text("아이콘");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_wgt1","160","101","60","30",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("9");
            obj.set_text("매출액(원)");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("edt_slamtWgt","225","104","60","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("10");
            obj.set_inputtype("number");
            obj.set_maxlength("5");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static11","80","69","70","32",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("11");
            obj.set_text("대상");
            obj.set_cssclass("sta_cm_box01L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("Static12","80","100","70","33",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("12");
            obj.set_text("가중치");
            obj.set_cssclass("sta_cm_box01L");
            this.div_detail.addChild(obj.name, obj);

            obj = new Radio("rdo_autoMnlSprCd","160","42","200","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_innerdataset("ds_autoMnlSprCd");
            ...
            obj = new Radio("rdo_autoLogicTgtCd","160","73","200","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("14");
            obj.set_direction("vertical");
            obj.set_innerdataset("ds_autoLogicTgtCd");
            obj.set_codecolumn("COM_DTL_CD");
            obj.set_datacolumn("COM_DTL_CD_NM");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_wgt2","305","101","60","30",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("15");
            obj.set_text("X 주문(건)");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("edt_ordCntWgt","370","104","60","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("16");
            obj.set_inputtype("number");
            obj.set_maxlength("5");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_wgt3","445","101","101","30",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("17");
            obj.set_text("X 재고상품(여부)");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("edt_invnPrdWgt","551","104","60","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("18");
            obj.set_inputtype("number");
            obj.set_maxlength("5");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_per1","272","102","19","29",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("19");
            obj.set_text("%");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_per1_00","416","102","19","29",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("20");
            obj.set_text("%");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_per1_00_00","597","102","19","29",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("21");
            obj.set_text("%");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_delete",null,"143","81","28","108",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("22");
            obj.set_text("삭제");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_save",null,"143","81","28","21",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("23");
            obj.set_text("저장");
            this.div_detail.addChild(obj.name, obj);

            obj = new Grid("grd_oprUnitList","340","189","582","135",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("24");
            ...
            obj = new Button("btn_oprUnitMulti","926","189","24","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("25");
            obj.set_cssclass("btn_WF_multi");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_oprUnitMultiText","926","217","24","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("26");
            obj.set_cssclass("btn_WF_document");
            this.div_detail.addChild(obj.name, obj);

            obj = new Radio("rdo_noticSprCd","160","200","155","115",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("27");
            ...
            obj = new Static("Static01","20","181","130","152",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("28");
            obj.set_text("게시구분");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.div_detail.addChild(obj.name, obj);

            obj = new Edit("edt_atflNm","160","12","420","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("29");
            obj.set_readonly("true");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_imgAdd","584","12","60","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("30");
            obj.set_text("파일찾기");
            this.div_detail.addChild(obj.name, obj);

            obj = new Static("sta_imgSize","687","11","300","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("31");
            obj.set_text("이미지사이즈 : 72*72");
            obj.set_textAlign("left");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_imgDelete","648","12","24","24",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("32");
            obj.set_text("X");
            obj.set_visible("true");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_search",null,"337","60","28","22",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("33");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_require");
            this.div_detail.addChild(obj.name, obj);

            obj = new Button("btn_reset",null,"337","60","28","86",null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("34");
            obj.set_text("초기화");
            this.div_detail.addChild(obj.name, obj);
            ...
            obj = new Button("btn_excelDownload",null,"401","110","28","276",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("엑셀다운로드");
            obj.set_cssclass("btn_WF_excel");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_mainPrdDtlListExcel","10","880",null,null,"30","-330",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_autofittype("col");
            obj.set_fillareatype("none");
            obj.set_binddataset("ds_mainPrdDtlList");
            ...
            obj.set_nodatatext("조회된 데이터가 없습니다.");
            obj.set_autosizingtype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"100\"/><Column size=\"270\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell text=\"정렬순번\"/><Cell col=\"1\" text=\"상품코드\"/><Cell col=\"2\" text=\"상품명\"/><Cell col=\"3\" text=\"구분\"/><Cell col=\"4\" text=\"공용전용구분\"/><Cell col=\"5\" text=\"대표상품구분\"/><Cell col=\"6\" text=\"SSP상품상태\"/><Cell col=\"7\" text=\"SSP진열상태\"/><Cell col=\"8\" text=\"등록일\"/></Band><Band id=\"body\"><Cell text=\"bind:SORT_NO\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:PRD_ID_VIEW\" color=\"blue\" textDecoration=\"underline\"/><Cell col=\"2\" text=\"bind:PRD_NM\"/><Cell col=\"3\" text=\"bind:NOTIC_SPR_CD\" textAlign=\"center\" expr=\"NOTIC_SPR_CD==&apos;20&apos; ? &apos;로그인후전체&apos; : NOTIC_SPR_CD==&apos;30&apos; ? OPR_UNIT_NM : &apos;전체&apos;\"/><Cell col=\"4\" text=\"bind:PUB_ONLY_SPR_NM\"/><Cell col=\"5\" text=\"bind:REPR_PRD_SPR_NM\"/><Cell col=\"6\" text=\"bind:PRD_USE_YN\" expr=\"PRD_USE_YN==&apos;Y&apos; ? &apos;사용&apos; : &apos;미사용&apos;\"/><Cell col=\"7\" text=\"bind:DISP_STATS_NM\"/><Cell col=\"8\" text=\"bind:PRD_REG_DT\" edittype=\"none\" maskedittype=\"string\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendareditformat=\"yyyy-MM-dd\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_largeExcel",null,"337","118","28","149",null,null,null,null,null,this);
            obj.set_taborder("11");
            ...
            obj = new BindItem("item0","div_detail.form.edt_slamtWgt","value","ds_mainPrd","SLAMT_WGT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","div_detail.form.rdo_autoMnlSprCd","value","ds_mainPrd","AUTO_MNL_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","div_detail.form.rdo_autoLogicTgtCd","value","ds_mainPrd","AUTO_LOGIC_TGT_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","div_detail.form.edt_ordCntWgt","value","ds_mainPrd","ODR_CNT_WGT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","div_detail.form.edt_invnPrdWgt","value","ds_mainPrd","INVN_PRD_WGT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div_detail.form.rdo_noticSprCd","value","ds_dtlSearch","EXPS_NOTIC_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","div_detail.form.edt_atflNm","value","ds_mainPrd","ATFL_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_VA_01_2.xfdl","CO::coUtils.xjs");
        this.addIncludeScript("SSP_BO_VA_01_2.xfdl","OD::odUtils.xjs");
        this.addIncludeScript("SSP_BO_VA_01_2.xfdl","SA::saUtils.xjs");
        this.registerScript("SSP_BO_VA_01_2.xfdl", function() {
        /*******************************************************
        PROJECT NAME : 메인상품(카테고리 BEST)
        ...
        ************************************************************************************************/
        ...
        this.fn_commonCodeSearch = function()
        {
        	...
        	var outDs = "ds_noticSprCd=ds_output1 ds_autoMnlSprCd=ds_output2 ds_autoLogicTgtCd=ds_output3";
        	var arg = "";

        	//조회 값 담기
        	this.ds_search.setColumn(0, "CODE_LIST", "EXPS_NOTIC_SPR_CD,AUTO_MNL_SPR_CD,AUTO_LOGIC_TGT_CD");
        ...
        this.fn_delete = function() {
        	var sSvcId = "deleteMainPrd";
        	var sUrl = "/sa/main-prd/delete-main-prd.do";
        	var inDs = "ds_delete=ds_mainPrd"
        	var outDs = "";
        	var arg = "";
        	var callback = "fn_callBack";
        ...
        this.fn_callBack = function(svcID, errorCode, errorMsg)
        {
        	switch(svcID) {
        		...
        		case "deleteMainPrd" :
        			...
        			this.ds_mainPrd.clearData();
        			this.ds_mainPrd.addRow();

        			// 메인상품 노출 목록 재조회, 포지션 최상단으로 위치 이동
        ...
        ************************************************************************************************/
        ...
        this.cfn_formInit = function(){
        	this.div_detail.form.sta_expsMthd.uEssentiel = "true";
        ...
        ************************************************************************************************/
        ...
        this.fn_setInit = function() {
        	...
        	var vMainPrdExpsPstId = this.ds_mainPrd.getColumn(0, "MAIN_PRD_EXPS_PST_ID");
        	var vHrnkMainPrdExpsPstId = this.ds_mainPrd.getColumn(0, "HRNK_MAIN_PRD_EXPS_PST_ID");
        	var catgDelYn = this.ds_mainPrd.getColumn(0, "CATG_DEL_YN");
        	var chnTpCd = this.ds_mainPrd.getColumn(0, "CHN_TP_CD");

        	if(chnTpCd == "P") {
        		this.div_detail.form.sta_imgSize.set_text("이미지사이즈 : 72*72");
        	} else if(chnTpCd == "M") {
        		this.div_detail.form.sta_imgSize.set_text("이미지사이즈 : 81*81");
        	}

        	this.fn_chgAutoMnlSprCd();

        	//삭제 버튼 노출 여부
        	if(catgDelYn == "Y") {
        		this.div_detail.form.btn_delete.set_visible(true);
        	} else {
        		this.div_detail.form.btn_delete.set_visible(false);
        	}

        	//카테고리BEST에서 저장되지 않은 카테고리에 대해선 버튼 disable
        	if(vMainPrdExpsPstId == 0) {
        ...
        //노출방식 수정
        this.fn_chgAutoMnlSprCd = function() {

        	// 노출방식 없으면 등록안된 걸로 판단. 노출방식:자동으로 기본 세팅
        	if(this.gfn_isNull(this.div_detail.form.rdo_autoMnlSprCd.value)) {
        		this.div_detail.form.rdo_autoMnlSprCd.set_index(0);
        	}
        	// 자동로직:대상 비었으면 전체로 기본 세팅
        	if(this.gfn_isNull(this.div_detail.form.rdo_autoLogicTgtCd.value)) {
        		this.div_detail.form.rdo_autoLogicTgtCd.set_index(0);
        	}


        	if(this.div_detail.form.rdo_autoMnlSprCd.value == "20") { //수동
        		this.div_detail.form.rdo_autoLogicTgtCd.set_enable(false);
        		this.div_detail.form.edt_slamtWgt.set_enable(false);
        		this.div_detail.form.edt_ordCntWgt.set_enable(false);
        		this.div_detail.form.edt_invnPrdWgt.set_enable(false);
        	} else {
        		this.div_detail.form.rdo_autoLogicTgtCd.set_enable(true);
        		this.div_detail.form.edt_slamtWgt.set_enable(true);
        		this.div_detail.form.edt_ordCntWgt.set_enable(true);
        		this.div_detail.form.edt_invnPrdWgt.set_enable(true);
        	}
        }
        ...
        ************************************************************************************************/
        ...
        {
        	if(confirm(this.fn_getMessage("ERRN000050"))) { // 현재 선택하신 카테고리의 메인상품정보와 상품들이 모두 삭제 됩니다.\n삭제하시겠습니까?
        		this.fn_delete();
        	}
        };
        ...
        {
        	if(this.gfn_isNull(this.div_detail.form.rdo_autoMnlSprCd.value)) {
        		alert(this.fn_getMessage("ERRN000001", "노출방식은")); // 노출방식은 필수 입력 값입니다.
        		return;
        	}
        	if(this.div_detail.form.rdo_autoMnlSprCd.value == "10") {
        		if(this.gfn_isNull(this.div_detail.form.rdo_autoLogicTgtCd.value)) {
        			alert(this.fn_getMessage("ERRN000001", "노출방식이 자동일 때 자동로직-대상은")); // 노출방식이 자동일 때 자동로직-대상은 필수 입력 값 입니다.
        			return;
        		}
        		if(this.gfn_isNull(this.div_detail.form.edt_slamtWgt.value) || this.gfn_isNull(this.div_detail.form.edt_ordCntWgt.value) || this.gfn_isNull(this.div_detail.form.edt_invnPrdWgt.value)) {
        			alert(this.fn_getMessage("ERRN000001", "노출방식이 자동일 때 가중치는")); // 노출방식이 자동일 때 가중치는 필수 입력 값 입니다."
        			return;
        		}
        	}

        	if(this.div_detail.form.edt_atflNm.value == "" || this.div_detail.form.edt_atflNm.value == undefined) {
        		alert(this.fn_getMessage("ERRN000001", "아이콘은")); // 아이콘은 필수 입력항목입니다.
        ...
        //노출방식 변경
        this.rdo_autoMnlSprCd_onitemchanged = function(obj,e)
        {
        	this.fn_chgAutoMnlSprCd();
        };
        ...
        ************************************************************************************************/
        ...
        {
        	// 현재 페이지 data
        	var sFileName = "카테고리BEST상품_EXCEL_EXPORT";			// file Name
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_detail.form.Static11.addEventHandler("onclick",this.Div_top_info_Static02_onclick,this);
            this.div_detail.form.Static12.addEventHandler("onclick",this.Div_top_info_Static02_onclick,this);
            this.div_detail.form.rdo_autoMnlSprCd.addEventHandler("onitemchanged",this.rdo_autoMnlSprCd_onitemchanged,this);
            this.div_detail.form.btn_delete.addEventHandler("onclick",this.btn_delete_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_VA_01_2.xfdl");
