(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static04_01_00","20","366",null,"64","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static65_00_00_00_00","20","335",null,"32","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static65_00_00","20","429",null,"32","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static65_00_00_00","20","241",null,"32","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("Static65_00","20","210",null,"32","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_cm_box02L");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static04","20","179",null,"32","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ttl","160","183","720","24",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo_noticSprCd","160","34","157","116",null,null,null,null,null,null,this);
            ...
            obj = new Static("sta_dispPeriod","20","210","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("전시 기간");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_dispStrDt","160","214","100","24",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("cal_WF_calendar");
            obj.set_dateformat("yyyy-MM-dd");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_dispEndDt","277","214","100","24",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_cssclass("cal_WF_calendar");
            obj.set_dateformat("yyyy-MM-dd");
            this.addChild(obj.name, obj);

            obj = new Static("Static59","264","214","9","24",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Static("Static04_01","20","272",null,"64","20",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta_gnbUrl","100","272","50","64",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("URL");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_mainUrlCnsolSprCd","sta_gnbUrl:10","276","300","24",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edt_mainUrl","sta_gnbUrl:10","307",null,"24","40",null,null,null,null,null,this);
            obj.set_taborder("20");
            this.addChild(obj.name, obj);

            obj = new Static("sta_gnbImg","100","241","50","32",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("이미지");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Static("sta_mainImgSize","659","245","300","24",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("이미지사이즈 : 400*619");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Static("sta_ttl","20","179","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("제목");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_mainAtflNm","sta_gnbImg:10","245","420","24",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn_mainImgAdd","564","245","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("파일찾기");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_useYn","20","429","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_useYn","sta_useYn:10","433","150","24",null,null,null,null,null,null,this);
            ...
            obj = new Static("sta_gnb","20","241","81","95",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text("GNB");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Static("sta_catg","20","335","81","95",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("카테고리");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Static("sta_catgUrl","100","366","50","64",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_text("URL");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Static("sta_catgImg","100","335","50","32",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("이미지");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_subAtflNm","sta_catgImg:10","339","420","24",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn_subImgAdd","584","339","60","24",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_text("파일찾기");
            this.addChild(obj.name, obj);

            obj = new Static("sta_subImgSize","679","339",null,"24","20",null,null,null,null,null,this);
            obj.set_taborder("35");
            obj.set_text("이미지사이즈 : 968*320");
            obj.set_textAlign("left");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_subUrl","sta_catgUrl:10","401",null,"24","40",null,null,null,null,null,this);
            obj.set_taborder("36");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_subUrlCnsolSprCd","sta_catgUrl:10","373","300","24",null,null,null,null,null,null,this);
            obj.set_innerdataset("ds_urlCnsolSprCd");
            obj.set_datacolumn("COM_DTL_CD_NM");
            obj.set_codecolumn("COM_DTL_CD");
            obj.set_taborder("37");
            ...
            obj = new CheckBox("chk_noEdnDt","391","214","90","24",null,null,null,null,null,null,this);
            obj.set_taborder("38");
            obj.set_text("종료일 없음");
            obj.set_truevalue("Y");
            ...
            obj = new Button("btn_mainImgDelete","628","245","24","24",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            obj.set_text("X");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn_subImgDelete","648","340","24","24",null,null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_text("X");
            obj.set_visible("true");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_totalCountOprUnit","240","30","121","25",null,null,null,null,null,null,this);
            obj.set_taborder("44");
            obj.set_text("(총 0건)");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_notLogn_Inc_Yn","160","153","134","20",null,null,null,null,null,null,this);
            obj.set_taborder("46");
            ...
            obj = new BindItem("item7","rdo_useYn","value","ds_bnrInfo","USE_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","edt_subAtflNm","value","ds_bnrInfo","SUB_ATFL_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","edt_subUrl","value","ds_bnrInfo","SUB_URL");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","rdo_subUrlCnsolSprCd","value","ds_bnrInfo","SUB_URL_CNSOL_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","chk_noEdnDt","value","ds_cpnInfo","UNLMT_PUBC_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_VA_08_3.xfdl","CO::coUtils.xjs");
        this.addIncludeScript("SSP_BO_VA_08_3.xfdl","OD::odUtils.xjs");
        this.addIncludeScript("SSP_BO_VA_08_3.xfdl","SA::saUtils.xjs");
        this.registerScript("SSP_BO_VA_08_3.xfdl", function() {
        /*******************************************************
        	...
        	switch(svcID) {
        		case "commonCodeSearch" :
        			...
        			if(!this.gfn_isNull(this.ds_search.getColumn(0, "BNR_INFO_SEQ"))) {
        				...
        				this.rdo_subUrlCnsolSprCd.set_index(0);
        		...
        		case "saveBnrInfo" :
        			if(errorCode == ""){
        				...
        				if(this.parent.bnrExpsPstId == 0) { // 1뎁스 카테고리 최초 저장시에는 트리 목록 재 조회(배너 노출 정보 insert)
        					// 배너 노출 목록 재조회, 포지션 최상단으로 위치 이동
        					this.opener.parent.parent.parent.preSelectRowPosition = 0;
        					this.opener.parent.parent.parent.fn_bnrExpsListSearch();
        					this.opener.parent.parent.parent.tab_dtl.set_tabindex(0);
        					this.close();
        				} else {
        ...
        ************************************************************************************************/
        ...
        this.fn_subUrlCnsolSprCd = function() {
        	if(this.rdo_subUrlCnsolSprCd.value == "10") {
        		this.edt_subUrl.set_enable(false);
        	} else {
        		this.edt_subUrl.set_enable(true);
        	}
        }
        ...
        ************************************************************************************************/
        ...
        // 		return;
        // 	}
        // 	if(this.edt_subAtflNm.value == "" || this.edt_subAtflNm.value == undefined) {
        // 		alert(this.fn_getMessage("ERRN000001", "이미지는")); // 이미지는 필수 입력항목입니다.
        // 		this.edt_subAtflNm.setFocus();
        // 		return;
        // 	}
        ...
        // 		return;
        // 	}
        // 	if(this.rdo_subUrlCnsolSprCd.value == "" || this.rdo_subUrlCnsolSprCd.value == undefined) {
        // 		alert(this.fn_getMessage("ERRN000001", "URL은")); // URL은 필수 입력항목입니다.
        // 		this.rdo_subUrlCnsolSprCd.setFocus();
        // 		return;
        // 	}
        	if(!this.gfn_isNull(this.rdo_mainUrlCnsolSprCd.value) && this.rdo_mainUrlCnsolSprCd.value != 10) {
        	...
        	if(!this.gfn_isNull(this.rdo_subUrlCnsolSprCd.value) && this.rdo_subUrlCnsolSprCd.value != 10) {
        		if(this.edt_subUrl.value == "" || this.edt_subUrl.value == undefined) {
        			alert(this.fn_getMessage("ERRN000001", "링크없음이 아니면 URL은")); // 링크없음이 아니면 URL은 필수 입력항목입니다.
        			this.edt_subUrl.setFocus();
        			return;
        		}
        	}
        ...
        this.edt_atflNm_onmouseenter = function(obj,e)
        {
        	...
        	if(e.fromobject.id == "edt_mainAtflNm") {
        		docRegId = this.ds_bnrInfo.getColumn(0, "MAIN_DOC_REG_ID");
        		docRegSeq = this.ds_bnrInfo.getColumn(0, "MAIN_DOC_REG_SEQ");
        		this.img_view.set_width(200);
         		this.img_view.set_height(300);
        	} else if(e.fromobject.id == "edt_subAtflNm") {
        		docRegId = this.ds_bnrInfo.getColumn(0, "SUB_DOC_REG_ID");
        		docRegSeq = this.ds_bnrInfo.getColumn(0, "SUB_DOC_REG_SEQ");
        		this.img_view.set_width(450);
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_subAtflNm.addEventHandler("oneditclick",this.edt_atflNm_onclick,this);
            this.edt_subAtflNm.addEventHandler("onmouseenter",this.edt_atflNm_onmouseenter,this);
            this.edt_subAtflNm.addEventHandler("onmouseleave",this.edt_atflNm_onmouseleave,this);
            this.btn_subImgAdd.addEventHandler("onclick",this.btn_subImageAdd_onclick,this);
            this.rdo_subUrlCnsolSprCd.addEventHandler("onitemchanged",this.rdo_subUrlCnsolSprCd_onitemchanged,this);
            ...
            this.btn_subImgDelete.addEventHandler("onclick",this.btn_subImgDelete_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_VA_08_3.xfdl");
