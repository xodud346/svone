(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_OA_28");
            this.set_titletext("주문번호 조회  멀티 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ODR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ODR_ITM_NO\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TOTAL_COUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"START_NUM\">0</Col><Col id=\"ROW_COUNT\">10</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_list01", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ODR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"1\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"170\"/><Column size=\"142\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"사업장ID\"/><Cell col=\"2\" text=\"사업장명\"/><Cell col=\"3\" text=\"주문번호\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;none&quot; : &quot;checkboxcontrol&quot;\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:BZPLC_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"2\" text=\"bind:BZPLC_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"3\" text=\"bind:ODR_NO\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("msk_searchCount",null,"60","100","27","btn_search:68",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_value("1000");
            this.addChild(obj.name, obj);

            obj = new Grid("grid_list02","20","grid_list01:50",null,null,"20","100",null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_autofittype("col");
            obj.set_nodatatext("조회된 결과가 없습니다.");
            ...
            obj.set_selecttype("row");
            obj.set_font("12px/normal \"맑은 고딕\"");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"170\"/><Column size=\"148\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"사업장ID\"/><Cell col=\"2\" text=\"사업장명\"/><Cell col=\"3\" text=\"주문번호\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:BZPLC_ID\"/><Cell col=\"2\" text=\"bind:BZPLC_NM\"/><Cell col=\"3\" text=\"bind:ODR_NO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_add",null,"grid_list01:10","65","30","20",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("추가");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_OA_28.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_OA_28.xfdl", function() {
        // 주문번호 조회
        ...
        ************************************************************************************************/
        ...
        this.SSP_BO_OA_28_onload = function(obj,e)
        {
        	//공통 함수 호출(필수)
        ...
        this.SSP_BO_OA_28_onkeyup = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.fn_search = function() {
        	var sSvcId = "selectOdrNumberList";
        	var sUrl = "/od/odrPopup/selectOdrNumberList.do";
        ...
        this.fn_searchOdrNumberCount = function() {
        	var sSvcId = "selectOdrNumberCount";
        	var sUrl = "/od/odrPopup/selectOdrNumberCount.do";
        	var inDs = "ds_search=ds_search";
        	var outDs = "";
        	var arg = "";
        	this.gfn_transaction(sSvcId, sUrl, inDs, outDs, arg, "fn_callBack");
        ...
        ************************************************************************************************/
        ...
        this.fn_initGrid = function() {
        	...
        	this.ds_list01.setColumn(0, "BZPLC_NM", "");
        ...
        this.fn_clearAll = function() {
        	...
        	this.ds_search.setColumn(0, "ODR_NO", "");
        ...
        this.fn_searchMapSetting = function() {
        	this.ds_search.setColumn(0, "BZPLC_ID", this.ds_list01.getColumn(0, "BZPLC_ID"));
        	this.ds_search.setColumn(0, "BZPLC_NM", this.ds_list01.getColumn(0, "BZPLC_NM"));
        	this.ds_search.setColumn(0, "ODR_NO", this.ds_list01.getColumn(0, "ODR_NO"));
        ...
        trace("### fn_setSearchCondition()");
        	this.ds_list01.setColumn(0, "BZPLC_ID", this.ds_search.getColumn(0, "BZPLC_ID"));
        	this.ds_list01.setColumn(0, "BZPLC_NM", this.ds_search.getColumn(0, "BZPLC_NM"));
        	this.ds_list01.setColumn(0, "ODR_NO", this.ds_search.getColumn(0, "ODR_NO"));
        };

        // 추가기능(특정 데이터만 하단 그리드에 데이터 추가)
        this.fn_addSelectedData = function(selectedRowPosition) {
        	/*
        	var chkCnt = this.ds_list01.getCaseCount("CHK == 1");
        	if (chkCnt <= 0) {
        		trace("### fn_addSelectedData - There is no selection row.");
        		return;
        	}
        	*/
        ...
        this.fn_addCheckedData = function() {
        	...
        	if (this.fn_validationCheck(this.ds_list01)) {
        		...
        		/*var nRowCnt = this.ds_list02.mergeData( this.ds_list01 );
        		if(nRowCnt > 0 )	{
        			var arrRows = this.ds_list02.extractRows("CHK=='0'");
        			for(var i = 0; i < arrRows.length; i++) {
        				this.ds_list02.deleteRow(i);
        			}
        		}*/


        		for(var i = 0; i < this.ds_list01.rowcount; i++) {
        			//var bzplcId = this.ds_list01.getColumn(i, "BZPLC_ID");
        			var odrNo = this.ds_list01.getColumn(i, "ODR_NO");

        			//this.ds_list02.filter("BZPLC_ID=='" + bzplcId + "' && ODR_NO=='" + odrNo + "'");
        			this.ds_list02.filter("ODR_NO=='" + odrNo + "'");
        ...
        ************************************************************************************************/
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	var bzplcNm = this.ds_list01.getColumn(0, "BZPLC_NM");
        	var odrNo = this.ds_list01.getColumn(0, "ODR_NO");
        	var searchCount = this.msk_searchCount.text;

        	trace("### bzplcID : " + bzplcID + ", bzplcNm : " + bzplcNm + ", odrNo : " + odrNo);

        	if ((bzplcID == undefined || bzplcID == "") &&
        	    (bzplcNm == undefined || bzplcNm == "") &&
        ...
        this.btn_delete_onclick = function(obj,e)
        {
        	...
        	if (this.fn_validationCheck(this.ds_list02)) {
        		for (var i = 0; i < this.ds_list02.rowcount; i++) {
        			if (this.ds_list02.getColumn(i, "CHK") == "1") {
        				delArr.push(i);
        				delIdArr.push(this.ds_list02.getColumn(i, "BZPLC_ID"));
        				delOdrArr.push(this.ds_list02.getColumn(i, "ODR_NO"));
        			}
        		}
        	}
        	...
        	for(var i = 0; i < delIdArr.length; i++) {
        		this.ds_list01.filter("BZPLC_ID=='" + delIdArr[i] + "' && ODR_NO=='" + delOdrArr[i] + "'");
        ...
        ************************************************************************************************/
        ...
        {
            this.addEventHandler("onload",this.SSP_BO_OA_28_onload,this);
            this.addEventHandler("onkeyup",this.SSP_BO_OA_28_onkeyup,this);
        ...
        this.loadIncludeScript("SSP_BO_OA_28.xfdl");
