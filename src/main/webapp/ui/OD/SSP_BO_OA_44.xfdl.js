(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_OA_44");
            this.set_titletext("MD담당자 멀티 팝업");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"170\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"담당자 ID\"/><Cell col=\"2\" text=\"담당자명\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;none&quot; : &quot;checkboxcontrol&quot;\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:OPRTR_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"2\" text=\"bind:OPRTR_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_selecttype("row");
            obj.set_font("12px/normal \"맑은 고딕\"");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"170\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"담당자 ID\"/><Cell col=\"2\" text=\"담당자명\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:OPRTR_ID\"/><Cell col=\"2\" text=\"bind:OPRTR_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_OA_44.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_OA_44.xfdl", function() {
        // 운영자 멀티 조회
        ...
        ************************************************************************************************/
        ...
        this.SSP_BO_OA_44_onkeyup = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.fn_search = function() {
        	var sSvcId = "selectMDOprtrList";
        	var sUrl = "/od/odrPopup/selectMDOprtrList.do";
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeyup",this.SSP_BO_OA_44_onkeyup,this);
        ...
        this.loadIncludeScript("SSP_BO_OA_44.xfdl");
