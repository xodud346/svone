(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_OA_55");
            this.set_titletext("결재자 조회 팝업");
            if (Form == this.constructor)
            {
                this._setFormPosition(880,658);
            }
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"MBR_BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JBPOS_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_list02", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"RN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_searchCB", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"GB\" type=\"STRING\" size=\"256\"/><Column id=\"ORI_BZPLC_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_totcnt","20",null,"300","29",null,"38",null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj.set_font("12px/normal \"맑은 고딕\"");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"85\"/><Column size=\"120\"/><Column size=\"85\"/><Column size=\"140\"/><Column size=\"85\"/><Column size=\"140\"/><Column size=\"85\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"사업장ID\"/><Cell col=\"1\" text=\"사업장명\"/><Cell col=\"2\" text=\"운영단위ID\"/><Cell col=\"3\" text=\"운영단위명\"/><Cell col=\"4\" text=\"부서ID\"/><Cell col=\"5\" text=\"부서명\"/><Cell col=\"6\" text=\"회원ID\"/><Cell col=\"7\" text=\"회원명\"/></Band><Band id=\"body\"><Cell text=\"bind:BZPLC_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:BZPLC_NM\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" combodataset=\"ds_list02\" combocodecol=\"BZPLC_ID\" combodatacol=\"BZPLC_NM\" combodisplaynulltext=\"전체\" combotype=\"dropdown\"/><Cell col=\"2\" text=\"bind:OPR_UNIT_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"3\" text=\"bind:OPR_UNIT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"4\" text=\"bind:DEPT_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"5\" text=\"bind:DEPT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"6\" text=\"bind:MBR_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"7\" text=\"bind:MBR_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",880,658,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SSP_BO_OA_55.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_OA_55.xfdl", function() {
        // 플랜트 조회
        ...
        ************************************************************************************************/
        ...
        this.SSP_BO_OA_55_onload = function(obj,e)
        {
        	...
        	this.fn_initGrid();
        	if(this.fv_GB == undefined )   this.fv_GB = "1";
        	if(this.fv_GB == "2")	this.staticTitle.set_text("발주자 조회");

        	this.fn_regShortCutMethod();
        };

        this.SSP_BO_OA_55_onkeyup = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.fn_searchCombo = function() {
        	this.fn_searchBzplcMapSetting();
        	var sSvcId = "selectMbrPopup";
        	var sUrl = "/od/orderChange/selectMbrPopup.do";
        	var inDs = "ds_search=ds_searchCB";
        ...
        ************************************************************************************************/
        this.fn_callBack = function(svcID, errorCode, errorMsg)	{
        	...
        	else if(svcID == "selectMbrPopup"){
        		this.sta_totcnt.set_visible(false);
        		this.ds_searchCB.set_rowposition(0);

        		//var bSucc = this.Grid00.setCellProperty( "head", 0, "color", "black");
        		this.grid_list01.selectCell(0,1,true);
        		this.fn_odCommLoading("fn_delayedSearch");
        	}
        };

        this.fn_delayedSearch = function()
        {
        	this.fn_search();
        }
        ...
        ************************************************************************************************/
        ...
        this.fn_searchMapSetting = function() {
        	...
        	this.ds_search.setColumn(0, "BZPLC_ID", this.ds_list01.getColumn(0, "BZPLC_NM"));
        ...
        this.fn_searchBzplcMapSetting = function() {
        	this.ds_searchCB.setColumn(0, "CO_CD", this.fv_coCd);
        	this.ds_searchCB.setColumn(0, "GB", this.fv_GB);
        	this.ds_searchCB.setColumn(0, "ORI_BZPLC_ID", this.fv_oriBzplcId);
        	//trace(this.fn_getStrFromDataset(this.ds_searchCB,0));
        };

        this.fn_setSearchCondition = function() {
        	this.ds_list01.setColumn(0, "BZPLC_NM", this.ds_search.getColumn(0, "BZPLC_ID"));
        ...
        ************************************************************************************************/
        ...
        this.btn_select_onclick = function(obj,e)
        {
        	...
        	if( selectedRow == -1 )
        	{
        		if(this.fv_GB == "2")	alert(this.fn_getMessage("ERRS000134","발주자"));
        		else	alert(this.fn_getMessage("ERRS000134","결재자"));
        		return;
        	}

        	resData.MBR_ID = this.ds_list01.getColumn(selectedRow, "MBR_ID");
        	resData.MBR_NM = this.ds_list01.getColumn(selectedRow, "MBR_NM");
        	resData.JBPOS_NM = this.ds_list01.getColumn(selectedRow, "JBPOS_NM");
        ...
        {
            this.addEventHandler("onload",this.SSP_BO_OA_55_onload,this);
            this.addEventHandler("onkeyup",this.SSP_BO_OA_55_onkeyup,this);
        ...
        this.loadIncludeScript("SSP_BO_OA_55.xfdl");
