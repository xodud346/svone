(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_OA_42");
            this.set_titletext("주문연계현황");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\" band=\"left\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"160\"/><Column size=\"200\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"80\"/><Column size=\"280\"/><Column size=\"112\"/><Column size=\"100\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"140\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell text=\"행선택\"/><Cell col=\"1\" text=\"주문번호\"/><Cell col=\"2\" text=\"인터페이스 구분\"/><Cell col=\"3\" text=\"상품 ID\"/><Cell col=\"4\" text=\"상품명\"/><Cell col=\"5\" text=\"메세지ID\"/><Cell col=\"6\" text=\"전송일시\"/><Cell col=\"7\" text=\"수신일시\"/><Cell col=\"8\" text=\"성공 여부\"/><Cell col=\"9\" text=\"메시지\"/><Cell col=\"10\" text=\"MRO생성여부\"/><Cell col=\"11\" text=\"VOC NO\"/><Cell col=\"12\" text=\"승인번호\"/><Cell col=\"13\" text=\"승인/취소금액\"/><Cell col=\"14\" text=\"MD담당자\"/><Cell col=\"15\" text=\"영업담당자\"/><Cell col=\"16\" text=\"구매담당자\"/><Cell col=\"17\" text=\"서비스담당자\"/><Cell col=\"18\" text=\"전송자\"/></Band><Band id=\"body\"><Cell displaytype=\"imagecontrol\" text=\"expr:comp.parent.parent.parent.fn_isSelectedRow(currow, comp.currentcell) == true ? &quot;url(&apos;theme://images/btn_WF_page_last.png&apos;)&quot; : &quot;&quot;\"/><Cell col=\"1\" text=\"bind:JNT_ODR_ITM_NO\" color=\"blue\" textDecoration=\"underline\"/><Cell col=\"2\" text=\"bind:IF_PI_NM\"/><Cell col=\"3\" text=\"bind:PRD_ID\"/><Cell col=\"4\" text=\"bind:PRD_NM\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:IF_MSG_ID\"/><Cell col=\"6\" text=\"bind:REG_DTM\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" text=\"bind:IF_PROC_RSLT_DTM\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" text=\"bind:IF_PROC_RSLT_CD_NM\"/><Cell col=\"9\" displaytype=\"normal\" calendardateformat=\"yyyy.MM.dd\" text=\"bind:IF_PI_MSG\" textAlign=\"left\"/><Cell col=\"10\" text=\"bind:MRO_CRT_YN\"/><Cell col=\"11\" text=\"bind:VOC_NO\"/><Cell col=\"12\" text=\"bind:TNO\" textAlign=\"center\"/><Cell col=\"13\" text=\"bind:AMOUNT\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"###,###,###,###\"/><Cell col=\"14\" text=\"bind:MD_CHRPSN_ID_NM\"/><Cell col=\"15\" text=\"bind:SALS_CHR_CD_NM\"/><Cell col=\"16\" text=\"bind:PURG_CHRPSN_ID_NM\"/><Cell col=\"17\" text=\"bind:SVC_CHRPSN_ID_NM\"/><Cell col=\"18\" text=\"bind:SND_USR_NM\"/></Band></Format></Formats>");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Button("btn_excelDownload",null,"0","110","28","317",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("2");
            obj.set_text("엑셀다운로드");
            ...
            obj = new Button("btn_resend",null,"0","60","28","432",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("3");
            obj.set_text("재전송");
            obj.set_cssclass("btn_WF_default");
            obj.set_enable("true");
            ...
            obj = new Combo("cmb_viewCount",null,"0","104","28","208",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("4");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Button("btn_layoutSave",null,"0","100","28","104",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("6");
            obj.set_text("레이아웃 저장");
            obj.set_visible("true");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Button("btn_layoutInit",null,"0","100","28","0",null,null,null,null,null,this.Div00_00.form);
            obj.set_taborder("7");
            obj.set_text("레이아웃 초기화");
            obj.set_visible("true");
            this.Div00_00.addChild(obj.name, obj);

            obj = new Div("div_paging","20","Div00_00:20",null,"30","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_formscrollbartype("none none");
        ...
        // User Script
        this.addIncludeScript("SSP_BO_OA_42.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_OA_42.xfdl", function() {
        // 연계정보 조회
        ...
        ************************************************************************************************/
        ...
        this.SSP_BO_OA_42_onclose = function(obj,e)
        {
        	this.fn_closeAll();
        };

        this.SSP_BO_OA_42_onkeyup = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.cfn_formInit = function(){
        	...
        	this.Div00_00.form.grid_list01.uRightMouse = "true";
        	this.Div00_00.form.grid_list01.uPersonalFlag = "true";
        }

        this.cfn_personalPopupClose = function(sRet) {
        	this.Div00_00.form.grid_list01.set_formats(sRet);
        ...
        ************************************************************************************************/
        ...
        this.fn_isSelectedRow = function(currow, cellPos) {
        	if (cellPos == 0) {
        		if (currow == this.ds_list01.rowposition) {
        			trace("### 001 -  currow : " + currow + ", rowposition : " + this.ds_list01.rowposition);
        			return true;
        		}
        		return false;
        	}
        	...
        	if (currow == this.selectedRow) {
        		trace("### 002 -  currow : " + currow + ", selectedRow : " + this.selectedRow);
        		return true;
        	}
        ...
        */
        ...
        this.fn_procVisibleResendButton = function() {
        	...
        	if(this.ds_list02.findRow("IF_PROC_RSLT_CD","S") < 0) {
        		...
        		} else if (this.ds_list01.findRow("IF_PI_ID","SD01920") >= 0) { // 2023.03.17 매출정산일 경우 한번 더 확인한다.
        			if("S" != lastPiRsltCd) { // 성공한 것이 아니라면 재전송 할 수 있다.
        				this.fn_setVisibleResendButton(true);
        			}
        		}

        	} else if (this.ds_list01.findRow("IF_PI_ID","SD01920") >= 0) {
        		var lastPiRsltCd = this.ds_list02.getColumn(0, "IF_PROC_RSLT_CD");
        		if("S" != lastPiRsltCd) {
        			this.fn_setVisibleResendButton(true);
        		}
        ...
        this.fn_setVisibleResendButton = function(visable) {
        	this.Div00_00.form.btn_resend.set_visible(visable);
        };
        ...
        ************************************************************************************************/
        ...
        {
        	this.gfn_personalSave("grid_list01", this.Div00_00.form.grid_list01.getCurFormatString());
        };
        // 레이아웃 초기화
        this.btn_layoutInit_onclick = function(obj,e)
        {
        	this.gfn_personalReset("grid_list01");
        	this.Div00_00.form.grid_list01.set_formats(this.Div00_00.form.grid_list01.uOrgFormat);
        };
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onclose",this.SSP_BO_OA_42_onclose,this);
            this.addEventHandler("onkeyup",this.SSP_BO_OA_42_onkeyup,this);
            ...
            this.Div00_00.form.grid_list01.addEventHandler("oncellclick",this.grid_list01_oncellclick,this);
            ...
            this.Div00_00.form.btn_layoutSave.addEventHandler("onclick",this.btn_layoutSave_onclick,this);
            this.Div00_00.form.btn_layoutInit.addEventHandler("onclick",this.btn_layoutInit_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_OA_42.xfdl");
