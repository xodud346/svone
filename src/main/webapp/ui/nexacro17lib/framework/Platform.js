		...
		if (this._keydown_element) {
			...
			if (comp) {
				...
				if (!altKey && !ctrlKey && !shiftKey && !metaKey) {
					if (this._keydown_element instanceof nexacro.InputElement) {
						var is_subcontrol = comp._is_subcontrol;
						var rootComp = comp._getFromComponent(comp);
						if (!is_subcontrol || (is_subcontrol && ((rootComp instanceof nexacro.Grid && (this._keydown_element.owner_elem.parent instanceof nexacro._GridEditControl || this._keydown_element.owner_elem.parent instanceof nexacro._GridMaskEditControl)) || (rootComp instanceof nexacro.ListView && (this._keydown_element.owner_elem.parent instanceof nexacro._CellEditControl || this._keydown_element.owner_elem.parent instanceof nexacro._CellMaskEditControl))))) {
					...
					if (keycode == 229) {
						...
						this._keydown_element_list.delete_item(key);
				...
				if (nexacro._OS == "Android" && keycode == nexacro.Event.KEY_RETURN && is_accept_imeaction) {
