(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"ACCT_TP_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_TP_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"220\"/><Column size=\"100\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"계정유형\"/><Cell col=\"2\" text=\"계정ID\"/><Cell col=\"3\" text=\"계정명\"/><Cell col=\"4\" text=\"계정코드\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:currow == 0 ? &quot;none&quot; :  &quot;checkbox&quot; \" cssclass=\"expr:currow == 0 ? &quot;grd_WF_searchImg&quot; : &quot;&quot;\"/><Cell col=\"1\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;combotext&quot;\" combodataset=\"ds_acctTpCd\" combocodecol=\"ACCT_TP_CD\" combodatacol=\"ACCT_TP_NM\" text=\"bind:ACCT_TP_CD\"/><Cell col=\"2\" text=\"bind:ACCT_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"3\" text=\"bind:ACCT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:ACCT_CD\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_autofittype("col");
            obj.set_cellsizebandtype("body");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"220\"/><Column size=\"100\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"계정유형\"/><Cell col=\"2\" text=\"계정ID\"/><Cell col=\"3\" text=\"계정명\"/><Cell col=\"4\" text=\"계정코드\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:ACCT_TP_CD\" combodataset=\"ds_acctTpCd\" combocodecol=\"ACCT_TP_CD\" combodatacol=\"ACCT_TP_NM\" displaytype=\"combotext\"/><Cell col=\"2\" textAlign=\"center\" text=\"bind:ACCT_ID\"/><Cell col=\"3\" text=\"bind:ACCT_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:ACCT_CD\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_PP_31.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_PP_31.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_PP_31.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        ...
        ************************************************************************************************/
        this.cfn_formInit = function(){
        	this.grd_list01.uUnCheckRow = "0";  //,구분자로 여려Row 설정 가능
        };
        /***********************************************************************************************
        *  개발자(사용자) 함수 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.btn_add_onclick = function(obj,e){
        	...
        	//체크된 값
        	if(this.ds_acctList.rowcount != 0){
        		aTotalArr = this.ds_acctList.extractRows("CHK == 1");
        	}

        	this.ds_acctList.set_enableevent(false);
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			if(aTotalArr[i] != 0){ //첫번째 row가 선택되어있다면 제외
        				var findRow = this.ds_select.findRowExpr("ACCT_ID == '" + this.ds_acctList.getColumn(aTotalArr[i], "ACCT_ID") + "'");
        				if(findRow < 0){
        					nRow = this.ds_select.addRow();
        					this.ds_select.copyRow(nRow, this.ds_acctList, aTotalArr[i]);
        					this.ds_select.setColumn(nRow, "CHK", 0);
        					this.ds_acctList.setColumn(aTotalArr[i], "CHK", 1);
        				}
        			}
        		}
        		this.grd_list01.clearSelect(); // 선택된 영역 해제
        	}else{
        		//alert("선택된 데이터가 없습니다.");
        		alert(this.fn_getMessage("ERRC000050", "데이터"));
        	}

        	this.ds_acctList.set_enableevent(true);
        ...
        this.btn_select_onclick = function(obj,e){
        	...
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		...
        		resData.ACCT_TP_CD  = this.ds_select.getColumn(i, "ACCT_TP_CD");	//박재광 2022.06.23
        ...
        this.loadIncludeScript("SSP_BO_PP_31.xfdl");
