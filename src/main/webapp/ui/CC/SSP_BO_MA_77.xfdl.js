(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_TP_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_TP_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_LVL\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"HRNK_ACCT_SEARCH_YN\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"LVL\" type=\"STRING\" size=\"256\"/><Column id=\"UNDER_ACCT_SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_TP_CD\" type=\"STRING\" size=\"256\"/><Column id=\"EXC_ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"START_NUM\">0</Col><Col id=\"ROW_COUNT\">1000</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"149\"/><Column size=\"100\"/><Column size=\"240\"/><Column size=\"120\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell text=\"계정유형\"/><Cell col=\"1\" text=\"비용부서\"/><Cell col=\"2\" text=\"계정ID\"/><Cell col=\"3\" text=\"계정명\"/><Cell col=\"4\" text=\"계정코드\"/></Band><Band id=\"body\"><Cell text=\"bind:ACCT_TP_CD\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;combotext&quot;\" combodataset=\"ds_acctTpCd\" combocodecol=\"ACCT_TP_CD\" combodatacol=\"ACCT_TP_NM\"/><Cell col=\"1\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;combotext&quot;\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" text=\"bind:DEPT_ID\" combodataset=\"ds_dept\" combocodecol=\"DEPT_ID\" combodatacol=\"DEPT_NM\"/><Cell col=\"2\" text=\"bind:ACCT_ID\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"3\" text=\"bind:ACCT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:ACCT_CD\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_77.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_MA_77.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_77.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        this.fn_onLoad = function(obj,e){
        	...
        	this.ds_search.setColumn(0, "MBR_ID" , this.MBR_ID );


        	this.fn_dept();

        	if(!this.gfn_isNull(this.ACCT_ID) || !this.gfn_isNull(this.ACCT_NM) || !this.gfn_isNull(this.DEPT_ID)){
        ...
        ************************************************************************************************/
        ...
        // 비용부서 리스트 조회
        this.fn_dept = function() {
        	var sSvcId = "selectComCostTrnsfDeptList";
        	var sUrl = "/cc/acct/selectComCostTrnsfDeptList.do";
        	var inDs = "ds_search=ds_search";
        	var outDs = "ds_dept=ds_output1";
        	var arg = "";
        ...
        ************************************************************************************************/
        ...
        this.fn_initGrid = function(){
        	...
        	this.ds_acctList.setColumn(0, "DEPT_ID"    , this.ds_search.getColumn(0, "DEPT_ID")     );
        ...
        this.fn_searchMapSetting = function(){
        	this.ds_search.setColumn(0, "DEPT_ID"   , this.ds_acctList.getColumn(0, "DEPT_ID")     );
        ...
        ************************************************************************************************/
        ...
        this.grd_list_oncelldblclick = function(obj,e){
        	if(e.row != 0){
        		...
        		var fRow = this.ds_acctTpCd.findRowExpr("ACCT_TP_CD=='"+this.ds_acctList.getColumn(this.ds_acctList.rowposition, "ACCT_TP_CD")+"'");
        	    resData.ACCT_TP_NM  = this.ds_acctTpCd.getColumn(fRow, "ACCT_TP_NM");

        		resData.DEPT_ID     = this.ds_acctList.getColumn(this.ds_acctList.rowposition, "DEPT_ID"  );
        		resData.DEPT_NM     = this.ds_acctList.getColumn(this.ds_acctList.rowposition, "DEPT_NM"  );
        ...
        this.CLIENT_SINGLE_POPUP_onkeydown = function(obj,e)
        {
