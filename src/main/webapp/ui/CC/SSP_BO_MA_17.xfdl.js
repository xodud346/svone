(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_select", this);
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MRO_DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"102\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"MRO회원ID\"/><Cell col=\"2\" text=\"MRO회원명\"/><Cell col=\"3\" text=\"회원ID\"/><Cell col=\"4\" text=\"MRO운영단위\"/><Cell col=\"5\" text=\"MRO부서\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:currow == 0 ? &quot;none&quot; :  &quot;checkbox&quot; \" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:MRO_MBR_ID\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"2\" text=\"bind:MRO_MBR_NM\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"3\" text=\"bind:MBR_ID\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"4\" text=\"bind:MRO_OPR_UNIT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"5\" text=\"bind:MRO_DEPT_NM\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj.set_scrollbartype("auto fixed");
            obj.set_selecttype("multirow");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"102\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"MRO회원ID\"/><Cell col=\"2\" text=\"MRO회원명\"/><Cell col=\"3\" text=\"회원ID\"/><Cell col=\"4\" text=\"MRO운영단위\"/><Cell col=\"5\" text=\"MRO부서\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:MRO_MBR_ID\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:MRO_MBR_NM\"/><Cell col=\"3\" text=\"bind:MBR_ID\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:MRO_OPR_UNIT_NM\"/><Cell col=\"5\" text=\"bind:MRO_DEPT_NM\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_17.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_17.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        ...
        ************************************************************************************************/
        ...
        {
        	var sSvcId = "search";
        	var sUrl = "/bo/cust/mbr/select-mro-mbr-list.do";
        ...
        ************************************************************************************************/
        this.fn_paramSetting = function (param){
        	if(this.gfn_isNull(param.coCd) || param.coCd ==  undefined){
        		alert(this.fn_getMessage("ERRC000004", "회사코드")); //&1 은(는) 필수 입력값입니다.
        		return;
        	}

        	this.ds_search.setColumn(0, "CO_CD", param.coCd);
        	this.ds_search.setColumn(0, "MRO_MBR_ID", param.mroMbrId);
        	this.ds_search.setColumn(0, "MBR_ID", param.mbrId);

        	if(!this.gfn_isNull(param.mroMbrId) || !this.gfn_isNull(param.mbrId)){
        		this.fn_search(true);
        	}else{
        		this.fn_initGrid();
        	}
        ...
        this.fn_initGrid = function(){
        	...
        	this.ds_memLogin.setColumn(0, "MRO_MBR_ID",  this.ds_search.getColumn(0, "MRO_MBR_ID"));
        	this.ds_memLogin.setColumn(0, "MRO_MBR_NM",  this.ds_search.getColumn(0, "MRO_MBR_NM"));
        	this.ds_memLogin.setColumn(0, "MRO_OPR_UNIT_NM",  this.ds_search.getColumn(0, "MRO_OPR_UNIT_NM"));
        	this.ds_memLogin.setColumn(0, "MRO_DEPT_NM",  this.ds_search.getColumn(0, "MRO_DEPT_NM"));
        ...
        this.fn_dsSelectCheck = function(){
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		var findRow = this.ds_memLogin.findRowExpr("currow != 0 && MRO_MBR_ID == '" + this.ds_select.getColumn(i, "MRO_MBR_ID") + "'");
        		if(findRow > -1){
        ...
        this.fn_searchMapSetting = function(){
        	...
        	this.ds_search.setColumn(0, "MRO_MBR_ID", this.ds_memLogin.getColumn(0, "MRO_MBR_ID"));
        	this.ds_search.setColumn(0, "MRO_MBR_NM", this.ds_memLogin.getColumn(0, "MRO_MBR_NM"));
        	this.ds_search.setColumn(0, "MRO_OPR_UNIT_NM", this.ds_memLogin.getColumn(0, "MRO_OPR_UNIT_NM"));
        	this.ds_search.setColumn(0, "MRO_DEPT_NM", this.ds_memLogin.getColumn(0, "MRO_DEPT_NM"));
        };
        ...
        ************************************************************************************************/
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			if(aTotalArr[i] != 0){ //첫번째 row가 선택되어있다면 제외
        				var findRow = this.ds_select.findRowExpr("MRO_MBR_ID == '" + this.ds_memLogin.getColumn(aTotalArr[i], "MRO_MBR_ID") + "'");
        				if(findRow < 0){
        		...
        		alert(this.fn_getMessage("ERRS000137")); //선택한 데이터가 없습니다.
        	}
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			var findRow = this.ds_memLogin.findRowExpr("currow != 0 && MRO_MBR_ID == '" + this.ds_select.getColumn(aTotalArr[i], "MRO_MBR_ID") + "'");
        			if(findRow >= 0){
        ...
        this.btn_select_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		resData.MRO_MBR_ID= this.ds_select.getColumn(i, "MRO_MBR_ID");
        		resData.MRO_MBR_NM= this.ds_select.getColumn(i, "MRO_MBR_NM");
        ...
        {
        	if(e.row != 0 && e.col != 0){
        		var findRow = this.ds_select.findRowExpr("MRO_MBR_ID == '" + this.ds_memLogin.getColumn(e.row, "MRO_MBR_ID") + "'");
        		if(findRow < 0){
        ...
        this.Div00_grd_list02_oncelldblclick = function(obj,e)
        {
        	if(e.row >= 0 ){
        		if(e.col != 0){
        			var findRow = this.ds_memLogin.findRowExpr("currow != 0 && MRO_MBR_ID == '" + this.ds_select.getColumn(e.row, "MRO_MBR_ID") + "'");
        			if(findRow >= 0){
        				this.ds_memLogin.setColumn(findRow, "CHK", 0);
        				this.Div00.form.grd_list01.selectRow(findRow, false); //선택해제
        			}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.grd_list01.addEventHandler("onenterdown",this.grd_list01_onenterdown,this);
        ...
        this.loadIncludeScript("SSP_BO_MA_17.xfdl");
