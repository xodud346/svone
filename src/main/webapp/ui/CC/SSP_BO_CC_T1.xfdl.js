(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_CC_T1");
            this.set_titletext("예산설정");
        ...
        // User Script
        this.registerScript("SSP_BO_CC_T1.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_CC_T1.xfdl");
