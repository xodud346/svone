(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_MA_90");
            this.set_titletext("일반고객 종결대상 사업장 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"1\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"STATE\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"TRMN_TGT_TP_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BAT_PROC_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"TRMN_PROC_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"TRMN_PROC_REQR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"TRMN_PROC_REQR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BIZNO\" type=\"STRING\" size=\"256\"/><Column id=\"CONT_STR_DT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"TRMN_TGT_TP_CD\" type=\"STRING\" size=\"256\"/><Column id=\"FROM_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"TO_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"INQ_COND_DTLS\" type=\"STRING\" size=\"256\"/><Column id=\"eOPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"eBZPLC_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"START_NUM\">0</Col><Col id=\"ROW_COUNT\">20</Col><Col id=\"OPR_UNIT_ID\"/><Col id=\"BZPLC_ID\"/><Col id=\"TYPE\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("ds_trmnTgtTpCd", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_trmnType", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"COM_DTL_CD\">1</Col><Col id=\"COM_DTL_CD_NM\">종결대기</Col></Row><Row><Col id=\"COM_DTL_CD\">2</Col><Col id=\"COM_DTL_CD_NM\">종결</Col></Row><Row><Col id=\"COM_DTL_CD_NM\">전체</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"STAT\" type=\"STRING\" size=\"256\"/><Column id=\"MESG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_trmnTgtTpCd2", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static06","20","20",null,"32","20",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_cm_box02L_tdt");
            obj.set_text("");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static07","20","20","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_text("사업장");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("edt_bzplcId","Static07:10","24","231","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_enable("true");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static08","520","20","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            obj.set_text("운영단위");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("edt_oprUnitId","Static08:10","24","231","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            obj.set_enable("true");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static05","20","51",null,"32","20",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            ...
            obj = new Static("Static04","883","51","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("14");
            obj.set_text("종결요청일");
            obj.set_cssclass("sta_cm_box01L");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static04_00","520","51","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("12");
            obj.set_text("종결상태");
            obj.set_cssclass("sta_cm_box01L");
            this.Div00.addChild(obj.name, obj);

            obj = new Radio("rdo_trmnTgtTpCd","Static02:10","55","340","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("11");
            obj.set_direction("vertical");
            obj.set_innerdataset("ds_trmnTgtTpCd");
            ...
            obj = new Radio("rdo_type","Static04_00:10","55","220","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("13");
            obj.set_innerdataset("ds_trmnType");
            obj.set_codecolumn("COM_DTL_CD");
            obj.set_datacolumn("COM_DTL_CD_NM");
            obj.set_direction("vertical");
            this.Div00.addChild(obj.name, obj);

            obj = new Calendar("cal_fromDt","Static04:10","55","96","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("15");
            ...
            obj = new Calendar("cal_toDt","1131","55","96","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("17");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyy-MM-dd");
            obj.set_headformat("yyyy.MM.DD");
            ...
            obj = new Combo("cbo_inqPerdSprCd","1231","55","78","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("18");
            ...
            obj = new Button("btn_search",null,"Static05:10","60","28","20",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("20");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_require");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("btn_reset",null,"Static05:10","60","28","btn_search:4",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("19");
            obj.set_text("초기화");
            obj.set_cssclass("btn_WF_reset");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("cbo_page",null,"Div00:20","100","28","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_layoutClear",null,"150","110","28","cbo_page:4",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("레이아웃 초기화");
            this.addChild(obj.name, obj);

            obj = new Button("btn_layoutSave",null,"150","100","28","btn_layoutClear:4",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("레이아웃 저장");
            this.addChild(obj.name, obj);

            obj = new Button("btn_req",null,"150","87","28","btn_layoutSave:4",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("종결요청");
            this.addChild(obj.name, obj);

            obj = new Button("btn_batch",null,"150","87","28","btn_req:4",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("수동배치");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"150","110","28","btn_batch:4",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("엑셀다운로드");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"23\"/><Column size=\"63\"/><Column size=\"64\"/><Column size=\"155\"/><Column size=\"64\"/><Column size=\"155\"/><Column size=\"80\"/><Column size=\"104\"/><Column size=\"84\"/><Column size=\"104\"/><Column size=\"71\"/><Column size=\"71\"/><Column size=\"104\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"상태\"/><Cell col=\"2\" text=\"사업장 ID\"/><Cell col=\"3\" text=\"사업장명\"/><Cell col=\"4\" text=\"운영단위 ID\"/><Cell col=\"5\" text=\"운영단위명\"/><Cell col=\"6\" text=\"종결대상유형\"/><Cell col=\"7\" text=\"사업자등록번호\"/><Cell col=\"8\" text=\"계약시작일\"/><Cell col=\"9\" text=\"배치수신일시\"/><Cell col=\"10\" text=\"종결요청자ID\"/><Cell col=\"11\" text=\"종결요청자\"/><Cell col=\"12\" text=\"종결요청일시\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"expr:String(STATE).valueOf() == &quot;종결&quot; ? &quot;none&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:String(STATE).valueOf() == &quot;종결&quot; ? &quot;none&quot; : &quot;checkbox&quot;\"/><Cell col=\"1\" text=\"bind:STATE\"/><Cell col=\"2\" text=\"bind:BZPLC_ID\"/><Cell col=\"3\" text=\"bind:BZPLC_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:OPR_UNIT_ID\"/><Cell col=\"5\" text=\"bind:OPR_UNIT_NM\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:TRMN_TGT_TP_CD\" displaytype=\"combotext\" combodataset=\"ds_trmnTgtTpCd2\" combodatacol=\"COM_DTL_CD_NM\" combocodecol=\"COM_DTL_CD\"/><Cell col=\"7\" text=\"bind:BIZNO\"/><Cell col=\"8\" text=\"bind:CONT_STR_DT\" maskeditformat=\"yyyy-MM-dd\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"9\" text=\"bind:BAT_PROC_DTM\" edittype=\"none\" calendardisplaynulltype=\"none\" maskedittype=\"string\" maskeditformat=\"yyyy-MM-dd hh:mm:ss\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/><Cell col=\"10\" text=\"bind:TRMN_PROC_REQR_ID\"/><Cell col=\"11\" text=\"bind:TRMN_PROC_REQR_NM\"/><Cell col=\"12\" text=\"bind:TRMN_PROC_DTM\" edittype=\"none\" calendardisplaynulltype=\"none\" maskedittype=\"string\" maskeditformat=\"yyyy-MM-dd hh:mm:ss\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item1","Div00.form.cal_fromDt","value","ds_search","FROM_DATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","Div00.form.cal_toDt","value","ds_search","TO_DATE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","Div00.form.rdo_type","value","ds_search","TYPE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","Div00.form.rdo_trmnTgtTpCd","value","ds_search","TRMN_TGT_TP_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_90.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_MA_90.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_90.xfdl", function() {
        /*******************************************************
          PROJECT NAME : SSP-BO
          CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        	...
        	// 수동배치
        	this.btn_batch_onclick = function(obj,e)
        	{
        	...
        	this.SSP_BO_MA_90_onkeyup = function(obj,e)
        	{
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeyup",this.SSP_BO_MA_90_onkeyup,this);
            ...
            this.Div00.form.rdo_trmnTgtTpCd.addEventHandler("canitemchange",this.Div00_Radio00_canitemchange,this);
            this.Div00.form.rdo_type.addEventHandler("canitemchange",this.Div00_Radio00_00_canitemchange,this);
            ...
            this.btn_req.addEventHandler("onclick",this.btn_req_onclick,this);
            this.btn_batch.addEventHandler("onclick",this.btn_batch_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_MA_90.xfdl");
