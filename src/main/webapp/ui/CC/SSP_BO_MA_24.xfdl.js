(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"1\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LEV_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"LEV_ID\" type=\"STRING\" size=\"256\"/><Column id=\"LEV_REA\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"FROM_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"TO_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"INQ_COND_DTLS\" type=\"STRING\" size=\"256\"/><Column id=\"eBZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"eOPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"eMBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"eDEPT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"START_NUM\">0</Col><Col id=\"ROW_COUNT\">20</Col><Col id=\"BZPLC_ID\"/><Col id=\"OPR_UNIT_ID\"/><Col id=\"DEPT_ID\"/><Col id=\"MBR_ID\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"COL_VALUE\" type=\"STRING\" size=\"256\"/><Column id=\"COL_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"COL_VALUE\">DRMC_DTM</Col><Col id=\"COL_NM\">휴먼전환일순</Col></Row><Row><Col id=\"COL_VALUE\">MBR_NM</Col><Col id=\"COL_NM\">회원명순</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"69\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"146\"/><Column size=\"80\"/><Column size=\"146\"/><Column size=\"80\"/><Column size=\"186\"/><Column size=\"93\"/><Column size=\"104\"/><Column size=\"263\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"고객 유형\"/><Cell col=\"1\" text=\"회원ID\"/><Cell col=\"2\" text=\"사업장ID\"/><Cell col=\"3\" text=\"사업장명\"/><Cell col=\"4\" text=\"운영단위ID\"/><Cell col=\"5\" text=\"운영단위명\"/><Cell col=\"6\" text=\"부서ID\"/><Cell col=\"7\" text=\"부서명\"/><Cell col=\"8\" text=\"탈퇴일\"/><Cell col=\"9\" text=\"탈퇴처리자\"/><Cell col=\"10\" text=\"탈퇴사유\"/></Band><Band id=\"body\"><Cell text=\"bind:CUST_SPR_CD\" combodataset=\"ds_custSprCd\" combodatacol=\"COM_DTL_CD_NM\" combocodecol=\"COM_DTL_CD\" displaytype=\"combotext\"/><Cell col=\"1\" text=\"bind:MBR_ID\" textDecoration=\"underline\" color=\"blue\"/><Cell col=\"2\" text=\"bind:BZPLC_ID\"/><Cell col=\"3\" text=\"bind:BZPLC_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:OPR_UNIT_ID\"/><Cell col=\"5\" text=\"bind:OPR_UNIT_NM\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:DEPT_ID\"/><Cell col=\"7\" text=\"bind:DEPT_NM\" textAlign=\"left\"/><Cell col=\"8\" text=\"bind:LEV_DTM\" edittype=\"none\" calendardisplaynulltype=\"none\" maskedittype=\"string\" maskeditformat=\"yyyy.MM.dd\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendareditformat=\"yyyy-MM-dd\"/><Cell col=\"9\" text=\"bind:LEV_ID\" expr=\" MBR_ID ==LEV_ID? LEV_ID+&quot;(본인)&quot;: LEV_ID\"/><Cell col=\"10\" text=\"bind:LEV_REA\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button01",null,"150","110","28","btn_layoutSave:4",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("엑셀다운로드");
            ...
            obj = new BindItem("item3","Div00.form.edt_bzplcId","value","ds_search","eBZPLC_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","Div00.form.edt_mbrId","value","ds_search","eMBR_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","Div00.form.edt_oprUnitId","value","ds_search","eOPR_UNIT_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","Div00.form.edt_deptId","value","ds_search","eDEPT_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","Div00.form.cbo_custSprCd","value","ds_search","CUST_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_24.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_MA_24.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_24.xfdl", function() {
        /*******************************************************
          PROJECT NAME : SSP-BO
          CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_MA_24.xfdl");
