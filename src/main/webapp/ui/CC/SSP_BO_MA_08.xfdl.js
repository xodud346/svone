(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("부서조회 생성");
            if (Form == this.constructor)
            {
                this._setFormPosition(1336,495);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_deptInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"32\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"32\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"32\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"32\"/><Column id=\"CUST_SPR_CD\" type=\"STRING\" size=\"32\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"32\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"32\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"32\"/><Column id=\"LVL\" type=\"STRING\" size=\"10\"/><Column id=\"DEPT_SRT_SEQ\" type=\"STRING\" size=\"32\"/><Column id=\"HRNK_DEPT_NM\" type=\"STRING\" size=\"32\"/><Column id=\"HRNK_DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"HGST_DEPT\" type=\"STRING\" size=\"32\"/><Column id=\"GI_CHRPSN_ID\" type=\"STRING\" size=\"32\"/><Column id=\"CCO_DEPT_CD\" type=\"STRING\" size=\"32\"/><Column id=\"ZPCD\" type=\"STRING\" size=\"32\"/><Column id=\"REPR_ADDR\" type=\"STRING\" size=\"256\"/><Column id=\"DTL_ADDR\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_OVER_AGD_YN\" type=\"STRING\" size=\"1\"/><Column id=\"BGT_TRNSF_AGD_YN\" type=\"STRING\" size=\"1\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"SUCCESS_YN\" type=\"STRING\" size=\"256\"/><Column id=\"RETURN_MSG\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DEPT_SRT_SEQ\">1</Col><Col id=\"BGT_OVER_AGD_YN\">N</Col><Col id=\"BGT_TRNSF_AGD_YN\">N</Col></Row></Rows>");
            ...
            obj = new Dataset("ds_output1", this);
            obj._setContents("<ColumnInfo><Column id=\"SUCCESS_YN\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"SUCCESS_YN\"/><Col id=\"USE_YN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("sta_title1","20","26","130","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("상위 정보");
            obj.set_cssclass("sta_WF_title01");
            this.addChild(obj.name, obj);

            obj = new Div("Div00","0","sta_title1:4",null,"40","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("검색 영역");
            ...
            obj = new Static("Static04","898","0","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_text("고객 구분");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("StaticStar2","459","0","130","32",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("운영단위");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("cbo_custSprCd","Static04:10","4","257","24",null,null,null,null,null,null,this.Div00.form);
            ...
            obj = new Edit("edt_oprUnitNm","edt_oprUnitId:4","4","158","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_bzplcId","StaticStar1:10","4","95","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("edt_bzplcNm","edt_bzplcId:4","4","158","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("btn_popBzplc","edt_bzplcNm:4","4","24","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            obj.set_cssclass("btn_WF_search02");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Div("Div01","0","sta_title2:4",null,"100","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div01");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static08","898","31","130","32",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("6");
            obj.set_text("입고 담당자");
            obj.set_cssclass("sta_cm_box01L");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static04","898","0","130","32",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("7");
            obj.set_text("부서 레벨");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_giChrpsn","Static08:10","35","257","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("8");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static08_00","459","31","130","32",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("9");
            obj.set_text("최상위 부서");
            obj.set_cssclass("sta_cm_box01L");
            this.Div01.addChild(obj.name, obj);

            obj = new Static("Static04_00","459","0","130","32",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("10");
            obj.set_text("부서 코드");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_deptId","Static04_00:10","4","257","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("11");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_hgstDept","Static08_00:10","35","257","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("12");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_hrnkDeptId","Static06:10","35","95","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("16");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_hrnkDeptNm","edt_hrnkDeptId:4","35","158","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("17");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_deptNm","StaticStar3:10","4","257","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("14");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_ccoDeptCd","Static10:10","66","257","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("15");
            this.Div01.addChild(obj.name, obj);

            obj = new Edit("edt_deptSrtSeq","Static04:10","4","197","24",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("18");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Static("StaticStar5","459","0","130","32",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("1");
            obj.set_text("주소");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div02.addChild(obj.name, obj);

            obj = new Edit("edt_reprAddr","StaticStar5:10","4","257","24",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("2");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("StaticStar6","898","0","130","32",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("3");
            obj.set_text("상세 주소");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.Div02.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_zpcd","StaticStar4:10","4","257","24",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("5");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div02.addChild(obj.name, obj);

            obj = new Edit("edt_dtlAddr","StaticStar6:10","4","257","24",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("6");
            obj.set_enable("true");
            this.Div02.addChild(obj.name, obj);
            ...
            obj = new Static("sta_title2_00_00","20","Div02:17","130","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("제어 권한");
            obj.set_cssclass("sta_WF_title01");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static04_00_00","459","0","130","32",null,null,null,null,null,null,this.Div03.form);
            obj.set_taborder("3");
            ...
            obj = new Button("btn_cancel","598","Div03:21","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save","btn_cancel:4","416","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("저장");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1336,495,this,function(p){});
            ...
            obj = new BindItem("item3","Div00.form.edt_bzplcId","value","ds_deptInfo","BZPLC_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item18","Div01.form.edt_hrnkDeptNm","value","ds_deptInfo","HRNK_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","Div01.form.edt_deptSrtSeq","value","ds_deptInfo","LVL");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_08.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_MA_08.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_08.xfdl", function() {
        /*******************************************************
          PROJECT NAME : SSP-BO
          CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.btn_popBzplc.addEventHandler("onclick",this.popOpen_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_MA_08.xfdl");
