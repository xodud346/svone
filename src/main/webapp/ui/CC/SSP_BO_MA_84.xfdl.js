(function()
{
    return function()
    {
        ...
        {
            this.set_name("form1");
            this.set_titletext("예산 부서/계정 설정(일반)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_PERD_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_YY\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_APLY_PERD_CD_1\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_APLY_PERD_CD_2\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_REG_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_TP_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ACCT_LVL\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"HRNK_ACCT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"HRNK_ACCT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_NO\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_YY\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_PERD_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_APLY_PERD_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_APLY_PERD_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_AMT\" type=\"STRING\" size=\"256\"/><Column id=\"CUR_BGT_AMT\" type=\"STRING\" size=\"256\"/><Column id=\"ORG_BGT_AMT\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_REG_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CHG_RSN\" type=\"STRING\" size=\"256\"/><Column id=\"CHG_RSN_HST\" type=\"STRING\" size=\"256\"/><Column id=\"TOT_ODR_AMT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtDeptId","117","40","263","24",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("10");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"110\"/><Column size=\"180\"/><Column size=\"50\"/><Column size=\"110\"/><Column size=\"180\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"160\"/><Column size=\"200\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"계정ID\"/><Cell col=\"1\" text=\"계정명\"/><Cell col=\"2\" text=\"레벨\"/><Cell col=\"3\" text=\"상위계정ID\"/><Cell col=\"4\" text=\"상위계정명\"/><Cell col=\"5\" text=\"예산 년/월\"/><Cell col=\"6\" text=\"예산 설정액\"/><Cell col=\"7\" text=\"주문가능액\"/><Cell col=\"8\" text=\"원 예산\"/><Cell col=\"9\" text=\"사유\"/><Cell col=\"10\" text=\"기존 사유\"/></Band><Band id=\"body\"><Cell text=\"bind:ACCT_ID\" displaytype=\"normal\" suppress=\"1\"/><Cell col=\"1\" text=\"bind:ACCT_NM\" textAlign=\"left\" suppress=\"1\"/><Cell col=\"2\" text=\"bind:ACCT_LVL\" cssclass=\"grd_WF_left\" textAlign=\"center\" suppress=\"1\"/><Cell col=\"3\" text=\"bind:HRNK_ACCT_ID\" suppress=\"1\"/><Cell col=\"4\" text=\"bind:HRNK_ACCT_NM\" suppress=\"1\"/><Cell col=\"5\" text=\"bind:BGT_APLY_PERD_NM\"/><Cell col=\"6\" displaytype=\"maskeditcontrol\" edittype=\"mask\" textAlign=\"right\" text=\"bind:BGT_AMT\" maskeditformat=\"###,###,###,###,##0\" maskeditlimitbymask=\"both\"/><Cell col=\"7\" text=\"bind:CUR_BGT_AMT\" displaytype=\"expr:CUR_BGT_AMT==&apos;-&apos; ? &apos;normal&apos; : &apos;number&apos;\" textAlign=\"right\"/><Cell col=\"8\" displaytype=\"expr:ORG_BGT_AMT==&apos;-&apos; ? &apos;normal&apos; : &apos;number&apos;\" textAlign=\"right\" text=\"bind:ORG_BGT_AMT\"/><Cell col=\"9\" displaytype=\"editcontrol\" edittype=\"text\" text=\"bind:CHG_RSN\"/><Cell col=\"10\" text=\"bind:CHG_RSN_HST\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MA_84.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MA_84.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_search = function (bInit){
        	var sSvcId = "search";
        	var sUrl = "/bo/cust/bgt/ssp_bo_ma_84/select-bgt-dept-dtl-mapp-list-by-dept.do";
        	var inDs = "ds_search=ds_search";
        ...
        ************************************************************************************************/
        ...
        this.cfn_formInit = function(){
        	...
        	this.ds_search.setColumn(0,"DEPT_ID",this.parent.DEPT_ID);
        	this.ds_search.setColumn(0,"DEPT_NM",this.parent.DEPT_NM);
        	...
        	this.div_search.form.edtDeptId.set_value(this.ds_search.getColumn(0,"DEPT_ID") + " | " + this.ds_search.getColumn(0,"DEPT_NM"));
        	...
        	if(this.ds_search.getColumn(0,"BGT_PERD_SPR_CD") == "1") { //월별
        		if(cboId == "cbo_month1") {
        			if(month > this.ds_search.getColumn(0,"BGT_APLY_PERD_CD_1")) {
        				alert(this.fn_getMessage("ERRC000021"));
        ...
        ************************************************************************************************/
        ...
        {
        	if(!confirm(this.fn_getMessage("ERRC000087"))) {
        		return;
        	}
        ...
        this.btn_save_onclick = function(obj,e)
        {
        	...
        	for(i=0; i<this.ds_list.getRowCount(); i++) {
        		if(this.ds_list.getRowType(i)=="4" && this.gfn_isNull(this.ds_list.getColumn(i,"BGT_AMT"))) { //수정건중 예산설정액이 공백일때
        			alert(this.fn_getMessage("ERRC000009", "예산설정액"));
        			return;
        		}
        	}
        ...
        this.loadIncludeScript("SSP_BO_MA_84.xfdl");
