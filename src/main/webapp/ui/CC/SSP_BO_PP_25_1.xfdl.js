(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_PP_25_1");
            this.set_titletext("회원 멀티 조회");
            if (Form == this.constructor)
            {
                this._setFormPosition(870,673);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_memLogin", this);
            obj._setContents("<ColumnInfo><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LOGN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"MBR_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LOGN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"APRV_AUTH_USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"ORD_AUTH_USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"GI_AUTH_USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"CRD_STL_AUTH_USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"CRD_STL_AUTH_USE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BGT_AUTH_USE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ADJ_AUTH_USE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MNG_AUTH_USE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TAXINV_AUTH_USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_select","385","603","60","30",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("선택");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"160\"/><Column size=\"102\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"사업장\"/><Cell col=\"2\" text=\"부서\"/><Cell col=\"3\" text=\"운영단위\"/><Cell col=\"4\" text=\"회원ID\"/><Cell col=\"5\" text=\"회원명\"/><Cell col=\"6\" text=\"로그인ID\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:currow == 0 ? &quot;none&quot; :  &quot;checkbox&quot; \" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:BZPLC_NM\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:DEPT_NM\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:OPR_UNIT_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:MBR_ID\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"5\" text=\"bind:MBR_NM\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"6\" text=\"bind:LOGN_ID\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj.set_scrollbartype("auto fixed");
            obj.set_selecttype("multirow");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"160\"/><Column size=\"102\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"사업장\"/><Cell col=\"2\" text=\"부서\"/><Cell col=\"3\" text=\"운영단위\"/><Cell col=\"4\" text=\"회원ID\"/><Cell col=\"5\" text=\"회원명\"/><Cell col=\"6\" text=\"로그인ID\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:BZPLC_NM\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:DEPT_NM\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:OPR_UNIT_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:MBR_ID\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:MBR_NM\"/><Cell col=\"6\" text=\"bind:LOGN_ID\" textAlign=\"center\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_maxCnt",null,"41","64","26","66",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            ...
            obj = new Static("sta_totcnt00",null,"40","60","25","134",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_text("최대조회수");
            obj.set_usedecorate("true");
            this.Div00.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",870,673,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("SSP_BO_PP_25_1.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_PP_25_1.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        CREATION DATES : 2021.05.11.

        부서입고책임자 팝업에서 회원정보팝업 시 사업장, 부서, 운영단위에 대한 정보도
        그리드에 표현하기 위해 _1을 붙여 팝업을 새로 생성하였습니다.
        *******************************************************/
        ...
        ************************************************************************************************/
        this.fn_search = function (bInit)
        {
        	...
        	var sSvcId = "search";
        	var sUrl = "/bo/cust/cmn/popup/select-client-popup-list.do";
        ...
        ************************************************************************************************/
        this.fn_paramSetting = function (param){
        	...
        	//this.mbrNm = param.mbrNm;
        	this.ds_search.setColumn(0, "MBR_ID", this.mbrId);
        	this.ds_search.setColumn(0, "BZPLC_ID", param.bzplcId);
        	this.ds_search.setColumn(0, "DEPT_ID", param.deptId);
        	this.ds_search.setColumn(0, "OPR_UNIT_ID", param.oprUnitId);
        	this.ds_search.setColumn(0, "CO_CD", param.coCd);
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_PP_25_1.xfdl");
