(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_MF_19");
            this.set_titletext("화학물질결재선 생성/상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"APRVL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"APRVL_SET_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"APRVL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"APRVL_SET_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div00","20","20",null,"63","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_deptNm","664","35","379","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Button("btn_popDept","488","35","24","24",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("11");
            obj.set_cssclass("btn_WF_search02");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static01",null,"3","476","21","188",null,null,null,null,null,this.Div01.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_addRow",null,"104","90","26","114",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("결재선추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRow",null,"104","90","26","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("결재선삭제");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","Div00.form.edt_bzplcId00","value","ds_list","DEPT_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_MF_19.xfdl","CC::CcUtils.xjs");
        this.addIncludeScript("SSP_BO_MF_19.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_MF_19.xfdl", function() {
        /*******************************************************
          PROJECT NAME : SSP-BO
          CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        	...
        	this.fn_searchInfo = function(){
        		var sSvcId = "fn_infoSearch";
        		var sUrl = "/bgt/chm/aprvl/select-pop-apr-info.do";
        	...
        	this.fn_search = function()	{
        		var sSvcId = "search";
        		var sUrl = "/bgt/chm/aprvl/select-pop-apr-detail.do";
        	...
        	this.fn_save = function(type)	{
        		var sSvcId = "save";
        		var sUrl = "/bgt/chm/aprvl/save-cust-bgt-chm-aprvl.do";
        	...
        	this.fn_update = function(type)	{
        		var sSvcId = "update";
        		var sUrl = "/bgt/chm/aprvl/update-cust-bgt-chm-aprvl.do";
        		var inDs = "ds_save1=ds_list ds_save2=ds_aprvl";
        		var outDs = "";
        		var arg = "";
        		var callBack = "fn_callBack";
        	...
        	this.fn_popupCallback = function(sPopupId, sRetValue){
        		switch(sPopupId){
        			case "btn_popBzplc":
        				...
        				this.ds_list.setColumn(0,"DEPT_ID", "");
        				this.Div00.form.edt_deptNm.set_value("");
        ...
        ************************************************************************************************/
        	...
        	this.btn_save_onclick = function(obj,e)
        	{
        		...
        		/* 안먹음
        		if(!this.gfn_dsIsUpdated(this.ds_aprvl)) {
        	...
        	this.SSP_BO_MF_19_onkeyup = function(obj,e)
        	{
        		//ESC : 닫기기능
        		if(e.keycode == 27){
        			this.close();
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeyup",this.SSP_BO_MF_19_onkeyup,this);
        ...
        this.loadIncludeScript("SSP_BO_MF_19.xfdl");
