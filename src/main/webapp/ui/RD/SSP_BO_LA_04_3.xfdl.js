(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc_prdNm","340","47","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("상품명");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_mnfr","466","81","201","24",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("stc_orgplc","677","77","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("원산지");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_orgplc","802","81",null,"24","10",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("stc_mnfr","340","77","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("제조원");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_prdNm","465","50",null,"24","10",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_hpeUprc","802","112",null,"24","10",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("stc_hpeUprc","677","108","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("희망단가");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_hpeQty","802","143",null,"24","10",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("stc_hpeQty","677","139","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("희망수량");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Static("stc_pubOnlySpr","677","170","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("공용전용구분");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_reprSpec","125","112","542","24",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_prdClcd","125","143","542","24",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_prdId","125","50","205","24",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_prdId00","125","80","205","24",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_prdId00_00","125","393","205","24",null,null,null,null,null,null,this);
            obj.set_taborder("42");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static26_00_02_00_00_00","340","389","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("43");
            obj.set_text("요청일");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_mnfr2_01","466","393","201","24",null,null,null,null,null,null,this);
            obj.set_taborder("44");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static26_03_01_00_00_01_03","677","389","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("45");
            obj.set_cssclass("sta_cm_box01L_tdt");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_prdId00_00_00","125","424","205","24",null,null,null,null,null,null,this);
            obj.set_taborder("47");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static26_00_02_00_00_00_00","340","420","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("48");
            obj.set_text("운영단위");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_mnfr2_01_00","466","424","201","24",null,null,null,null,null,null,this);
            obj.set_taborder("49");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static26_03_01_00_00_01_03_00","677","420","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("50");
            obj.set_text("요청자");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_orgplc2_03_00","802","424",null,"24","10",null,null,null,null,null,this);
            obj.set_taborder("51");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_pubOnlySpr","803","175","130","24",null,null,null,null,null,null,this);
            obj.set_taborder("52");
        ...
        // User Script
        this.registerScript("SSP_BO_LA_04_3.xfdl", function() {
        /******************************************************************************
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_LA_04_3.xfdl");
