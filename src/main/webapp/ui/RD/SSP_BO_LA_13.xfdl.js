(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("일반고객할인율 추가");
            this.set_background("black");
            if (Form == this.constructor)
            {
                this._setFormPosition(1244,538);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_genCust", this);
            ...
            obj = new Button("btn_save","615","480","67","24",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("등록");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("btn_cancel","543","480",null,"24","btn_save:4",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("취소");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("5");
            obj.set_text("일반고객할인율 추가");
            obj.set_cssclass("sta_WF_title04");
            this.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_00_01_00_00_00","0","507","100.00%","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_color("#000000");
            obj.set_background("aqua");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_00_01_01","0","458",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_color("#000000");
            obj.set_background("aqua");
            obj.set_visible("false");
            ...
            obj = new Grid("grd_list","20","Static01_00_01_00:0",null,null,"20","Static01_00_01_01:0",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_binddataset("ds_genCust");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"180\"/><Column size=\"120\"/><Column size=\"180\"/><Column size=\"120\"/><Column size=\"300\"/><Column size=\"150\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell text=\"\"/><Cell col=\"1\" text=\"할인율 구분\"/><Cell col=\"2\" colspan=\"2\" text=\"제조원\"/><Cell col=\"4\" colspan=\"2\" text=\"카테고리\"/><Cell col=\"6\" text=\"일반고객할인율\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:RND_PRFRT_SPR_NM\"/><Cell col=\"2\" text=\"bind:MNFR_NO\"/><Cell col=\"3\" text=\"bind:MNFR_NM\" expandshow=\"expr:RND_PRFRT_SPR_CD  == &apos;10&apos; || RND_PRFRT_SPR_CD == &apos;20&apos; ? &quot;show&quot; : &quot;hide&quot;;\" expandsize=\"25\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:PRD_CLCD\"/><Cell col=\"5\" text=\"bind:PRD_CLCD_NM\" expandshow=\"expr:RND_PRFRT_SPR_CD  == &apos;10&apos; || RND_PRFRT_SPR_CD == &apos;30&apos; ? &quot;show&quot; : &quot;hide&quot;;\" expandsize=\"25\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:GEN_CUST_DCRT\" displaytype=\"editcontrol\" edittype=\"mask\" textAlign=\"right\" expr=\"GEN_CUST_DCRT==null?&apos;&apos;:GEN_CUST_DCRT+&apos; %&apos;\" maskeditclipmode=\"excludespace\" maskeditformat=\"+#0.##\" editmaxlength=\"5\" maskeditlimitbymask=\"both\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","681","71","71","24",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("할인율 구분:");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_dcrtSpr","Static00:4","71","312","24",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1244,538,this,function(p){});
            obj.set_description("일반고객할인율 추가");
        ...
        {
            this._addPreloadList("data","","ds_genCust");
        };
        
        // User Script
        this.addIncludeScript("SSP_BO_LA_13.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_LA_13.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): SSP_BO_LA_13.xfdl(일반고객할인율 등록 팝업)
        * 작 성			일 명: 손나라
        * 작 성	    	일 자: 2022/05/17
        * 변 경     	일 자:
        * 변 경			자 명:
            ...
            switch(strIdTemp[0])
            {
        		...
        		case "MNFR_NM" :
        			if(!this.gfn_isNull(strVal))
        			{
        				...
        				this.ds_genCust.setColumn(nRow,"MNFR_NO",jsonData.MNFR_NO);
        				this.ds_genCust.setColumn(nRow,"MNFR_NM",jsonData.MNFR_NM);
        			}else
        			{
        			// 닫기 버튼 처리
        			}
        		...
        		case "PRD_CLCD" :
        			...
        			{
        				var jsonData = JSON.parse(strVal);
        				this.ds_genCust.setColumn(nRow,"PRD_CLCD",jsonData.PRD_CLCD);
        				this.ds_genCust.setColumn(nRow,"PRD_CLCD_NM",jsonData.FULL_PRD_CLSF_NM);
        			}else
        			{
        			// 닫기 버튼 처리
        			}
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
            ...
            var nRow = this.ds_genCust.addRow();
        	/* 할인율구분
        	dcrtSpr ( 10 : 제조원/상품군, 20 : 제조원, 30 : 상품군 )
        	*/
        	var dcrtSpr = this.rdo_dcrtSpr.value;

            this.ds_genCust.setColumn(nRow,"CHK","0");                                  // 체크
        	this.ds_genCust.setColumn(nRow,"CO_CD",this.lv_coCd)                        // 회사코드
        	this.ds_genCust.setColumn(nRow,"RND_PRFRT_SPR_NM",this.rdo_dcrtSpr.text);   // 할인율구분명
        	this.ds_genCust.setColumn(nRow,"RND_PRFRT_SPR_CD",this.rdo_dcrtSpr.value);  // 할인율구분코드
        	this.ds_genCust.setColumn(nRow,"USE_YN","Y");                               // 사용여부
        };
        ...
        ***********************************************************************/
        ...
        {
            // 멀티삭제용도
            if(this.ds_genCust.rowcount < 1 || this.ds_genCust.findRow("CHK",1) == -1)
            {
            ...
            // 멀티 삭제 처리
            for(var i = this.ds_genCust.rowcount-1; 0 <= i; i--)
            {
                if(this.ds_genCust.getColumn(i,"CHK") == 1)
                {
                    this.ds_genCust.deleteRow(i);
                }
            }
        ...
        ***********************************************************************/
        ...
        {
        	if ( this.ds_genCust.getRowCount() == 0 ) {
        		this.fn_alert("ERRS000174","저장","question");  // 적용할 내용이 없습니다.
        		return false;
        	}
            // 필수 입력사항 체크
            for(var idx=0; idx<this.ds_genCust.getRowCount(); idx++)
        	{
        		var dcrtSpr = this.ds_genCust.getColumn(idx,"RND_PRFRT_SPR_CD");
        		if ( dcrtSpr == "10" )
        		{
        			if ( this.gfn_isNull(this.ds_genCust.getColumn(idx,"MNFR_NO")) )
        			{
        				this.fn_alert("ERRS000144","저장","제조원 ","question");      // 제조원 (&1은(는) 필수입력사항입니다.)
        				return false;
        			}
        			if ( this.gfn_isNull(this.ds_genCust.getColumn(idx,"PRD_CLCD")) )
        			{
        				this.fn_alert("ERRS000144","저장","카테고리 ","question");      // 카테고리 (&1은(는) 필수입력사항입니다.)
        				return false;
        			}
        			if ( this.gfn_isNull(this.ds_genCust.getColumn(idx,"GEN_CUST_DCRT")) )
        			{
        ...
        this.fn_Save = function()
        {
            ...
            var strInDs     = "ds_master=ds_genCust:u";
            var strOutDs    = "";
            var strArg      = "";
        ...
        ***********************************************************************/
        ...
        {
        	var strMnfrNo             = this.ds_genCust.getColumn(e.row,"MNFR_NO");
        	var strPrdClcd            = this.ds_genCust.getColumn(e.row,"PRD_CLCD");
        	var strRndPrfrtSprCd      = this.ds_genCust.getColumn(e.row,"RND_PRFRT_SPR_CD");
        ...
        this.ds_genCust_cancolumnchange = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdo_dcrtSpr.addEventHandler("onitemchanged",this.rdo_dcrtSpr_onitemchanged,this);
            this.ds_genCust.addEventHandler("canrowposchange",this.dsMaster_canrowposchange,this);
            this.ds_genCust.addEventHandler("cancolumnchange",this.ds_genCust_cancolumnchange,this);
        };
        this.loadIncludeScript("SSP_BO_LA_13.xfdl");
