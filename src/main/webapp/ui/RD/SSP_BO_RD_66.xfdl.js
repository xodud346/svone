(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_RD_66");
            this.set_titletext("전시상품 상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE_LIST\" type=\"STRING\" size=\"256\"/><Column id=\"LANG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_CLCD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DISP_STATS_YN\" type=\"STRING\" size=\"256\"/><Column id=\"MALL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DISP_GRP_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_CLCD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_CLSF_NM\" type=\"STRING\" size=\"256\"/><Column id=\"REPR_PRD_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DISP_PRD_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"DISP_PRD_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ADD_INFO_SET_YN\" type=\"STRING\" size=\"256\"/><Column id=\"PRFRT\" type=\"STRING\" size=\"256\"/><Column id=\"UPD_RSN\" type=\"STRING\" size=\"256\"/><Column id=\"SRT_SO\" type=\"STRING\" size=\"256\"/><Column id=\"REGPSN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"UPDPSN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"UPD_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_CON_DIFF\" type=\"STRING\" size=\"256\"/><Column id=\"DISP_GRP_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static05_01_01_01_00","655","112","145","32",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("추가정보수취");
            obj.set_cssclass("sta_cm_box01L");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo_addInfoSetYn","Static05_01_01_01_00:6","116","150","24",null,null,null,null,null,null,this);
            obj.set_taborder("35");
            obj.set_columncount("2");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Grid("grd_optnBasis","20","440",null,"64","20",null,null,null,null,null,this);
            obj.set_taborder("45");
        ...
        // User Script
        this.registerScript("SSP_BO_RD_66.xfdl", function() {
        /*******************************************************
        PROJECT NAME : RND 전시상품 상세
        CREATION DATES : 2023.07.11
        *******************************************************/
        // 공통형 스크립트 인클루드
        /*******************************************************
        * Form 변수 선언 영역
        ...
        ************************************************************************************************/
        ...
        this.fn_onLoad = function(obj,e){
        	...
        	this.Static03_00.uEssentiel = "true";
        	...
        	var dispGrpId = this.parent.dispGrpId;
        	...
        	if(!this.gfn_isNull(prdClcd)){
        		...
        		this.ds_search.setColumn(0, "DISP_GRP_ID", dispGrpId);
        		this.fn_dispInfo();
        		this.pageMode = 'U';
        	}else{
        ...
        ************************************************************************************************/
        ...
        this.fn_dispInfo = function() {
        	var sSvcId = "dispInfo";
        	var sUrl = "/rd/disp-prd-mng-lst/select-product-disp-info.do";
        	var inDs = "ds_search=ds_search";
        ...
        // 카테고리 옵션 조회
        this.fn_getCategoryOpt = function() {
        	var sSvcId = "categoryOpt";
        	var sUrl = "/rd/disp-prd-mng-lst/select-category-option-values.do";
        	var inDs = "ds_search=ds_search";
        	var outDs = "ds_reprPrd=ds_reprPrd ds_optnBasis=ds_optnBasis";
        	var arg = "";
        ...
        this.fn_save = function (bInit){
            var sSvcId = "save";
            var sUrl = "/rd/disp-prd-mng-lst/save-product-disp-info.do";
            ...
            switch(svcID) {
        		...
        		case "categoryOpt" :
        			...
        			for (var i = 0; i<this.ds_optnBasis.rowcount; i++) {
        				OPTN_NM = this.ds_optnBasis.getColumn(i, "OPTN_NM");
        				//OPTN_NM.setAttribute("readonly", true);
        				//this.grd_optnBasis.setCellProperty("body", 2, "readonly", true)
        			}

        			this.btn_addOptnDtl_onclick();
        			break;
        		...
        		case "prdConMappPrdId" :
        			if(this.searchPrdCount>0){
        				...
        				var params = {
        					coCd:this.coCd
        					, prdClcd:this.selPrdClcd
        					, dispStatsYn:'Y'
        					, pubOnlySprCd:'P'
        					, prdId:this.ds_prdCon.getColumn(this.grd_prdCon.getSelectedRows(), "MAPP_PRD_ID")
        ...
        */
        ...
        this.fn_validation = function(){
        	if(this.gfn_isNull(this.edt_prdClcd.value) || this.gfn_isNull(this.edt_dispPrdNm.value)){
        		//alert('필수값을 확인하세요.');
        ...
        ************************************************************************************************/
        ...
        this.btn_history_onclick = function(obj,e)
        {
        	...
        	var dispGrpId = this.ds_basic.getColumn(0, "DISP_GRP_ID");

        	var params = {
        		historyType : 'rndDisp',	// 히스토리 유형 필수값
        		key1 : prdClcd,				// 필요에따라 추가
        		key2 : dispGrpId			// 필요에따라 추가
        	};
        	var options = {};
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_btn.form.btn_save.addEventHandler("onclick",this.btn_save_onclick,this);
            this.btn_save00.addEventHandler("onclick",this.div_btn_btn_save_onclick,this);
            this.btn_save00_00.addEventHandler("onclick",this.btn_save_onclick,this);
        ...
        this.loadIncludeScript("SSP_BO_RD_66.xfdl");
