(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("일반고객할인율 변경이력");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"330\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"변경일시\"/><Cell col=\"1\" text=\"상태\"/><Cell col=\"2\" text=\"제조원\"/><Cell col=\"3\" text=\"R&amp;D카테고리ID\"/><Cell col=\"4\" text=\"R&amp;D카테고리\"/><Cell col=\"5\" text=\"일반고객할인율\"/><Cell col=\"6\" text=\"변경담당자ID\"/><Cell col=\"7\" text=\"변경 담당자\"/></Band><Band id=\"body\"><Cell text=\"bind:REG_UPD_DTM\" displaytype=\"normal\"/><Cell col=\"1\" text=\"bind:USE_YN\" displaytype=\"normal\" expr=\"USE_YN==&apos;Y&apos;?&apos;사용&apos;:&apos;미사용&apos;\"/><Cell col=\"2\" text=\"bind:MNFR_NO\" displaytype=\"normal\" expr=\"MNFR_NM==null?&apos;&apos;:&apos;(&apos;+MNFR_NO+&apos;)&apos;+MNFR_NM\"/><Cell col=\"3\" text=\"bind:PRD_CLCD\" expr=\"PRD_CLCD==&apos;*&apos;?&apos;&apos;:PRD_CLCD\"/><Cell col=\"4\" text=\"bind:PRD_CLCD_NM\" displaytype=\"normal\" expr=\"PRD_CLCD==&apos;*&apos;?&apos;&apos;:PRD_CLCD_NM\"/><Cell col=\"5\" text=\"bind:GEN_CUST_DCRT\" displaytype=\"mask\" expr=\"GEN_CUST_DCRT==null?&apos;&apos;:GEN_CUST_DCRT+&apos;%&apos;\" textAlign=\"right\"/><Cell col=\"6\" text=\"bind:REG_UPD_ID\"/><Cell col=\"7\" text=\"bind:OPRTR_NM\" displaytype=\"normal\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_description("일반고객할인율 변경이력");
        ...
        // User Script
        this.addIncludeScript("SSP_BO_LA_14.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_LA_14.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): SSP_BO_LA_14.xfdl(일반고객할인율 변경이력)
        * 작 성			일 명: 손나라
        * 작 성	    	일 자: 2022/06/22
        * 변 경     	일 자:
        * 변 경			자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function(page)
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/rd/gen-cust-dcrt-mng/select-gen-cust-dcrt-mng-hst.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_LA_14.xfdl");
