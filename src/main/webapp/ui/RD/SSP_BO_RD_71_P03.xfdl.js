(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"PRD_REG_DIS_TP_CD\" type=\"STRING\" size=\"32\"/><Column id=\"REG_DIS_RSN\" type=\"STRING\" size=\"32\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"NEW_PRD_REQ_GRP_NO\" type=\"STRING\" size=\"256\"/><Column id=\"MALL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"REQ_SBJ_CD\" type=\"STRING\" size=\"256\"/><Column id=\"NEW_PRD_REQ_STATS_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_REG_DIS_TP_NM\" type=\"STRING\" size=\"256\"/><Column id=\"EMAIL_ADDR\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"PRD_REG_DIS_TP_CD\"/><Col id=\"REG_DIS_RSN\"/><Col id=\"CO_CD\"/><Col id=\"NEW_PRD_REQ_GRP_NO\"/><Col id=\"MALL_SPR_CD\"/><Col id=\"REQ_SBJ_CD\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_btn1","0","256",null,null,"0","9",null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_btn2","0","256",null,null,"0","9",null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_RD_71_P03.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_RD_71_P03.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.postformInit = function()
        {
        	...
        	this.ds_list.setColumn(0,"NEW_PRD_REQ_GRP_NO",		this.sParamArg1);
        	this.ds_list.setColumn(0,"MALL_SPR_CD",				this.sParamArg3);
        	this.ds_list.setColumn(0,"REQ_SBJ_CD",				this.sParamArg4);

        	if(this.sParamArg5=="N"){
        		this.div_btn1.set_visible(true);
        		this.div_btn2.set_visible(false);
        		this.txt_regDisTip.set_readonly(false);
        		this.cmb_prdRegDisTpCd.set_readonly(false);
        	}else{
        		this.div_btn1.set_visible(false);
        		this.div_btn2.set_visible(true);
        		this.txt_regDisTip.set_value(this.sParamArg4);
        		this.txt_regDisTip.set_readonly(true);
        		var nByte = this.fn_getLengthB(this.sParamArg4,3);
        		this.sta_batySize.set_text(nByte + "/300");
        		this.ds_list.setColumn(0, "PRD_REG_DIS_TP_CD", this.sParamArg6);
        		this.cmb_prdRegDisTpCd.set_readonly(true);
        	}
        };
        ...
        ***********************************************************************/
        ...
        this.fn_save = function()
        {
        	...
        	var strSvc 		= "Save";
        	var strUrl 		= "/rd/new-prd-mlt-req-lst/save-prd-mlt-req-rjct-proc-stor.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_RD_71_P03.xfdl");
