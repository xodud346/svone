(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("계약고객할인율 변경이력");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"32\"/><Column id=\"PRD_CLCD\" type=\"STRING\" size=\"32\"/><Column id=\"MNFR_NO\" type=\"STRING\" size=\"32\"/><Column id=\"PRD_CLCD_NM\" type=\"STRING\" size=\"32\"/><Column id=\"CONT_CUST_DCRT\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"MNFR_NM\" type=\"STRING\" size=\"32\"/><Column id=\"REG_UPD_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"OPRTR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"32\"/><Column id=\"REG_UPD_ID\" type=\"STRING\" size=\"32\"/><Column id=\"VLD_STR_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"VLD_END_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"32\"/><Column id=\"SEQ\" type=\"BIGDECIMAL\" size=\"16\"/><Column id=\"BZPLC_NM\" type=\"STRING\" size=\"32\"/><Column id=\"RND_PRFRT_SPR_CD\" type=\"STRING\" size=\"32\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"MNFR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"PRD_CLCD\" type=\"STRING\" size=\"256\"/><Column id=\"START_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_COLUMN\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"INQ_COND_DTLS\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"TOTAL_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"330\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"변경일시\"/><Cell col=\"1\" text=\"상태\"/><Cell col=\"2\" text=\"사업장ID\"/><Cell col=\"3\" text=\"사업장\"/><Cell col=\"4\" text=\"제조원\"/><Cell col=\"5\" text=\"R&amp;D카테고리ID\"/><Cell col=\"6\" text=\"R&amp;D카테고리\"/><Cell col=\"7\" text=\"계약고객할인율\"/><Cell col=\"8\" text=\"변경담당자ID\"/><Cell col=\"9\" text=\"변경 담당자\"/></Band><Band id=\"body\"><Cell text=\"bind:REG_UPD_DTM\" displaytype=\"normal\"/><Cell col=\"1\" text=\"bind:USE_YN\" displaytype=\"normal\" expr=\"USE_YN==&apos;Y&apos;?&apos;사용&apos;:&apos;미사용&apos;\"/><Cell col=\"2\" text=\"bind:BZPLC_ID\"/><Cell col=\"3\" text=\"bind:BZPLC_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:MNFR_NM\" displaytype=\"normal\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:PRD_CLCD\" expr=\"PRD_CLCD==&apos;*&apos;?&apos;&apos;:PRD_CLCD\"/><Cell col=\"6\" text=\"bind:PRD_CLCD_NM\" displaytype=\"normal\" textAlign=\"left\" expr=\"PRD_CLCD==&apos;*&apos;?&apos;&apos;:PRD_CLCD_NM\"/><Cell col=\"7\" text=\"bind:CONT_CUST_DCRT\" displaytype=\"mask\" expr=\"CONT_CUST_DCRT==null?&apos;&apos;:CONT_CUST_DCRT+&apos;%&apos;\" textAlign=\"right\"/><Cell col=\"8\" text=\"bind:REG_UPD_ID\"/><Cell col=\"9\" text=\"bind:OPRTR_NM\" displaytype=\"normal\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_description("계약고객할인율 변경이력");
        ...
        // User Script
        this.addIncludeScript("SSP_BO_LA_17.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_LA_17.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): SSP_BO_LA_17.xfdl(계약고객할인율 변경이력)
        * 작 성			일 명: 손나라
        * 작 성	    	일 자: 2022/06/03
        * 변 경     	일 자:
        * 변 경			자 명:
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
        	...
        	this.ds_search.setColumn(nRow,"BZPLC_ID",this.sParamArg4);
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function(page)
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/rd/cont-cust-dcrt-mng/select-cont-cust-dcrt-mng-hst.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("SSP_BO_LA_17.xfdl");
