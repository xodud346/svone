(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("사용자팝업(그리드조건없음)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"32\"/><Column id=\"PROG_ID\" type=\"STRING\" size=\"32\"/><Column id=\"FORM_PATH\" type=\"STRING\" size=\"32\"/><Column id=\"FORM_ID\" type=\"STRING\" size=\"32\"/><Column id=\"FORM_NM\" type=\"STRING\" size=\"32\"/><Column id=\"USER_YN\" type=\"STRING\" size=\"32\"/><Column id=\"REG_ID\" type=\"STRING\" size=\"32\"/><Column id=\"REG_DT\" type=\"DATETIME\" size=\"17\"/><Column id=\"MOD_ID\" type=\"STRING\" size=\"32\"/><Column id=\"MOD_DT\" type=\"DATETIME\" size=\"17\"/></ColumnInfo><Rows><Row><Col id=\"PROG_ID\">10000</Col><Col id=\"FORM_PATH\">dddd</Col><Col id=\"FORM_ID\">ddd</Col><Col id=\"FORM_NM\">테스트</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_CO_08.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_CO_08.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        {
        	this.grd_list_oncellclick(this.grd_list);
        };
        ...
        this.loadIncludeScript("SSP_BO_CO_08.xfdl");
