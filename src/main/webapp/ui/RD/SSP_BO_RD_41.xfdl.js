(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_RD_41");
            this.set_titletext("R&D상품담당자 상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MALL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PR_EMP_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CO_CD\"/><Col id=\"MALL_SPR_CD\"/><Col id=\"PR_EMP_NO\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_codeChkYn", this);
            obj._setContents("<ColumnInfo><Column id=\"PR_EMP_NO_YN\" type=\"STRING\" size=\"32\"/></ColumnInfo><Rows><Row><Col id=\"PR_EMP_NO_YN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_close2",null,"0","20","20","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("X");
            ...
            obj = new Static("stc_prdChrpsn","0","98","130","32",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("12");
            obj.set_text("R&D 상품담당자");
            obj.set_cssclass("sta_cm_box01L");
            this.div.addChild(obj.name, obj);

            obj = new Edit("edt_prdChrpsnNm","244","102","184","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("13");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.div.addChild(obj.name, obj);

            obj = new Edit("edt_prdChrpsnId","139","102","101","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("14");
            ...
            obj = new Radio("Radio00","143","132","202","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("25");
            ...
            obj = new Button("btn_close","298",null,"100","32",null,"50",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("닫기");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_prdChrpsnPopup","451","182","24","24",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item0","div.form.rdo_useYn","value","ds_master","PRD_CLSF_CHRPSN_USEYN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","div.form.Radio00","value","ds_master","PRD_CLSF_CHRPSN_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","div.form.tae_reason","value","ds_master","UPD_RSN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","div.form.edt_prdChrpsnId","value","ds_master","PRD_CLSF_CHRPSN_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","div.form.edt_prdChrpsnNm","value","ds_master","PRD_CLSF_CHRPSN_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","div.form.edt_regDtm","value","ds_master","REG_DTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","div.form.edt_regpsnId","value","ds_master","REGPSN_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item13","div.form.edt_updDtm","value","ds_master","UPD_DTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","div.form.edt_updpsnId","value","ds_master","UPDPSN_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_RD_41.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_RD_41.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.fn_postRet = function()
        {
        	...
        	if(this.gfn_isNull(this.gfn_trim(this.ds_master.getColumn(0,"MNFR_NO"))) && this.ds_master.getColumn(0,"USE_YN") == "Y"
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/rd/prd-chrpsn-mng/update-prd-chrpsn-mng.do";
            var strInDs     = "ds_search=ds_search ";
        ...
        *  R&D 상품담당자 시작
         ...
         */
        this.btn_prdChrpsnPopup_onclick = function(obj,e)
        {
        ...
        this.fn_setCallPopup01 = function(sCodeId)
        {
        	...
        	} else
        	{
        		var objParam = {empNo : sCodeId
        	                  , coCd  : this.lv_coCd};
        		var options = { title : this.div.form.stc_prdChrpsn.text };
        ...
        *  R&D 상품담당자 종료
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_prdChrpsnPopup.addEventHandler("onclick",this.btn_prdChrpsnPopup_onclick,this);
            this.btn_history_popup.addEventHandler("onclick",this.btn_history_popup_onclick,this);
        };
        this.loadIncludeScript("SSP_BO_RD_41.xfdl");
