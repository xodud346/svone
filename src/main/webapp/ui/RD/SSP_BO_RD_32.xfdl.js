(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("R&D구매담당자 목록");
            ...
            obj = new Button("btn_search",null,"128","60","28","0",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_require");
            this.div_search.addChild(obj.name, obj);

            obj = new Button("btn_init",null,"128","60","28","btn_search:4",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_text("초기화");
            this.div_search.addChild(obj.name, obj);
            ...
            div_search_form_cmb_chrpsn_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">PRD_CLSF_CHRPSN_ID</Col><Col id=\"datacolumn\">구매담당자</Col></Row><Row><Col id=\"codecolumn\">REGPSN_ID</Col><Col id=\"datacolumn\">등록자</Col></Row><Row><Col id=\"codecolumn\">UPDPSN_ID</Col><Col id=\"datacolumn\">수정자</Col></Row></Rows>");
            ...
            obj = new Combo("cmb_chrpsnStats","902","85","130","24",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("27");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_autoselect("true");
            var div_search_form_cmb_chrpsnStats_innerdataset = new nexacro.NormalDataset("div_search_form_cmb_chrpsnStats_innerdataset", obj);
            div_search_form_cmb_chrpsnStats_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">Y</Col><Col id=\"datacolumn\">사용</Col></Row><Row><Col id=\"codecolumn\">N</Col><Col id=\"datacolumn\">삭제</Col></Row></Rows>");
            obj.set_innerdataset(div_search_form_cmb_chrpsnStats_innerdataset);
            obj.set_text("전체");
            obj.set_value("0");
            obj.set_index("0");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_list","20","230",null,null,"20","110",null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj = new Div("div_paging","20","Static01_00_01_00_00:0",null,"3.55%","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Combo("cbo_rowCont",null,"189","100","28","21",null,null,null,null,null,this);
            obj.set_taborder("16");
            ...
            obj = new Button("btn_excelDown",null,"189","110","28","cbo_rowCont:4",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("엑셀다운로드");
            ...
            obj = new Button("btn_layoutInit",null,"189","100","28","btn_excelDown:4",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Static("Static01_00_01_00_00_00","0","158","100.00%","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_color("#000000");
            obj.set_background("aqua");
            obj.set_visible("false");
            ...
            obj = new Button("btn_layoutSave",null,"189","100","28","btn_layoutInit:4",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("레이아웃 저장");
            this.addChild(obj.name, obj);

            obj = new Button("btn_upload",null,"189","81","28","btn_layoutSave:4",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("일괄수정");
            this.addChild(obj.name, obj);

            obj = new Button("btn_saveall",null,"189","81","28","btn_upload:4",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("일괄등록");
            this.addChild(obj.name, obj);

            obj = new Button("btn_reg",null,"189","81","28","btn_saveall:4",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("등록");
            this.addChild(obj.name, obj);

            obj = new Static("Static01_00_00","0","219","100.00%","10",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_color("#000000");
            obj.set_background("aqua");
            obj.set_visible("false");
            ...
            obj = new BindItem("item3","div_search.form.edt_chrpsnId","value","ds_search","PSN_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","div_search.form.edt_chrpsnNm","value","ds_search","PSN_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","div_search.form.cmb_prdClsfChrpsnSpr","value","ds_search","PRD_CLSF_CHRPSN_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","div_search.form.edt_mnfrNm","value","ds_search","MNFR_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item0","div_search.form.edt_prdGrpCd","value","ds_search","PRD_CLCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","div_search.form.edt_prdGrpNm","value","ds_search","PRD_CLCD_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item9","div_search.form.cmb_dateType","value","ds_search","DT_SPR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","div_search.form.cal_reqDtFnlProcDtStr","value","ds_search","DATE_FR_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div_search.form.cal_reqDtFnlProcDtEnd","value","ds_search","DATE_TO_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","div_search.form.cmb_chrpsn","value","ds_search","PSN_TYPE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item13","div_search.form.cmb_dtUnit","value","ds_search","REQ_DT_FNL_PROC_DT_UNIT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_RD_32.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_RD_32.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): SSP_BO_RD_32.xfdl(R&D구매담당자 목록)
        * 작 성         일 명: 홍길동
        * 작 성         일 자: 2022/05/06
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function(page)
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/rd/purg-chrpsn-mng/select-purg-chrpsn-mng.do";
        ...
        ***********************************************************************/
        ...
        {
        	var params = { reqGubun    : "10"     // 요청구분 [고객:10,자사:20,협력사:30]
        ...
        */
        ...
        this.fn_Excel = function()
        {
            ...
            this.gfn_excelExport(this.grd_list, "R&D구매담당자 목록","R&D구매담당자 목록");
        };
        /**********************************************************************
                12_1. 개인화 이벤트처리
        ***********************************************************************/
        ...
        *  담당자 종료
        ...
        this.fn_setCallPopup = function(params)
        {
        	...
        	switch(params.reqGubun)
        	{
        		case "10" :
        		     sPopId = "SSP_BO_RD_35";
        		     sUrl 	= "RD::SSP_BO_RD_35.xfdl";
        		     break;
        		case "20" :
        		     sPopId = "SSP_BO_RD_36";
        		     sUrl 	= "RD::SSP_BO_RD_36.xfdl";
        		     break;
        		default : break;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.form.cmb_dateType.addEventHandler("onitemchanged",this.div_search_cmb_dateType_onitemchanged,this);
        ...
        this.loadIncludeScript("SSP_BO_RD_32.xfdl");
