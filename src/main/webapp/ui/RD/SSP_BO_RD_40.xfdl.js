(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_RD_40");
            this.set_titletext("R&D상품담당자 생성");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MALL_SPR_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MNFR_NO\" type=\"STRING\" size=\"256\"/><Column id=\"PR_EMP_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CO_CD\"/><Col id=\"MALL_SPR_CD\"/><Col id=\"MNFR_NO\"/><Col id=\"PR_EMP_NO\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_codeChkYn", this);
            obj._setContents("<ColumnInfo><Column id=\"MNFR_NO_YN\" type=\"STRING\" size=\"32\"/><Column id=\"PR_EMP_NO_YN\" type=\"STRING\" size=\"32\"/></ColumnInfo><Rows><Row><Col id=\"MNFR_NO_YN\"/><Col id=\"PR_EMP_NO_YN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div","20","44",null,"166","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_border("");
            ...
            obj = new Edit("edt_prdChrpsnNm","244","72","184","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("15");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.div.addChild(obj.name, obj);

            obj = new Edit("edt_prdChrpsnId","139","72","101","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("16");
            obj.set_enable("true");
            obj.set_autoselect("true");
            this.div.addChild(obj.name, obj);

            obj = new Static("stc_prdChrpsn","0","68","130","32",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("17");
            obj.set_text("R&D상품담당자");
            obj.set_cssclass("sta_cm_box01L");
            obj.getSetter("uEssentiel").set("true");
            this.div.addChild(obj.name, obj);

            obj = new Button("btn_prdChrpsnPopup","432","72","24","24",null,null,null,null,null,null,this.div.form);
            obj.set_taborder("18");
            obj.set_cssclass("btn_WF_search02");
            obj.set_text("");
            this.div.addChild(obj.name, obj);
            ...
            obj = new Button("btn_cancel","298",null,"100","32",null,"30",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save","401",null,"100","32",null,"30",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("등록");
            ...
            obj = new BindItem("item1","div.form.edt_prdClcd","value","ds_master","PRD_CLCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","div.form.edt_mnfrCd","value","ds_master","MNFR_NO");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","div.form.edt_mnfrNm","value","ds_master","MNFR_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","div.form.edt_prdChrpsnId","value","ds_master","PRD_CLSF_CHRPSN_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div.form.edt_prdChrpsnNm","value","ds_master","PRD_CLSF_CHRPSN_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","div.form.rdo_prdClsfChrpsnSpr","value","ds_master","PRD_CLSF_CHRPSN_SPR_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("SSP_BO_RD_40.xfdl","RD::rdMain.xjs");
        this.registerScript("SSP_BO_RD_40.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): SSP_BO_RD_40.xfdl(R&D상품담당자 생성 팝업)
        * 작 성			일 명: 손나라
        * 작 성	    	일 자: 2022/05/12
        * 변 경     	일 자:
        * 변 경			자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_PostformInit = function()
        {
        	...
        	this.ds_master.setColumn(nRow,"PRD_CLSF_CHRPSN_TP_CD"        ,"10");                    //10:상품담당자, 20:MD담당자, 30:구매담당자
        ...
        this.fn_popupCallback = function(strId, strVal)
        {
            switch(strId)
            {
        		...
        		case "SSP_BO_PP_27" :
        				...
        				{
        					var jsonData = JSON.parse(strVal);
        					this.div.form.edt_prdChrpsnId.set_value(jsonData.OPRTR_ID.replace(/,\s*$/, ""));
        					this.div.form.edt_prdChrpsnNm.set_value(jsonData.OPRTR_NM.replace(/,\s*$/, ""));
        				}else
        				{
        					// 닫기 버튼 처리
        				}
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
        	...
        	var strSvc      = "Ret";
            var strUrl      = "/rd/prd-chrpsn-mng/select-prd-chrpsn-mng-dtl.do";
        ...
        ***********************************************************************/
        ...
        this.fn_PreSave = function()
        {
        	...
        	if(this.gfn_isNull(this.div.form.edt_prdChrpsnId.value))
        	{
        		this.fn_alert("ERRS000144","저장","상품담당자 ","question");      // R&D속성명 (&1은(는) 필수입력사항입니다.)
        		return false;
        	}
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/rd/prd-chrpsn-mng/insert-prd-chrpsn-mng.do";
        ...
        this.fn_codeChkYn = function()
        {
        	...
        	this.ds_searchChkYn.setColumn(nRow,"PR_EMP_NO",	    this.gfn_trim(this.div.form.edt_prdChrpsnId.value));

        	var strSvc      = "CodeYn";
            var strUrl      = "/rd/prd-chrpsn-mng/select-code-chk-yn.do";
        	...
        	// 상품담당자
        	if(!this.gfn_isNull(this.gfn_trim(this.div.form.edt_prdChrpsnId.value)))
        	{
        		if(strPrEmpNoYn == "N")
        		{
        			this.fn_alert("ERRR000174","저장정보","R&D상품담당자 코드","question"); // 존재하지 않는 &1 입니다.
        			this.div.form.edt_prdChrpsnId.setFocus();
        			return false;
        		}
        	}
        	return true;
        ...
        ***********************************************************************/
        ...
        {
        	var params = { mallSprCd : this.mallSprCd , coCd : this.lv_coCd };
        ...
        *  R&D상품담당자 시작
         ...
         */
        this.div_btn_prdChrpsnPopup_onclick = function(obj,e)
        {

        	var sCodeId = this.gfn_trim(this.div.form.edt_prdChrpsnId.value);
         ...
         * 입력창을 지우면 자동을 이름도 초기화처리
         */
        this.div_edt_prdChrpsnId_oninput = function(obj,e)
        {
        	if(obj.getLength() == 0)
        	{
        		this.div.form.edt_prdChrpsnNm.set_value("");
        	}
        };
        ...
        this.div_edt_prdChrpsnId_onkeyup = function(obj,e)
        {
        	var sCodeId = this.gfn_trim(this.div.form.edt_prdChrpsnId.value);
        ...
        *  R&D상품담당자 종료
        ...
        this.on_initEvent = function()
        {
            ...
            this.div.form.edt_prdChrpsnId.addEventHandler("oninput",this.div_edt_prdChrpsnId_oninput,this);
            this.div.form.edt_prdChrpsnId.addEventHandler("onkeyup",this.div_edt_prdChrpsnId_onkeyup,this);
            this.div.form.btn_prdChrpsnPopup.addEventHandler("onclick",this.div_btn_prdChrpsnPopup_onclick,this);
            this.btn_cancel.addEventHandler("onclick",this.btn_cancel_onclick,this);
            this.btn_save.addEventHandler("onclick",this.btn_save_onclick,this);
        };
        this.loadIncludeScript("SSP_BO_RD_40.xfdl");
