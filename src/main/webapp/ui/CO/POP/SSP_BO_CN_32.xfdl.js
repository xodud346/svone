(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("매뉴얼 수정");
            if (Form == this.constructor)
            {
                this._setFormPosition(1280,653);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_manual", this);
            obj._setContents("<ColumnInfo><Column id=\"MANUAL_REG_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"MANUAL_REG_TTL\" type=\"STRING\" size=\"256\"/><Column id=\"DOWN_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"MEMO_CTS\" type=\"STRING\" size=\"256\"/><Column id=\"DOC_REG_ID\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_KEY\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"REGPSN_ID\" type=\"STRING\" size=\"256\"/><Column id=\"UPD_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"UPDPSN_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Div("div_top_info","20","0","1240","603",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div01");
            ...
            obj = new Static("Static27","0","Static21:-1",null,"197","0",null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_cm_box02L");
            obj.set_text("");
            this.div_top_info.addChild(obj.name, obj);
            ...
            obj = new Static("Static17_01","0","480",null,"32","0",null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_cm_box02L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static16_01","0","480","130","32",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("13");
            obj.set_text("최초 등록");
            obj.set_cssclass("sta_cm_box01L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static17_01_00","0","511",null,"32","0",null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_cm_box02L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static16_01_00","0","511","130","32",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("15");
            obj.set_text("최종 수정");
            obj.set_cssclass("sta_cm_box01L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static16_01_01","531","480","130","32",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("16");
            obj.set_text("등록일시");
            obj.set_cssclass("sta_cm_box01L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static16_01_00_00","531","511","130","32",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("17");
            obj.set_text("수정일시");
            obj.set_cssclass("sta_cm_box01L");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static04","140","484","167","24",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("18");
            obj.set_text("Static04");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static04_00","675","484","167","24",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("19");
            obj.set_text("Static04");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static04_01","140","515","167","24",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("20");
            obj.set_text("Static04");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Static("Static04_00_00","675","515","167","24",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("21");
            obj.set_text("Static04");
            this.div_top_info.addChild(obj.name, obj);
            ...
            obj = new Button("Button01_00","653","573","70","30",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("23");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_select");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Button("Button01","505","573","70","30",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("24");
            obj.set_text("취소");
            this.div_top_info.addChild(obj.name, obj);

            obj = new Button("Button01_00_00","579","573","70","30",null,null,null,null,null,null,this.div_top_info.form);
            obj.set_taborder("25");
            obj.set_text("삭제");
            this.div_top_info.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1280,653,this,function(p){});
            ...
            obj = new BindItem("item1","div_top_info.form.Static04","text","ds_manual","REGPSN_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","div_top_info.form.Static04_01","text","ds_manual","UPDPSN_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div_top_info.form.Static04_00","text","ds_manual","REG_DTM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","div_top_info.form.Static04_00_00","text","ds_manual","UPD_DTM");
            this.addChild(obj.name, obj);
            obj.bind();
