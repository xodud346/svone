(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PGM_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE_LIST\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PGM_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CUR_PGM_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"USE_YN\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_positionstep("0");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"121\"/><Column size=\"246\"/><Column size=\"130\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"프로그램ID\"/><Cell col=\"2\" text=\"프로그램명\"/><Cell col=\"3\" text=\"사용유무\"/></Band><Band id=\"body\"><Cell text=\"expr:currow == 0 ? &quot;theme::default/images/grd_WF_search.png&quot; : &quot;&quot;\" displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;normal&quot;\"/><Cell col=\"1\" text=\"bind:PGM_ID\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"2\" text=\"bind:PGM_NM\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" cssclass=\"grd_WF_left\"/><Cell col=\"3\" textAlign=\"center\" combodataset=\"ds_useYn\" combodatacol=\"COM_DTL_CD_NM\" combocodecol=\"COM_DTL_CD\" text=\"bind:USE_YN\" comboautoselect=\"false\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;combotext&quot;\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" combotype=\"dropdown\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("SSP_BO_YA_30.xfdl", function() {
        /*******************************************************
        ...
        ************************************************************************************************/
        this.fn_onLoad = function(obj,e)
        {
        	...
        	this.ds_frtPgmInfoCopy.copyData(this.ds_frtPgmInfo);

        	this.currow = this.parent.currow;
        	this.ds_search.setColumn(0, "CUR_PGM_ID", this.parent.curPgmId);
        	this.ds_search.setColumn(0, "PGM_ID", this.parent.pgmId);
        	this.ds_search.setColumn(0, "PGM_NM", this.parent.pgmNm);
        	//this.ds_search.setColumn(0, "CALL_TYPE", this.parent.type);
        	this.fn_initGrid();
        ...
        ************************************************************************************************/
        ...
        {
        	var sSvcId = "search";
        	var sUrl = "/co/frt/select-frt-pgm-popup-list.do";
        ...
        ************************************************************************************************/
        ...
        this.fn_initGrid = function(){
        	this.ds_frtPgmInfo.insertRow(0);
        	this.ds_frtPgmInfo.setColumn(0, "PGM_ID",  this.ds_search.getColumn(0, "PGM_ID"));
        	this.ds_frtPgmInfo.setColumn(0, "PGM_NM",  this.ds_search.getColumn(0, "PGM_NM"));
        	this.ds_frtPgmInfo.setColumn(0, "USE_YN",  this.ds_search.getColumn(0, "USE_YN"));
        	this.ds_frtPgmInfo.set_rowposition(-1);
        };


        this.fn_searchMapSetting = function(){
        	this.ds_search.setColumn(0, "PGM_ID", this.ds_frtPgmInfo.getColumn(0, "PGM_ID"));
        	this.ds_search.setColumn(0, "PGM_NM", this.ds_frtPgmInfo.getColumn(0, "PGM_NM"));
        	this.ds_search.setColumn(0, "USE_YN", this.ds_frtPgmInfo.getColumn(0, "USE_YN"));
        };
        /***********************************************************************************************
        ...
        ************************************************************************************************/
        ...
        this.grd_list_oncelldblclick = function(obj,e)
        {
        	if(e.row != 0 ){
        		var resData = {};
        		var resString = "";
        		resData.PGM_ID = this.ds_frtPgmInfo.getColumn(e.row, "PGM_ID");
        		resData.PGM_NM = this.ds_frtPgmInfo.getColumn(e.row, "PGM_NM");
        ...
        this.btn_select_onclick = function(obj,e)
        {
        	...
        	if(this.ds_frtPgmInfo.rowposition < 1){
        		alert("선택된 데이터가 없습니다.");
        		return;
        	}

        	resData.PGM_ID = this.ds_frtPgmInfo.getColumn(this.ds_frtPgmInfo.rowposition, "PGM_ID");
        	resData.PGM_NM = this.ds_frtPgmInfo.getColumn(this.ds_frtPgmInfo.rowposition, "PGM_NM");
        	resData.CURROW = this.currow;
        	resString = JSON.stringify(resData);
        	this.close(resString);
        };
        ...
        this.loadIncludeScript("SSP_BO_YA_30.xfdl");
