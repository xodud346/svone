(function()
{
    return function()
    {
        ...
        {
            this.set_name("ProductGroupSinglePopup");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"131\"/><Column size=\"276\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"상품군ID\"/><Cell col=\"1\" text=\"상품군명\"/></Band><Band id=\"body\"><Cell text=\"bind:PRD_CLS_CD\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:PRD_CLS_NM\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("productGroupSinglePopup.xfdl", function() {
        /*******************************************************
        ...
        ************************************************************************************************/
        ...
        {
        	var sSvcId = "productGroupSelect";
        	var sUrl = "/co/popUp/productGroupPopupList.do";
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("productGroupSinglePopup.xfdl");
