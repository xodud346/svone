(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_PP_23");
            this.set_titletext("운영단위 멀티 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CODE_LIST\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/><Column id=\"AUTH_USE_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"USE_YN\"/></Row></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"OPR_UNIT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"OPR_UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"BZPLC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"96\"/><Column size=\"288\"/><Column size=\"92\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"운영단위ID\"/><Cell col=\"2\" text=\"운영단위명\"/><Cell col=\"3\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:currow == 0 ? &quot;none&quot; :  &quot;checkbox&quot; \" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:OPR_UNIT_ID\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"2\" text=\"bind:OPR_UNIT_NM\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\" cssclass=\"grd_WF_left\"/><Cell col=\"3\" text=\"bind:USE_YN\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;combo&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;combocontrol&quot; : &quot;combotext&quot;\" combodataset=\"ds_useYn\" combodatacol=\"COM_DTL_CD_NM\" combocodecol=\"COM_DTL_CD\" combotype=\"dropdown\" cssclass=\"gridComboTextCenter\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj.set_scrollbartype("auto fixed");
            obj.set_selecttype("multirow");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"96\"/><Column size=\"288\"/><Column size=\"92\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"운영단위ID\"/><Cell col=\"2\" text=\"운영단위명\"/><Cell col=\"3\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:OPR_UNIT_ID\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:OPR_UNIT_NM\" cssclass=\"grd_WF_left\"/><Cell col=\"3\" text=\"expr:USE_YN == &quot;Y&quot; ? &quot;사용&quot; :  &quot;미사용&quot;\" textAlign=\"center\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_PP_23.xfdl","OD::odUtils.xjs");
        this.registerScript("SSP_BO_PP_23.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        ...
        ************************************************************************************************/
        this.fn_search = function (bInit)
        {
        	...
        	if(bInit){
        		sSvcId = "initSearch";
        		outDs = "ds_oprUnit=ds_output1 ds_select=ds_output1";
        	}
        ...
        ************************************************************************************************/
        this.fn_paramSetting = function (param){
        	...
        	this.ds_search.setColumn(0, "AUTH_USE_CD", param.AUTH_USE_CD);
        	...
        	this.ds_search.setColumn(0, "BZPLC_ID", param.bzplcId);
        	this.fn_commonCodeSearch();
        	if(!this.gfn_isNull(this.oprUnitId)){
        		this.fn_search(true);
        	}else{
        		this.fn_initGrid();
        ...
        this.fn_dsSelectCheck = function(){
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		var findRow = this.ds_oprUnit.findRowExpr("currow != 0 && OPR_UNIT_ID == '" + this.ds_select.getColumn(i, "OPR_UNIT_ID") + "'");
        		if(findRow > -1){
        			this.ds_oprUnit.setColumn(findRow, "CHK", 1);
        		}
        	}
        ...
        ************************************************************************************************/
        ...
        this.btn_add_onclick = function(obj,e)
        {
        	...
        	//체크된 값
        	if(this.ds_oprUnit.rowcount != 0){
        		aTotalArr = this.ds_oprUnit.extractRows("CHK == 1");
        	}

        	this.ds_oprUnit.set_enableevent(false);
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			if(aTotalArr[i] != 0){ //첫번째 row가 선택되어있다면 제외
        				var findRow = this.ds_select.findRowExpr("OPR_UNIT_ID == '" + this.ds_oprUnit.getColumn(aTotalArr[i], "OPR_UNIT_ID") + "'");
        				if(findRow < 0){
        					nRow = this.ds_select.addRow();
        					this.ds_select.copyRow(nRow, this.ds_oprUnit, aTotalArr[i]);
        					this.ds_select.setColumn(nRow, "CHK", 0);
        					this.ds_oprUnit.setColumn(aTotalArr[i], "CHK", 1);
        				}
        			}
        		}
        	...
        	this.ds_oprUnit.set_enableevent(true);
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			var findRow = this.ds_oprUnit.findRowExpr("currow != 0 && OPR_UNIT_ID == '" + this.ds_select.getColumn(aTotalArr[i], "OPR_UNIT_ID") + "'");
        			if(findRow >= 0){
        				this.ds_oprUnit.setColumn(findRow, "CHK", 0);
        ...
        this.btn_select_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		...
        		resData.OPR_BZPLC_ID= this.ds_select.getColumn(i, "BZPLC_ID");
        ...
        {
        	if(e.row != 0 ){
        		var findRow = this.ds_select.findRowExpr("OPR_UNIT_ID == '" + this.ds_oprUnit.getColumn(e.row, "OPR_UNIT_ID") + "'");
        		if(findRow < 0){
        			var nRow = this.ds_select.addRow();
        			this.ds_select.copyRow(nRow, this.ds_oprUnit, e.row);
        			this.ds_select.setColumn(nRow, "CHK", 0);
        			this.ds_oprUnit.setColumn(e.row, "CHK", 1);
        		}
        	}
        };
        ...
        this.Div00_grd_list02_oncelldblclick = function(obj,e)
        {
        	if(e.row >= 0 ){
        		if(e.col != 0){
        			var findRow = this.ds_oprUnit.findRowExpr("currow != 0 && OPR_UNIT_ID == '" + this.ds_select.getColumn(e.row, "OPR_UNIT_ID") + "'");
        			if(findRow >= 0){
        				this.ds_oprUnit.setColumn(findRow, "CHK", 0);
        				this.Div00.form.grd_list01.selectRow(findRow, false); //선택해제
        			}
        ...
        this.Div00_grd_list01_onselectchanged = function(obj,e)
        {
        	...
        	for(var i =startRow; i <= endRow; i++){
        		this.ds_oprUnit.setColumn(i, "CHK", 1);
        	}
        ...
        this.loadIncludeScript("SSP_BO_PP_23.xfdl");
