(function()
{
    return function()
    {
        ...
        {
            this.set_name("SSP_BO_YA_37");
            this.set_titletext("작업예약관리 상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE_LIST\" type=\"STRING\" size=\"256\"/><Column id=\"WRK_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"RSRV_PGM_ID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_del","441","214","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("등록삭제");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save","365","214",null,"30","btn_del:4",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("저장");
            ...
            obj = new Button("btn_cancel","291","214",null,"30","btn_save:4",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("취소");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_wrkRsrvNm","160","156",null,"24","30",null,null,null,null,null,this);
            obj.set_taborder("16");
        ...
        // User Script
        this.registerScript("SSP_BO_YA_37.xfdl", function() {
        /***********************************************************************************************
         * Form 변수 선언 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        this.fn_onload = function(obj,e)
        {
        	...
        	this.ds_search.setColumn(0, "WRK_SEQ", this.parent.wrkSeq);
        	this.ds_search.setColumn(0, "RSRV_PGM_ID", this.parent.rsrvPgmId);
        	this.fn_search();
        };
        ...
        ************************************************************************************************/
        ...
        this.fn_callBack = function(svcID, errorCode, errorMsg) {
        	...
        	case "search":
        		...
        		var sysdate = objDate.getYear() + mm  + dd + hours + minutes + seconds;

        // 		if(!this.gfn_isNull(this.ds_wrkRsrvDtls.getColumn(0, "WRK_EXCE_RSLT_CD"))) {
        ...
        // 		}
        		...
        		if(this.ds_wrkRsrvDtls.getColumn(0, "RSRV_DTM") > sysdate) {
        			this.btn_save.set_enable(true);
        			this.btn_del.set_enable(true);
        		}else{
        			this.btn_save.set_enable(false);
        			this.btn_del.set_enable(false);
        			this.ds_minutes.clearData();
        			this.ds_minutes.addRow();
        			this.ds_minutes.setColumn(0,"MINUTES",this.ds_wrkRsrvDtls.getColumn(0,"RSRV_MINUTE"));
        			this.cal_rsrvDtm.set_enable(false);
        			this.cmb_rsrvHour.set_enable(false);
        			this.cmb_rsrvMinute.set_enable(false);
        			this.cmb_rsrvPgmNm.set_enable(false);
        			this.cmb_wrkRsrvSprCd.set_enable(false);
        			this.edt_wrkRsrvNm.set_enable(false);
        		}
        		break;
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.cal_rsrvDtm.addEventHandler("ondropdown",this.cal_regStartDate_ondropdown,this);
        };
        this.loadIncludeScript("SSP_BO_YA_37.xfdl");
