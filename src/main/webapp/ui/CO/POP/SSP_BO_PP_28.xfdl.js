(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_list","20","135","510","433",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("sta_totcnt","20","109","370","25",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("· 도로명주소 검색 결과 (총 0건, 1 / 1)");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Div("Div00","0","0",null,"90","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Div00");
            obj.set_cssclass("div_WF_SearchArea");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_keyword","20","20","510","30",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("SSP_BO_PP_28.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        CREATION DATES :
        *******************************************************/
        ...
        ************************************************************************************************/
        ...
        this.Div00_edt_keyword_onkeyup = function(obj,e)
        {
        	if(e.keycode == 13) {
        		e.keyCode = 0;
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.edt_keyword.addEventHandler("onkeyup",this.Div00_edt_keyword_onkeyup,this);
            this.Div00.form.sta_totcnt00.addEventHandler("onclick",this.Div_top_info00_sta_totcnt00_onclick,this);
        };
        this.loadIncludeScript("SSP_BO_PP_28.xfdl");
