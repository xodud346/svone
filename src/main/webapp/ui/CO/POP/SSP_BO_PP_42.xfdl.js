(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"COM_CLSF_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"COM_DTL_CD_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_maxCnt","220","41",null,"26","btn_search:4",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            ...
            obj = new Static("sta_totcnt00","156","40",null,"25","edt_maxCnt:4",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_text("최대조회수");
            obj.set_usedecorate("true");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("SSP_BO_PP_42.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        ...
        ************************************************************************************************/
        ...
        this.btn_add_onclick = function(obj,e){
        	...
        	//체크된 값
        	if(this.ds_comCdDtl.rowcount != 0){
        		aTotalArr = this.ds_comCdDtl.extractRows("CHK == 1");
        	}
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			if(aTotalArr[i] != 0){ //첫번째 row가 선택되어있다면 제외
        				var findRow = this.ds_select.findRowExpr("COM_DTL_CD == '" + this.ds_comCdDtl.getColumn(aTotalArr[i], "COM_DTL_CD") + "'");
        				if(findRow < 0){
        					nRow = this.ds_select.addRow();
        					this.ds_select.copyRow(nRow, this.ds_comCdDtl, aTotalArr[i]);
        					this.ds_select.setColumn(nRow, "CHK", 0);
        					this.ds_comCdDtl.setColumn(aTotalArr[i], "CHK", 1);
        				}
        			}
        		}
        ...
        this.btn_del_onclick = function(obj,e){
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			var findRow = this.ds_comCdDtl.findRowExpr("currow != 0 && COM_DTL_CD == '" + this.ds_select.getColumn(aTotalArr[i], "COM_DTL_CD") + "'");
        			if(findRow >= 0){
        ...
        this.Div00_grd_list02_oncelldblclick = function(obj,e)
        {
        	if(e.row >= 0 ){
        		if(e.col != 0){
        			var findRow = this.ds_comCdDtl.findRowExpr("currow != 0 && COM_DTL_CD == '" + this.ds_select.getColumn(e.row, "COM_DTL_CD") + "'");
        			if(findRow >= 0){
        				this.ds_comCdDtl.setColumn(findRow, "CHK", 0);
        				this.Div00.form.grd_list01.selectRow(findRow, false); //선택해제
        			}
        ...
        this.Div00_grd_list01_onselectchanged = function(obj,e)
        {
        	...
        	for(var i =startRow; i <= endRow; i++){
        		this.ds_comCdDtl.setColumn(i, "CHK", 1);
        	}
        ...
        this.loadIncludeScript("SSP_BO_PP_42.xfdl");
