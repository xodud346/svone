(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_orgCd", this);
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"ORG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ORG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"ORG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ORG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ROW_COUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows/>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("ds_orgCdCopy", this);
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"INT\" size=\"256\"/><Column id=\"ORG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"ORG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CO_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"102\"/><Column size=\"109\"/></Columns><Rows><Row size=\"31\" band=\"head\"/><Row size=\"31\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"부서ID\"/><Cell col=\"2\" text=\"부서명\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:currow == 0 ? &quot;imagecontrol&quot; : &quot;checkboxcontrol&quot;\" edittype=\"expr:currow == 0 ? &quot;none&quot; :  &quot;checkbox&quot; \" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:ORG_CD\" textAlign=\"center\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/><Cell col=\"2\" text=\"bind:ORG_NM\" edittype=\"expr:currow == 0 ? &quot;text&quot; : &quot;none&quot;\" displaytype=\"expr:currow == 0 ? &quot;editcontrol&quot; : &quot;normal&quot;\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            obj.set_scrollbartype("auto fixed");
            obj.set_selecttype("multirow");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"102\"/><Column size=\"109\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"부서ID\"/><Cell col=\"2\" text=\"부서명\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:ORG_CD\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:ORG_NM\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_BO_PP_46.xfdl","OD::odUtils.xjs");
        this.addIncludeScript("SSP_BO_PP_46.xfdl","CC::CcUtils.xjs");
        this.registerScript("SSP_BO_PP_46.xfdl", function() {
        /*******************************************************
        PROJECT NAME : SSP-BO
        ...
        ************************************************************************************************/
        this.fn_onLoad = function(obj,e)
        {
        	...
        	this.ds_orgCdCopy.copyData(this.ds_orgCd);
        ...
        ************************************************************************************************/
        ...
        {
        	var orgCd = this.ds_search.getColumn(0, "ORG_CD");
        	var orgNm = this.ds_search.getColumn(0, "ORG_NM");
        	if(this.gfn_isNull(this.gfn_trim(orgCd)) && this.gfn_isNull(this.gfn_trim(orgNm))){
        		alert(this.fn_getMessage("ERRC000253")); // 최소 1개의 검색조건을 입력하여 주십시오.
        		return;
        	}

        	var sSvcId = "search";
        	var sUrl = "/co/popup/select-orgcd-popup-list.do";
        	var inDs = "ds_search=ds_search"
        	var outDs = "ds_orgCd=ds_output1";
        	var arg;

        	if(bInit){
        		sSvcId = "initSearch";
        		outDs = "ds_orgCd=ds_output1 ds_select=ds_output1";
        	}
        ...
        ************************************************************************************************/
        this.fn_callBack = function(svcID, errorCode, errorMsg)	{
        	switch(svcID){
        		...
        		case "search":
        			if(this.totalCount < 1){
        				this.ds_orgCd.copyData(this.ds_orgCdCopy);
        ...
        ************************************************************************************************/
        ...
        this.fn_initGrid = function(){
        	this.ds_orgCd.insertRow(0);
        	this.ds_orgCd.setColumn(0, "CO_CD", this.ds_search.getColumn(0, "CO_CD"));
        	this.ds_orgCd.setColumn(0, "ORG_CD", this.ds_search.getColumn(0, "ORG_CD"));
        	this.ds_orgCd.setColumn(0, "ORG_NM", this.ds_search.getColumn(0, "ORG_NM"));
        	this.ds_orgCd.set_rowposition(-1);
        };

        //선택한 값을 조회 후에도 확인할 수 있도록 체크
        this.fn_dsSelectCheck = function(){
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		var findRow = this.ds_orgCd.findRowExpr("currow != 0 && ORG_CD == '" + this.ds_select.getColumn(i, "ORD_CD") + "'");
        		if(findRow > -1){
        			this.ds_orgCd.setColumn(findRow, "CHK", 1);
        		}
        	}
        ...
        this.fn_searchMapSetting = function(){
        	this.ds_search.setColumn(0, "ORG_CD", this.ds_orgCd.getColumn(0, "ORD_CD"));
        	this.ds_search.setColumn(0, "ORG_NM", this.ds_orgCd.getColumn(0, "ORG_NM"));
        };
        ...
        ************************************************************************************************/
        ...
        this.btn_add_onclick = function(obj,e)
        {
        	...
        	//체크된 값
        	if(this.ds_orgCd.rowcount != 0){
        		aTotalArr = this.ds_orgCd.extractRows("CHK == 1");
        	}

        	this.ds_orgCd.set_enableevent(false);
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			if(aTotalArr[i] != 0){ //첫번째 row가 선택되어있다면 제외
        				var findRow = this.ds_select.findRowExpr("ORG_CD == '" + this.ds_orgCd.getColumn(aTotalArr[i], "ORG_CD") + "'");
        				if(findRow < 0){
        					nRow = this.ds_select.addRow();
        					this.ds_select.copyRow(nRow, this.ds_orgCd, aTotalArr[i]);
        					this.ds_select.setColumn(nRow, "CHK", 0);
        					this.ds_orgCd.setColumn(aTotalArr[i], "CHK", 1);
        				}
        			}
        		}
        	...
        	this.ds_orgCd.set_enableevent(true);
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(aTotalArr != undefined && aTotalArr.length != 0){
        		for(var i = 0; i< aTotalArr.length; i++){
        			var findRow = this.ds_orgCd.findRowExpr("currow != 0 && ORG_CD == '" + this.ds_select.getColumn(aTotalArr[i], "ORG_CD") + "'");
        			if(findRow >= 0){
        				this.ds_orgCd.setColumn(findRow, "CHK", 0);
        ...
        this.btn_select_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i< this.ds_select.rowcount; i++){
        		resData.ORG_CD= this.ds_select.getColumn(i, "ORG_CD");
        		resData.ORG_NM= this.ds_select.getColumn(i, "ORG_NM");
        ...
        {
        	if(e.row != 0 && e.col != 0){
        		var findRow = this.ds_select.findRowExpr("ORG_CD == '" + this.ds_orgCd.getColumn(e.row, "ORG_CD") + "'");
        		if(findRow < 0){
        			var nRow = this.ds_select.addRow();
        			this.ds_select.copyRow(nRow, this.ds_memLogin, e.row);
        			this.ds_select.setColumn(nRow, "CHK", 0);
        			this.ds_orgCd.setColumn(e.row, "CHK", 1);
        		}
        	}
        };
        ...
        this.Div00_grd_list02_oncelldblclick = function(obj,e)
        {
        	if(e.row >= 0 ){
        		if(e.col != 0){
        			var findRow = this.ds_orgCd.findRowExpr("currow != 0 && ORG_CD == '" + this.ds_select.getColumn(e.row, "ORG_CD") + "'");
        			if(findRow >= 0){
        				this.ds_orgCd.setColumn(findRow, "CHK", 0);
        				this.Div00.form.grd_list01.selectRow(findRow, false); //선택해제
        			}
        ...
        this.Div00_grd_list01_onselectchanged = function(obj,e)
        {
        	...
        	for(var i =startRow; i <= endRow; i++){
        		this.ds_orgCd.setColumn(i, "CHK", 1);
        	}
        ...
        this.loadIncludeScript("SSP_BO_PP_46.xfdl");
