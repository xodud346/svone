(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00","119","0","51","23",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("10MB");
            obj.set_color("red");
            ...
            obj = new Static("Static01","172","0","388","23",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("미만의 파일최대         까지 등록 할 수 있습니다.");
            this.addChild(obj.name, obj);

            obj = new Static("Static01_00_00","266","0","33","23",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("5개");
            obj.set_color("red");
            obj.set_font("normal bold 10pt/normal \"Arial\"");
        ...
        // User Script
        this.registerScript("fileUpload_01.xfdl", function() {
        ...
        ************************************************************************************************/
        ...
        this.grd_file_oncellclick = function(obj,e)
        {
        	if( this.ds_files.getRowType(e.row) != 1) {
        		if( obj.getCellPos() == 2 ) {
        			this.FileUpTransfer.clearFileList(e.row);//해당 파일첨부 행 삭제
        ...
        this.fn_fileSizeCheck = function(obj, fileSize) {
        	...
        	if( this.ds_files.rowcount >= 5 ) {
        		alert("최대 첨부 개수는 5개 입니다.");
        		return false;
        	}
        ...
        this.loadIncludeScript("fileUpload_01.xfdl");
