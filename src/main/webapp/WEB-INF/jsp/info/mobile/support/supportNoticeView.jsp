...
<%@ include file="/WEB-INF/jsp/info/mobile/include/top.jsp" %>
	...
	<article id="container" class="container" data-role="content">
        ...
        <h3 class="bbs-title report-title mt20"><c:if test="${row.DRT_NTS_TOP_YN eq 'Y'}">[공지]</c:if><c:out value="${row.DRT_NTS_TITLE}" /></h3>

        <div class="ct bbs-desc report-desc"><!-- bbs-desc -->
            <div class="fl date">
                <span class="blind">등록 날짜</span><c:out value="${row.DRT_NTS_REG_DT}" />
            </div>
            <div class="fr hit">
                조회수 <c:out value="${row.DRT_NTS_READ_CNT}" />
            </div>
        </div><!-- // bbs-desc -->
        ...
        <div class="section-button"><!-- section-button -->
            <a href="<c:out value="${mobileBrandDomain}"/>/info/mobile/support/supportNotice.do" class="button"><span>목록</span></a>
        </div><!-- // section-button -->
