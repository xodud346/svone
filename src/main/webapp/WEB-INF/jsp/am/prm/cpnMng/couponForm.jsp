			  		...
			  		<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
		                            <input type="radio" name="CPN_MST_ISU_GBN" id="cG3" class="radio" value="B" checked="checked"/>
		                            <label for="cG3">대상자 지정 발행</label>
		                            <input type="radio" name="CPN_MST_ISU_GBN" id="cG4" class="radio" value="D"/>
		                            <label for="cG4">회원가입</label>
		                            <input type="radio" name="CPN_MST_ISU_GBN" id="cG5" class="radio" value="C"/>
		                            <label for="cG5">다운로드발급</label>	
		                            	
	                    		</td>
	                        </tr>
	                        
	                        <tr id="expsId" style="display:none;">
	                    		<th><label class="label"><span>쿠폰함 노출 여부</span></label></th>
	                    		<td colspan="3">
	                    			<input type="radio" name="CPN_MST_EXPS_YN" id="expsA" class="radio" value="Y"/>
		                            <label for="expsA">노출</label>
		                            <input type="radio" name="CPN_MST_EXPS_YN" id="expsB" class="radio" value="N" checked="checked"/>
	                        ...
	                        <tr>
	                    		...
	                    		<td colspan="3">
		                            ...
		                            <span class="auctionEventTime"><label for="cmidgB">사용가능일수(<span id="CPN_MST_USE_DAY_NM">발행</span>일로부터 <input type="text" id="CPN_MST_USE_DAY" name="CPN_MST_USE_DAY" class="text short number" disabled="disabled" maxlength="10" /> 일)</label> (고객이 보유한 시점부터 사용가능)</span>
		                            <br/><br/>
                	...
                	<span id="rowUnit">
		                ...
		                <div class="grid section-button-list"><!-- 목록 상단 버튼 -->
		                    <div class="col-1-2 text-left">
		                        <span class="pages ml0 pt10">(총 <strong id="memberCnt">0</strong>건)</span>
		                    </div>
                	...
                	<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="radio" name="CPN_MST_TGT_GBN" id="cmtg2" class="radio" value="B" checked="checked"/>
		                            <label for="cmtg2">전체상품</label>
		                            
	                    			<input type="radio" name="CPN_MST_TGT_GBN" id="cmtg1" class="radio" value="A"/>
		                            <label for="cmtg1">개별상품</label>	
		                            
		                            <input type="radio" name="CPN_MST_TGT_GBN" id="cmtg5" class="radio" value="E"/>
		                            <label for="cmtg5">카테고리</label>	                           
	                    		</td>
	                        </tr>
	                        <tr id="CPN_MST_PLN_TEX" style="display:none;">
	                    		...
	                    		<td id="divCategoryTgt" style="display:block">
	                    			<div class="grid section-button-list"><!-- 목록 상단 버튼 -->
					                    <div class="text-right">
                	...
                	<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="radio" name="CPN_MST_ETC_GBN" id="cmeg5" class="radio" value="F" checked="checked"/>
	                    	...
	                    	<tr id="CPN_MST_PLN_TEX_2" style="display:none;">
	                    		<th><label class="label"><span>대상<i class="require"><em>필수입력</em></i></span></label></th>
...
<tr>
	<td><input type="checkbox" class="checkbox checkMember" name="MEM_ID_CHKECs" value="\${memId}"/><input type="hidden" name="MEM_IDs" value="\${memId}"/></td>
	<td>\${memSprNm}</td>
	<td>\${memId}</td>
	<td>\${memNm}</td>
	<td>\${loginId}</td>
...
<tr>
	<td><input type="checkbox" class="checkbox checkRow" name="PRD_MST_CDs" value="\${prdId}"/></td>
	<td><a href="\${serverDomain}/am/product/basicProductEdit.do?PRD_MST_CD=\${prdId}" target="_blank" title="새 창 으로 열립니다.">\${prdId}</a><input type="hidden" name="APPLY_IDXs" value="\${prdId}"/></td>
	<td>
		\${prdNm}
	</td>
</tr>
...
<tr>
	<td><input type="checkbox" class="checkbox checkRow2" name="PRD_MST_CDs2" value="\${prdId}"/></td>
	<td><a href="\${serverDomain}/am/product/basicProductEdit.do?PRD_MST_CD=\${prdId}" target="_blank" title="새 창 으로 열립니다.">\${prdId}</a><input type="hidden" name="APPLY_IDXs2" value="\${prdId}"/></td>
	<td>
		\${prdNm}
	</td>
</tr>
...
<tr>
	<td><input type="checkbox" class="checkbox checkRow_category" name="PRD_CTG_IDXs_category" value="\${prdClsCd}"/></td>
...
<tr>
	<td><input type="checkbox" class="checkbox checkRow2_category" name="PRD_CTG_IDXs2_category" value="\${prdClsCd}"/></td>
	<td class="left">\${prdClsCd}</td>
	<td class="left">\${prdLvlNm}<input type="hidden" name="PRD_CTG_IDXs2" value="\${prdClsCd}"/></td>
</tr>
</script>
...
$(function(){
    ...
    $(document).on("click", "#goRegist", function() {
    	...
    	if (confirm("저장 하시겠습니까?")) 
  		{
            $("#frm").attr({"action" : "<c:out value="${serverDomain}" />/am/prm/cpnMng/couponFormRegist.do", "target" : "_self", "method" : "post"}).submit();
        }	
...
function fnResultProduct66(params){
	if($("#search_1").val() == "Y"){
		fnResultProduct1(params);
	}
