			  		...
			  		<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                    	<tr>
	                    		...
	                    		<td>
	                    			<input type="radio" name="APP_VER_GBN" id="gubunA" value="A" class="radio" checked="checked"/>
		                            <label for="gubunA">안드로이드</label>
		                            <input type="radio" name="APP_VER_GBN" id="gubunB" value="I" class="radio" />
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="text" name="APP_VER_NM" id="APP_VER_NM" class="text xlarge" placeholder="최대 15자까지 입력하실 수 있습니다." maxlength="15"/>
	                    		</td>
	                        </tr>
	                        <tr>
	                    		<th><label class="label"><span>버전 <i class="require"><em>필수입력</em></i></span></label></th>
	                    		<td>
	                    			<input type="text" name="APP_VER_NO" id="APP_VER_NO" class="text" maxlength="10"/>
	                    		</td>
	                        </tr>
	                        <tr>
	                    		<th><label class="label"><span>내용<i class="require"><em>필수입력</em></i></span></label></th>
	                    		<td>
	                    			<textarea name="APP_VER_CTS" id="APP_VER_CTS" style="height: 300px;" maxlength="1800"></textarea>
	                    		</td>
	                        </tr>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="radio" name="APP_VER_YN" id="stateA" value="Y" class="radio" checked="checked"/>
		                            <label for="stateA">사용</label>
		                            <input type="radio" name="APP_VER_YN" id="stateB" value="N" class="radio" />
    ...
    $(document).on("click", "#goRegist", function () {
    	...
    	if($frm.valid()){ 
            ...
            if (confirm( "저장 하시겠습니까?")) {
                $frm.attr({"action":"<c:out value="${serverDomain}" />/am/app/appVersionManageRegist.do", "target":"_self", "method":"post"}).submit();
            }
        }
    });
});
