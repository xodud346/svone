	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				<h3 class="title"><span>처리자 조회</span></h3>
...
$(function(){
	...
	// 검색
	search = function() {
		$("#popList").load("/am/com/popUp/employee2PopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnEmployeeSingleCallback(param);
				self.close();
			});
		});
	};
