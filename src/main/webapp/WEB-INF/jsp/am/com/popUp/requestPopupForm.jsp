	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				<h3 class="title"><span>요청자 조회</span></h3>
				<form id="frm" name="frm">
					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
						...
						<tbody>
							<tr>
								<th scope="col"><span>요청자 ID</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="reqrId" name="reqrId" value="" />
								</td>
							</tr>
							<tr>
								<th scope="col"><span>요청자 명</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="reqrNm" name="reqrNm" value="" />
								</td>
							</tr>
							<tr>
								<th scope="col"><span>로그인 ID</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="lgnId" name="lgnId" value="" />
								</td>
							</tr>
						</tbody>
					</table><!-- // table -->
...
$(function(){
	...
	// 검색
	search = function() {
		$("#rqstList").load("/am/com/popUp/requestPopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnRequestResultCallback(param);
				self.close();
			});
		});
	};
