	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				<h3 class="title"><span>${commandMap.titleTxt } 조회</span></h3>
				...
				<!-- 조회 결과 영역 -->
				<div id="popList">
					<%-- <%@ include file="/WEB-INF/jsp/am/com/popUp/memOprtrOrgPopupList.jsp" %> --%>
				</div>
				<!-- //조회 결과 영역 -->
			</div>
		</div>
...
$(function(){
	...
	// 검색
	search = function() {
		$("#popList").load("/am/com/popUp/memOprtrOrgPopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnMemOprtrOrgResultCallback("${commandMap.eleId}",param);
				self.close();
			});
		});
	};
