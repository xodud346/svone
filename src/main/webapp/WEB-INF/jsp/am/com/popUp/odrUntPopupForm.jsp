	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				<h3 class="title"><span>주문단위 검색</span></h3>
				<form id="frm" name="frm">
					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
						...
						<tbody>
							<tr>
								<th scope="col"><span>주문단위</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="untCd" name="untCd" value="" />
								</td>
							</tr>
...
$(function(){
	...
	// 검색
	search = function() {
		$("#odrList").load("/am/com/popUp/odrUntPopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnOdrUntResultCallback(param);
				self.close();
			});
		});
	};
