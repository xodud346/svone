    ...
    <div class="modal">
        <div class="modal-wrapper">
            <div class="modal-inner">
	                ...
	                <table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
	                    ...
	                    <tbody>
	                    	<tr>
	                            ...
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="bzplcId" name="bzplcId" value="${commandMap.BZPLC_ID}" />
	                            </td>
	                    	</tr>
	                    	<tr>
	                    		<th><span>사업장명</span></th>
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="bzplcNm" name="bzplcNm" value="${commandMap.BZPLC_NM}" />
	                            </td>
	                    	</tr>
	                    </tbody>
	                </table><!-- // table -->
                ...
                <!-- 조회 결과 영역 -->
                <div id="popList">
                	<%-- <%@ include file="/WEB-INF/jsp/am/com/popUp/onebzplcPopupList.jsp" %> --%>
                </div>
                <!-- 조회 결과 영역 -->
            </div>
        </div>
...
$(function(){
	...
	// 검색
    search = function() {
		$("#popList").load("/am/com/popUp/onebzplcPopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnOneBzplcResultCallback(param);
				self.close();
			});
		});
	};
