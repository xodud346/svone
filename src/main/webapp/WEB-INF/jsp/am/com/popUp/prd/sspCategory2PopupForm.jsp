    ...
    <div class="modal">
        <div class="modal-wrapper">
            <div class="modal-inner">
				<h3 class="title"><span>카테고리 조회</span></h3>
				<form id="frm" name="frm">
	                ...
	                <table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
	                    ...
	                    <tbody>
	                    	<tr>
	                    		<th scope="col"><span>카테고리ID</span></th>
	                            <td>
                ...
                <!-- 조회 결과 영역 -->
				<div id="popList">
					<%-- <%@ include file="/WEB-INF/jsp/am/com/popUp/prd/sspCategory2PopupList.jsp" %> --%>
				</div>
				<!-- //조회 결과 영역 -->
            </div>
        </div>
...
$(function(){
	...
	search = function(cPage) {
		...
		$("#popList").load("/am/com/popUp/prd/sspCategory2PopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off('click').on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnResultSspCateSingleCallback("${commandMap.eleId}",param);
				self.close();
			});
		});
	};
