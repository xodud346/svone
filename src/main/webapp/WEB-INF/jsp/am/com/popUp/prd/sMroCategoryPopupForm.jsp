    ...
    <div class="modal">
        <div class="modal-wrapper">
            <div class="modal-inner">
				<h2 class="title"><span>S-MRO 카테고리관리</span></h2>
	                ...
	                <table class="table-row table-a" style="margin-bottom: 0;">
	                    ...
	                    <tbody>
	                    	<tr>
	                            ...
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="searchPrdClsCd" name="searchPrdClsCd" value="${commandMap.smroMappId}" />
	                            </td>
	                    	</tr>
	                    	<tr>
	                    		<th><span>카테고리명</span></th>
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="searchPrdClsNm" name="searchPrdClsNm" value="${commandMap.smroMappNm}" />
	                            </td>
	                    	</tr>
	                    </tbody>
	                </table>
...
$(function(){
	...
	search = function(cPage) {
		...
		$("#categoryList").load("/am/com/popUp/prd/sMroCategoryPopupList.do", $frm.serialize(), function(){})
	}
    ...
    categorySel = function () {
    	...
    	obj.prdClsLvlNm = $("input[name='rowChk']:checked").data('lvlnm');
		
    	// 사업장 조회 팝업 return function
    	window.opener.fnResultSMroCategoryMapp(obj);
		self.close();
    }
