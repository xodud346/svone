	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				...
				<!-- 조회 결과 영역 -->
				<div id="popList">
					<%-- <%@ include file="/WEB-INF/jsp/am/com/popUp/productSinglePopupList.jsp" %> --%>
				</div>
				<!-- //조회 결과 영역 -->
			</div>
		</div>
...
$(function(){
	...
	search = function(cPage) {
		...
		$("#popList").load("/am/com/popUp/productSinglePopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off('click').on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnProductSingleCallback("${commandMap.eleId}",param);
				self.close();
			});
		});
	};
