    ...
    <div class="modal">
        <div class="modal-wrapper">
            <div class="modal-inner">
				<h3 class="title"><span>제조원 조회</span></h3>
				<form id="frm" name="frm">
	                ...
	                <table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
	                    ...
	                    <tbody>
	                    	<tr>
	                    		<th scope="col"><span>제조원ID</span></th>
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="mnfrNo" name="mnfrNo" value="" />
	                            </td>
	                    	</tr>
	                    	<tr>
	                    		<th scope="col"><span>제조원명</span></th>
	                            <td>
	                            	<input type="text" class="text" style="width: 100%;" id="mnfrNm" name="mnfrNm" value="" />
	                            </td>
	                    	</tr>
	                    </tbody>
	                </table><!-- // table -->
...
$(function(){
	...
	search = function(cPage) {
		...
		$("#popList").load("/am/com/popUp/prd/manufacturer2PopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off('click').on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnResultMnfrSingleCallback("${commandMap.eleId}",param);
				self.close();
			});
		});
	};
