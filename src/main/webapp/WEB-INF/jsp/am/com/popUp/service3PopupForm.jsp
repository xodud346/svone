			...
			<div class="modal-inner">
				...
				<form id="frm" name="frm">
					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
						...
						<tbody>
							<tr>
								<th scope="col"><span>담당자 ID</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="chrpsnId" name="chrpsnId" value="" />
								</td>
							</tr>
							<tr>
								<th scope="col"><span>담당자 명</span></th>
								<td>
									<input type="text" class="text" style="width: 100%;" id="chrpsnNm" name="chrpsnNm" value="" />
								</td>
							</tr>
...
$(function(){
	...
	// 검색
	search = function() {
		$("#popList").load("/am/com/popUp/service3PopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnServiceResultCallback(param);
				self.close();
			});
		});
	};
