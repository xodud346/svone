	...
	<div class="modal">
		<div class="modal-wrapper">
			<div class="modal-inner">
				...
				<form id="frm" name="frm">
					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
						...
						<tbody>
							...
							<tr>
								<th scope="col"><span>운영단위 명</span></th>
								<td>
				...
				<!-- 조회 결과 영역 -->
				<div id="popList">
					<%-- <%@ include file="/WEB-INF/jsp/am/com/popUp/operatePopupList.jsp" %> --%>
				</div>
				<!-- //조회 결과 영역 -->
			</div>
		</div>
...
$(function(){
	...
	search = function(cPage) {
		...
		$("#popList").load("/am/com/popUp/operatePopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off('click').on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnOprUntSingleCallback("${commandMap.eleId}",param);
				self.close();
			});
		});
	};
