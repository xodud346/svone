			  		...
			  		<table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                    		...
	                    		<td>
	                    			<input type="radio" name="BRD_FAQ_OFTEN_YN" id="stateOftenA" value="Y" class="radio" />
	                                <label for="stateOftenA">사용</label>
	                                <input type="radio" name="BRD_FAQ_OFTEN_YN" id="stateOftenB" value="N" class="radio" checked="checked" />
