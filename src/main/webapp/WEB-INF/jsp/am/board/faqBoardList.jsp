        ...
        <div id="contents"><!-- contents -->
            ...
            <div class="container">
									...
									<select class="select" name="saerchBrdCmnComIdx" id="saerchBrdCmnComIdx">
	                                	...
	                                	<c:if test="${not empty codes.FAQ_INQUIRY_TYPE_CODE }">
			 	                    		<c:forEach var="faqRow" items="${codes.FAQ_INQUIRY_TYPE_CODE }" varStatus="i">
			 	                    			<option value="<c:out value="${faqRow.CMN_COM_IDX }"/>" <c:if test="${commandMap.saerchBrdCmnComIdx eq faqRow.CMN_COM_IDX}">selected="selected"</c:if>>
                ...
                <form id="frm" name="frm"> 
                    ...
                    <input type="hidden" name="saerchBrdCmnComUpIdx" value="<c:out value="${commandMap.saerchBrdCmnComUpIdx }"/>"/>
								...
								<c:when test="${not empty list }">
									...
									<c:forEach var="row" items="${list }" varStatus="i">
										<tr>
											...
											<td><c:out value="${row.BRD_FAQ_READ_CNT }"/></td>
											<%-- <td>
