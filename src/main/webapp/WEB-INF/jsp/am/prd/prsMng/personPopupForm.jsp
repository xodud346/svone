					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
						...
						<tr>
							...
							<tr>
								...
								<td>
									<input type="text" class="text" style="width: 100%;" id="chrpsnNm" name="oprtrNm" value="" />
								</td>
							</tr>
							<tr>
...
$(function(){
	...
	// 검색
	search = function() {
		$("#popList").load("/am/prd/prsMng/personPopupList.do", $frm.serialize(), function(){
			//데이터 클릭
			$("#_selectedData tr").off().on("click" , function(){
				...
				// 부모창 함수 콜
				window.opener.fnPersonResultCallback(param);
				self.close();
			});
		});
	};
