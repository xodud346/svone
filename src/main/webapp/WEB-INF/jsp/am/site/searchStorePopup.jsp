...
<div id="container"><!-- container -->
	...
	<div id="contents"><!-- contents -->
        ...
        <form id="searchForm" name="searchForm">
            ...
            <input type="hidden" name="searchMniShpUseYn" value="Y" />
				...
				<c:choose>
				    <c:when test="${not empty list}">
						...
						<tr>
							...
							<td class="left">
								<a href="javascript:goReturn('<c:out value="${item.COMP_CD }" />','<c:out value="${item.BCNC_CD }" />','<c:out value="${item.BCNC_NM }" />');"><c:out value="${item.BCNC_NM }" /></a>
							</td>								
						</tr>
...
$(document).ready(function () {
    ...
    search = function() 
    {
        ...
        $searchForm.attr({"action":"<c:out value="${serverDomain}" />/am/site/searchStorePopup.do", "target":"_self", "method":"post"}).submit(); 
    };
    ...
    goPage = function (cPage) 
    {
        ...
        $frm.attr({"action":"<c:out value="${serverDomain}"/>/am/site/searchStorePopup.do", "target":"_self", "method":"post"}).submit();
    };
    
    // 매장 선택 
    goReturn = function (compCd, bcncCd,bcncNm)
    {
        var obj = new Object();
        obj.COMP_CD = compCd;
        obj.SHOP_CD = bcncCd;
