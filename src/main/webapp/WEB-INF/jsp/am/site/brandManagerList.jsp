	                ...
	                <table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;"><!-- table -->
	                    ...
	                    <tbody>
	                        <tr><!-- row -->
	                            ...
	                            <td>
	                                <input type="text" class="text" name="searchBrandNm" id="searchBrandNm" value="<c:out value="${commandMap.searchBrandNm }"/>" maxlength="15"/>
	                            </td>
	                            <th><span>상태</span></th>
	                            <td>
                       	...
                       	<c:when test="${not empty list }">
                            ...
                            <c:forEach var="row" items="${list }" varStatus="i">
                                <tr>
                           			...
                           			<td>
                           				<a href="javascript:goEdit('<c:out value="${row.BND_MST_IDX }"/>');" class="list-title">
									...
									<td><ui:formatDate value="${row.BND_MST_REG_DT }" pattern="yyyy.MM.dd HH:mm:ss"/></td>
                           			<td><c:out value="${row.BND_MST_USE_YN eq 'Y'?'사용':'미사용' }"/></td>
                       			</tr>
