	...
	<table cellspacing="0" class="table-row table-a"><!-- table -->
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="radio" name="BNR_MST_TGT" id="BNR_MST_TGT1" value="" <ui:select v="${row.BNR_MST_TGT }" t="" g="checked"/>><label for="BNR_MST_TGT1">링크없음</label>
			...
			<tr>
				...
				<td>
					<input type="number" name="BNR_MST_MIL_ADD" id="BNR_MST_MIL_ADD" class="text" value="<c:out value="${row.BNR_MST_MIL_ADD }"/>" />
				</td>
			</tr>
			<tr>
				<th><label class="label"><span>상품권</span></label></th>
				<td>
					<input type="number" name="BNR_MST_GFT" id="BNR_MST_GFT" class="text" value="<c:out value="${row.BNR_MST_GFT }"/>"/>
				</td>
			</tr>
