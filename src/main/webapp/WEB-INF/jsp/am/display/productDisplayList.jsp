				...
				<c:forEach var="row" items="${list }" varStatus="i">
					...
					<tr>
					    ...
					    <td class="left" style="padding-left:10px">
							...
							<textarea name="DSP_MST_TXT" id="DSP_MST_TXT" style="width:100%;height:30px;" maxlength=100><c:out value="${row.DSP_MST_TXT }" /></textarea>
					    </td>
					    <td>
    ...
    $(document).on("click", "#modifySort", function () {
        if (confirm( "저장 하시겠습니까?")) {
	        ...
	        $(".sort-target").find("tr").each(function (i) {
	            ...
	            txtArray.push($("textarea[name=DSP_MST_TXT]").eq(i).val());
	        });
