	...
	<div id="contents"><!-- contents -->
		...
		<div class="tab-a justified" style="margin-top: 20px;"><!-- tab -->
             <ul class="tab">
                 ...
                 <li class="active"><a href="<c:out value="${serverDomain}" />/am/common/commonZipCodePopup.do?searchType=BUILDING"><span>건물명 검색</span></a></li>
             </ul>
         </div><!-- // tab -->
...
<%-- 			<input type="hidden" name="searchType" id="searchType" value="${commandMap.searchType != null ? commandMap.searchType : 'BASIC'}"> --%>
        ...
        <div class="searchTypeBuilding"><!-- step2 건물명 -->
            <p style="padding-left:20px;">
            	-   찾고 싶으신 동/읍/면과 번지를 입력해 주세요.<br/>
            ...
            <div class="search-zip"><!-- search-zip -->
            	<div>
                    ...
                    <em class="strong">*</em>
                    <input type="text" class="text" id="dong" maxlength="15" placeholder="동/읍/면 입력" value="<%=searchDong %>"/>
            	</div>
            	<div class="mt5">
            		<strong>건물명</strong>
	                <input type="text" class="text large" id="buildNm" placeholder="건물명 입력" title="건물명" value="<%=searchBuildNm%>"/>
