...
<header><!-- header -->
	<h1 class="title">이메일 발송 ( 이벤트 발송 )</h1>
			...
			<form id="frm" method="post">
				...
				<div class="form-group lmsDiv">
		         ...
		         <div class="form-group">
		             ...
		             <div class="field">
		                 <textarea class="textarea LMS_MSG" name="EMAIL_CONTENTS1" id="EMAIL_CONTENTS1" style="width:90%;"></textarea>
		             </div>
		         </div>
		         ...
		         <div class="form-group">
		             <label class="label"><span>내용 <em class="strong">*</em></span></label>
		             <div class="field">
		                 <textarea class="textarea LMS_MSG" name="EMAIL_CONTENTS2" id="EMAIL_CONTENTS2" style="width:90%;"></textarea>
		             </div>
		         </div>
			</form>
		</div>
...
$(document).ready(function(){
    ...
    $frm.validate(
    {
        rules: 
        {
        	...
        	EMAIL_CONTENTS1 : {required:true}				 					 // 이메일 내용
        },
        messages :
        {
        	...
        	EMAIL_CONTENTS1: {required:"[이메일 내용]는 필수 정보입니다."}
        }
		...
		if(submitCnt == 0){
			...
			if($frm.valid()){
				...
				if(confirm("발송하시겠습니까?")){
					...
					$("#frm").attr("action","<c:out value="${serverDomain}" />/am/common/commonEmailSendFormProc.do").submit();
				}
			}
