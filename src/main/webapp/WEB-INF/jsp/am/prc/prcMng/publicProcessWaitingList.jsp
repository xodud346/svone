...
<div id="container">
	...
	<div id="wrapper">
		...
		<div id="contents">
			<div id="container">
				<h2 class="title"><span>공용상품 처리대기 목록</span></h2>
					...
					<table cellspacing="0" class="table-row table-a" style="margin-bottom: 0;">
						...
						<tbody>
							<tr>	
								...
								<td>
									<select class="select" id="selectCategory" name="selectCategory">
										<option value="" selected>가격등록요청</option>
									</select>
								</td>	
							...
							<tr>
								...
								<td>
								<input type="text" class="text-large" id="bzplcId" name="bzplcId" />
								</td>	
								<th><span>요청사업장</span></th>
								<td>
									<input type="text" class="text-large" id="searchPrdClsNm" name="searchPrdClsNm" />
									<a href="javascript:openMultiTextPopup('searchId');" class="icon doc"></a>
								</td>
				...
				<form id="listForm">
					...
					<div id="productList">
						<%@ include file="/WEB-INF/jsp/am/prc/prcMng/publicProcessWaitingSubList.jsp" %>
					</div>
				</form>
			</div>
		</div>
...
$(function(){
	...
	goSearch = function(){
		$("#productList").load("<c:out value="${serverDomain}" />/am/prc/prcMng/publicProcessWaitingSubList.do", $searchForm.serialize());
	}
