	                ...
	                <table cellspacing="0" class="table-row table-a"><!-- table -->
	                    ...
	                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="select" name="PRD_MST_MD_ID" id="PRD_MST_MD_ID">
                                        <option value="" <ui:select v="${productInfo.PRD_MST_MD_ID}" t="" g="selected"/>>선택</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="PRD_MST_CPN_OWN" id="PRD_MST_CPN_OWN" class="select">
                                        <option value="M" <ui:select v="${productInfo.PRD_MST_CPN_OWN}" t="M" g="selected"/>>본사 주최</option>
                                        <option value="V" <ui:select v="${productInfo.PRD_MST_CPN_OWN}" t="V" g="selected"/>>입점업체 주최</option>
                                    </select>
                                    ...
                                    <input type="text" id="PRD_MST_PC_CPN_PRC" name="PRD_MST_PC_CPN_PRC" class="number text short" value="<c:out value="${productInfo.PRD_MST_PC_CPN_PRC }" />"  maxlength=10 />
                                    <p style="margin:3px 0;"></p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    배송 가능일 <input type="text" id="PRD_MST_DLV_DT" name="PRD_MST_DLV_DT" class="number text short" value="<c:out value="${productInfo.PRD_MST_DLV_DT}" />"  maxlength="9"  />&nbsp;일
                                </td>
                            </tr>   
                            <tr>
                            ...
                            <tr>
                                <th><span>등록일</span></th>
                                <td><c:out value="${productInfo.PRD_MST_REG_NM}" />(<c:out value="${productInfo.PRD_MST_REG_ID}" />)/<ui:formatDate value="${productInfo.PRD_MST_REG_DT }" pattern="yyyy.MM.dd HH:mm:ss"/></td>
                                <th><span>수정일</span></th>
                                <td>
                                	<c:if test="${not empty productInfo.PRD_MST_UPD_NM }">
                                		<c:out value="${productInfo.PRD_MST_UPD_NM}" />(<c:out value="${productInfo.PRD_MST_UPD_ID}" />)/<ui:formatDate value="${productInfo.PRD_MST_UPD_DT }" pattern="yyyy.MM.dd HH:mm:ss"/>
                                	</c:if>
                                </td>
                            </tr>
	                    </tbody>
	                                             ...
	                                             <c:if test="${fn:length(Code.PRODUCT_ICON_NM) > 0 }">
	                                                 ...
	                                                 <tr>
	                                                     ...
	                                                     <td>노출기간 : 
	                                                         ...
	                                                         <input type="text" class="text datepicker s-datepicker" id="PRD_MST_ICN_ST_DT_${iconCnt}" name="PRD_MST_ICN_ST_DT${iconCnt}" value="<c:out value="${PRD_MST_ICN_ST_DT[iconCnt -1] }" />" readonly="readonly" data-target-end="#PRD_MST_ICN_ED_DT${iconCnt}" />
	                                                          ~
	                                                         <a href="javascript:;" class="js-datepickr"><span class="icon datepickr"><em>날짜선택</em></span></a>
	                                                         <input type="text" class="text datepicker e-datepicker" id="PRD_MST_ICN_ED_DT_${iconCnt}" name="PRD_MST_ICN_ED_DT${iconCnt}" value="<c:out value="${PRD_MST_ICN_ED_DT[iconCnt -1] }" />" readonly="readonly" data-target-start="#PRD_MST_ICN_ST_DT_${iconCnt}"/>
	                                                     </td>
	                                                ...
	                                                <c:when test="${not empty optionList}">
	                                                    ...
	                                                    <input type="hidden" class="text" name="PRD_OPT_IDX" id="PRD_OPT_IDX" value ="<c:out value="${optionList.PRD_OPT_IDX}" />" />
	                                                        <tr>  
	                                                            ...
	                                                            <td colspan=5>
	                                                                <table class="table-row table-c" style="width:100%;" id="optDetail_${detidx }">
	                                                                    <colgroup>
	                                                                        <col style="width: 20%;" />
                                                                            <col style="width: 12%;" />
                                                                            <col style="width: 12%;" />
	                                                                                ...
	                                                                                <tr style="margin:0px; padding:0px;">
	                                                                                    <td>
	                                                                                        ...
	                                                                                        <c:choose>
	                                                                                            ...
	                                                                                            <c:otherwise>
	                                                                                                &nbsp;<input type="button" data-opt_dtl_idx="<c:out value="${optionDetailList.OPT_DTL_IDX}" />" name="goProductOptionDetaildel" id="goProductOptionDetaildel" value="-" />
	                                                                                            </c:otherwise>
	                                                                                        </c:choose>
	                                                                                    </td>
	                                                                                    <td>
	                                                                                    ...
	                                                                                    <td>
	                                                                                        <a href="javascript:;" class="js-datepickr"><span class="icon datepickr"><em>날짜선택</em></span></a>
                                                                                            <input type="text" class="text date small" id="OPT_DTL_ST_DT_${detidx }_${subcnt}" name="OPT_DTL_ST_DT" value="<ui:formatDate value="${optionDetailList.OPT_DTL_ST_DT }" pattern="yyyy-MM-dd"/>" readonly="readonly" data-target-end="#OPT_DTL_ED_DT_${detidx }_${subcnt}" />
                                                                                            &nbsp;~&nbsp;
                                                                                            <a href="javascript:;" class="js-datepickr"><span class="icon datepickr"><em>날짜선택</em></span></a>
                                                                                            <input type="text" class="text date small" id="OPT_DTL_ED_DT_${detidx }_${subcnt}" name="OPT_DTL_ED_DT" value="<ui:formatDate value="${optionDetailList.OPT_DTL_ED_DT }" pattern="yyyy-MM-dd"/>" readonly="readonly" data-target-start="#OPT_DTL_ST_DT_${detidx }_${subcnt}" />
	                                                                                    </td>
	                                                                                    <td>
                        ...
                        <div class="table-a"><!-- col list -->
                            <table class="table-row table-a">
                                ...
                                <tbody>
                                    <tr>
                                        <th>메타태그1 : Author</th>
                                        <td><input type="text" id="PRD_MST_MTA_TAG1" name="PRD_MST_MTA_TAG1" class="text" maxlength=100 style="width:60%" value="<c:out value="${productInfo.PRD_MST_MTA_TAG1 }" />"  /></td>
                                    </tr>
                                    <tr>
                                        <th>메타태그2 : Description</th>
                                        <td><input type="text" id="PRD_MST_MTA_TAG2" name="PRD_MST_MTA_TAG2" class="text" maxlength=250 style="width:60%" value="<c:out value="${productInfo.PRD_MST_MTA_TAG2 }" />"  /></td>
                                    </tr>
                                    <tr>
                                        <th>메타태그3 : Keywords</th>
                                        <td>
                                            <input type="text" id="PRD_MST_MTA_TAG3" name="PRD_MST_MTA_TAG3" class="text" maxlength=100 style="width:60%" value="<c:out value="${productInfo.PRD_MST_MTA_TAG3 }" />"   /><br />
...
$(function () 
{
 ...
 // 상품아이콘 제한없음 클릭
    ...
    $(document).on("click", "#goRegist", function () 
    {
        ...
        //즉시쿠폰 사용유무
        if($("#PRD_MST_PC_CPN_PRC").val() !="" || $("#PRD_MST_MB_CPN_PRC").val() !=""){
            if($("#PRD_MST_CPN_OWN").val() == ""){
                alert("즉시쿠폰 주최 업체를 선택해주세요.");
                $("#PRD_MST_CPN_OWN").focus();
                return;
            }
        }
