...
<c:choose>
	<c:when test="${'2996' eq commandMap.CMN_COM_IDX }">
		<c:choose>	
			<c:when test="${empty commandMap.BNR_MST_IDX}">
				<h3 class="title">브랜드 등록</h3>
			</c:when>
			<c:otherwise>
				<h3 class="title">브랜드 수정</h3>
			</c:otherwise>
		</c:choose>
	</c:when>
	<c:otherwise>
	...
	<table cellspacing="0" class="table-row table-a">
		...
		<tbody>
			...
			<tr>
				<c:choose>
					<c:when test="${'2996' eq commandMap.CMN_COM_IDX }">
						<th><label class="label"><span>브랜드명<i class="require"><em>필수입력</em></i></span></label></th>
					</c:when>
					<c:otherwise>
			...
			<tr>
				<c:choose>
					<c:when test="${'2996' eq commandMap.CMN_COM_IDX }">
						<th><label class="label"><span>로고이미지 <i class="require"><em>필수입력</em></i></span></label></th>
					</c:when>
					<c:otherwise>
				...
				<td>
					<input type="file" class="file hide fileOneDepth" name="file" data-view="fileView1" data-type="" data-target-file-cts="" accept="image/png" />
