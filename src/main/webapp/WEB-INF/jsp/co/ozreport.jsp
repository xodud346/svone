...
var reports = [
	  ...
	  , {
              ...
              , "PARAMETERS": ["CO_CD", "BZPLC_ID", "GDOC_NO", "PARAM"]
	          , "SAVE_NAME": "출고거래명세서"
	    }
	  , {
...
function fn_ozStart()
{
	...
	SetOZParamters_OZViewer = function(){
		...
		/* 2022-07-15 성진우.디폴트파일명지정(남민희책임님요청)*/
		let today = new Date();   
		...
		var tmp2 = rprt1.SAVE_NAME;
		var fileName = tmp2+"_"+year + month +  date + hour + minutes + seconds;
		...
		/*220712.성진우.bo툴바oz기본제공상태로변경(남민희책임요청)*/
		/*
		...
		*/
		...
		/*20221129.성진우.SSP-2072.OZ REPORT 텍스트 drag&복사 기능 개발*/
		oz.sendToActionScript("viewer.screentool", "textselect");
