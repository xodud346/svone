            ...
            $.each(_arr, function(i) {
                ...
                if (_filename !== 'untitled' && val(_this.src) !== 'javascript:;') {
                    ...
                    if (_filename.match('pop')) {
                        ...
                        _result += '<a href="' + val(_this.src) + '" data-size="' + _this.size + '" data-title="' + _this.name + '" data-text="' + val(_this.src) + '" class="js-popup" target="_blank" data-scroll="true">' + _filename + '</span></a>';
