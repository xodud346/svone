    ...
    var siteDomain = $snsInitForm.find("input[name=MOBILE_DOMAIN]").val();
    var httpDomain = "http://mobile.marketplanta.epasscni.com:8080";
    ...
    var naverCallbackUrl = siteDomain+"/mobile/manager/naverCallbackUrl.do?locationProtocol="+locationProtocol+"&url="+url+"&";
    var snsCallbackUrl = siteDomain+"/mobile/manager/snsLoginCallback.do?snsType=";
...
//    	window.open(naver_id_login.getNaverIdLoginLink(naverAppId), "naverLogin", "width=500, height=450, scrollbars=no, toolbar=no, menubar=no, resizable=no");
    	document.location.href = naver_id_login.getNaverIdLoginLink(naverAppId);
    }
