...
if (!nexacro.Grid) {
	...
	_pGridTree.on_fire_user_onlbuttondown = function (button, alt_key, ctrl_key, shift_key, screenX, screenY, canvasX, canvasY, meta_key) {
	...
	_pGrid._showEditor = function (focus_cellobj) {
		...
		if (owner_frame._is_popup_frame) {
			owner_frame = owner_frame.parent;
		}
