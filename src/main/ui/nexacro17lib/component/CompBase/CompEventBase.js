...
if (nexacro.Component) {
	...
	_pComponent.on_imeaction_default_action = function (elem, keycode, alt_key, ctrl_key, shift_key, meta_key) {
	...
	_pComponent.on_fire_onimeaction = function (key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp) {
		if (this.onimeaction && this.onimeaction._has_handlers) {
			var evt = new nexacro.KeyEventInfo(this, "onimeaction", alt_key, ctrl_key, shift_key, key_code, from_comp, from_refer_comp);
